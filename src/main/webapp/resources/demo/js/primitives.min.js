/*
 Basic Primitives Diagram v3.7.7
...
primitives.common.ConnectorOffbeat.prototype.draw=function(a,b,c,d,e,f,g,h,i,j,k,l,m,n){var q,r,p,s,y,w,t,u,m=f=0,z=null,v,x;v=a.getPolyline(b);y=[];switch(i){case 1:y=[-e/2,e/2];x=!1;break;case 0:y=[0];x=!1;break;case 2:y=[0],x=!0}q=Math.max(l?g.width:0,5*e);if(c.right()+q<d.left()||c.left()>d.right()+q)if(c.left()>d.right()?(p=new primitives.common.Point(c.left(),c.verticalCenter()),s=new primitives.common.Point(d.right(),d.verticalCenter())):(p=new primitives.common.Point(c.right(),c.verticalCenter()),
s=new primitives.common.Point(d.left(),d.verticalCenter())),l&&(c.left()>d.right()?(f=7,m=3):(f=3,m=7)),r=new primitives.common.Rect(p,s),u=p.y<=s.y,t=p.x<s.x,r.height<r.width){r.height<2*e&&r.offset(0,u?2*e:0,0,u?0:2*e);h=0;for(q=y.length;h<q;h+=1)w=y[h],a.addInverted(function(c){c=c.getPolyline(b);c.addSegment(new primitives.common.MoveSegment(p.x,p.y+w));c.addSegment(new primitives.common.QuadraticArcSegment(r.horizontalCenter(),(u?r.top():r.bottom())+w,s.x,s.y+w));x&&c.addArrow(b.lineWidth,function(b){b.mergeTo(a.getPolyline(b.paletteItem))})},
h||0==i),v.addArrow(b.lineWidth,function(b){b.mergeTo(a.getPolyline(b.paletteItem))});l&&(i=g.width<2*(r.width/5)?primitives.common.QuadraticArcSegment.prototype.offsetPoint(p.x,p.y,r.horizontalCenter(),u?r.top():r.bottom(),s.x,s.y,0.5):new primitives.common.Point(p.x,u?r.top():r.bottom()),z=new primitives.common.Rect(i.x+(t?e:-g.width-e),u?i.y-g.height-e:i.y+e,g.width,g.height))}else{h=0;for(q=y.length;h<q;h+=1)w=y[h],a.addInverted(function(c){c=c.getPolyline(b);c.addSegment(new primitives.common.MoveSegment(p.x,
p.y+w));c.addSegment(new primitives.common.QuadraticArcSegment(r.horizontalCenter()+w*(u!=t?1:-1),(u?r.top():r.bottom())+w,r.horizontalCenter()+w*(u!=t?1:-1),r.verticalCenter()+w));c.addSegment(new primitives.common.QuadraticArcSegment(r.horizontalCenter()+w*(u!=t?1:-1),(u?r.bottom():r.top())+w,s.x,s.y+w));x&&c.addArrow(b.lineWidth,function(b){b.mergeTo(a.getPolyline(b.paletteItem))})},h||0==i),v.addArrow(b.lineWidth,function(b){b.mergeTo(a.getPolyline(b.paletteItem))});l&&(z=new primitives.common.Rect(r.horizontalCenter()+
(u!=t?e:-(e+g.width)),r.verticalCenter()-g.height/2,g.width,g.height))}else if(c.verticalCenter()<d.top()||c.verticalCenter()>d.bottom()){t=c.x<h.width/2;p=new primitives.common.Point(t?c.right():c.left(),c.verticalCenter());s=new primitives.common.Point(t?d.right():d.left(),d.verticalCenter());r=new primitives.common.Rect(p,s);r.offset(10*e,0,10*e,0);u=p.y<=s.y;h=0;for(q=y.length;h<q;h+=1)w=y[h],a.addInverted(function(c){c=c.getPolyline(b);c.addSegment(new primitives.common.MoveSegment(p.x,p.y+w));
c.addSegment(new primitives.common.QuadraticArcSegment(t?r.right()+w*(u?-1:1):r.left()-w*(u?-1:1),r.verticalCenter(),t?d.right():d.left(),d.verticalCenter()-w));x&&c.addArrow(b.lineWidth,function(b){b.mergeTo(a.getPolyline(b.paletteItem))})},h||0==i),v.addArrow(b.lineWidth,function(b){b.mergeTo(a.getPolyline(b.paletteItem))});l&&(m=f=t?3:7,i=primitives.common.QuadraticArcSegment.prototype.offsetPoint(p.x,p.y,t?r.right():r.left(),r.verticalCenter(),s.x,s.y,0.5),z=new primitives.common.Rect(i.x+(t?
e/2:-e/2-g.width),i.y-g.height/2,g.width,g.height))}else{p=new primitives.common.Point(c.horizontalCenter(),c.top());s=new primitives.common.Point(d.horizontalCenter(),d.top());r=new primitives.common.Rect(p,s);r.offset(0,7*e,0,0);t=p.x<s.x;h=0;for(q=y.length;h<q;h+=1)w=y[h],a.addInverted(function(c){c=c.getPolyline(b);c.addSegment(new primitives.common.MoveSegment(p.x+w,p.y));c.addSegment(new primitives.common.QuadraticArcSegment(r.horizontalCenter(),r.top()-w*(t?-1:1),d.horizontalCenter()-w,d.top()));
x&&c.addArrow(b.lineWidth,function(b){b.mergeTo(a.getPolyline(b.paletteItem))})},h||0==i),v.addArrow(b.lineWidth,function(b){b.mergeTo(a.getPolyline(b.paletteItem))});l&&(m=f=1,i=primitives.common.QuadraticArcSegment.prototype.offsetPoint(p.x,p.y,r.horizontalCenter(),r.top(),s.x,s.y,0.5),z=new primitives.common.Rect(i.x-g.width/2,i.y-(j+g.height),g.width,g.height))}if(l)switch(k){case 0:z=this._getLabelPosition(c.x,c.y,c.width,c.height,z.width,z.height,j,f);break;case 2:z=this._getLabelPosition(d.x,
...
primitives.common.ConnectorStraight.prototype.draw=function(a,b,c,d,e,f,g,h,i,j,k,l,m,n){var q,r,p,s,y,w=e/2,t=null,u=0,z=0,v=this;s=new primitives.common.Vector(c.centerPoint(),d.centerPoint());c.loopEdges(function(a,b){q=a.getIntersectionPoint(s,!0,1);u=b;return null!=q});d.loopEdges(function(a,b){r=a.getIntersectionPoint(s,!0,1);z=b;return null!=r});if(null!=q&&null!=r){var x=new primitives.common.Vector(q,r);m.getOffset(x,function(c,d,e){x.offset((c*f-(d-1)*f/2)*e);q=x.from;r=x.to;switch(i){case 1:y=
new primitives.common.Vector(r.clone(),q.clone());y.offset(w);v._drawLine(a,b,y.from,y.to,!1);y=new primitives.common.Vector(q.clone(),r.clone());y.offset(w);v._drawLine(a,b,y.from,y.to,!1);break;case 0:v._drawLine(a,b,q,r,!1);break;case 2:v._drawLine(a,b,q,r,!0)}if(l){switch(k){case 0:t=v._getLabelPositionBySnapPoint(q.x,q.y,g.width,g.height,j,u);break;case 1:p=v._betweenPoint(q,r);t=v._getLabelPositionBySnapPoint(p.x,p.y,g.width,g.height,j,3);break;case 2:t=v._getLabelPositionBySnapPoint(r.x,r.y,
...
b.activeLayer.canvas.append(g),this.m_cache.put(b.name,b.activeLayer.name,a,g)):e.update(g[0],this.ie8mode)};primitives.common.ArrayReader=function(a,b,c,d,e){this.itemTemplate=a;this.containsUniqueItems=b;this.uniquePropertyKey=c;this.containsPrimitiveValues=primitives.common.isNullOrEmpty(c);this.createSourceHash=d;this.isOrdered=e};
primitives.common.ArrayReader.prototype.read=function(a,b,c,d){var e=[],f={},g,h,i={},j={},k,l,m,n,q,r=c+"-seq";if(!b||!primitives.common.isArray(b))b=[];g=d.hash[c]||{};h=d.hash[r]||{};m=0;for(n=b.length;m<n;m+=1)k=b[m],l=this.containsUniqueItems?this.containsPrimitiveValues?k:k[this.uniquePropertyKey]:m,f.hasOwnProperty(l)||(q=this.itemTemplate.read(g[l]||{},k,c+"-"+m,d),e.push(q),f[l]=q,i[m]=l,this.createSourceHash&&(j[l]=k),this.isOrdered&&h[m]!=i[m]&&(d.isChanged=!0));d.hash[c]=f;d.hash[r]=i;
this.createSourceHash&&(d.sourceHash[c]=j);if(null==a||a.length!=e.length)d.isChanged=!0;return e};primitives.common.EnumerationReader=function(a,b,c){this.enumeration=a;this.isNullable=b;this.defaultValue=c;this.hash={};for(var d in a)this.hash[a[d]]=d};primitives.common.EnumerationReader.prototype.read=function(a,b,c,d){if(null===b||"undefined"==typeof b||!this.hash.hasOwnProperty(b))b=this.isNullable?null:this.defaultValue;a!==b&&(d.isChanged=!0);return b};primitives.common.FunctionReader=function(){};
...
this.onHighlightChanged=this.onHighlightChanging=null;this.dotLevelShift=this.normalLevelShift=20;this.normalItemsInterval=this.lineLevelShift=10;this.dotItemsInterval=1;this.lineItemsInterval=2;this.cousinsIntervalMultiplier=5;this.itemTitleFirstFontColor="#ffffff";this.itemTitleSecondFontColor="#000080";this.minimizedItemShapeType=6;this.linesColor="#c0c0c0";this.linesWidth=1;this.linesType=0;this.showNeigboursConnectorsHighlighted=!1;this.highlightLinesColor="#ff0000";this.highlightLinesWidth=
1;this.highlightLinesType=0;this.linesPalette=[];this.showCallout=!0;this.calloutPlacementOffset=100;this.defaultCalloutTemplateName=null;this.calloutfillColor="#000000";this.calloutBorderColor=null;this.calloutCornerRadius=this.calloutOffset=4;this.calloutPointerWidth="10%";this.calloutLineWidth=1;this.calloutOpacity=0.2;this.buttonsPanelSize=28;this.checkBoxPanelSize=this.groupTitlePanelSize=24;this.groupTitleOrientation=2;this.groupTitleVerticalAlignment=1;this.groupTitleHorizontalAlignment=0;
this.groupTitleFontSize="12px";this.groupTitleFontFamily="Arial";this.groupTitleColor="#4169e1";this.groupTitleFontStyle=this.groupTitleFontWeight="normal";this.distance=3;this.scale=1;this.minimumScale=0.5;this.maximumScale=1;this.showLabels=0;this.labelSize=new primitives.common.Size(80,24);this.labelOffset=1;this.labelOrientation=0;this.labelPlacement=1;this.labelFontSize="10px";this.labelFontFamily="Arial";this.labelColor="#000000";this.labelFontStyle=this.labelFontWeight="normal";this.enablePanning=
!0;this.printPreviewPageSize=new primitives.common.Size(612,792);this.autoSizeMinimum=new primitives.common.Size(800,600);this.autoSizeMaximum=new primitives.common.Size(1024,768)};
...
k.fromItem));return a.SKIP}));for(l in d)if(d.hasOwnProperty(l)){e=d[l];e.sort(function(a,b){return b.toItems.length-a.toItems.length});for(m=0;m<e.length;m+=1){k=e[m];for(var n=a,q=c,r=k.fromItem,p=k.toItems,s=void 0,y=!0,w=null,t=void 0,u=void 0,z=void 0,v=void 0,x=[],u=0,z=p.length;u<z;u+=1)if(t=p[u],s=q.edge(r,t),null!=s){if(null==w)w=s.getFar(t);else if(w!=s.getFar(t)){y=!1;break}x.push(s.getNear(t))}else{y=!1;break}if(y&&(v=new primitives.famdiagram.FamilyItem({id:k.id,isVisible:!0,isLevelNeutral:!0,
isActive:!1,itemConfig:k}),n.bundleParents(w,x,v.id,v)?(v.levelGravity=2,y=!0):n.bundleChildren(w,x,v.id,v)?(v.levelGravity=1,y=!0):n.bundleParents(w,p,v.id,v)?(v.levelGravity=2,y=!0):n.bundleParents(w,p,v.id,v)&&(v.levelGravity=1,y=!0),y)){u=0;for(z=p.length;u<z;u+=1)t=p[u],s=q.edge(r,t),s.setFar(t,v.id)}}}}}var d=null,e=null;return{process:function(f){var g=b.getLogicalFamily(),h=a.getAnnotations(),g=g.clone();c(g,h);d=g;e=a.getMaximumId();if(f&&!g.validate())throw"References are broken in family structure!";
return!0},getNavigationFamily:function(){return d},getMaximumId:function(){return e}}};
primitives.famdiagram.AddSpousesTask=function(a,b){var c=null,d=null;return{process:function(e){var f=b.getLogicalFamily(),g=b.getMaximumId(),h=a.getItems(),i=f=f.clone(),j,k,l,m,n,q,r,p;l=0;for(m=h.length;l<m;l+=1){n=h[l];p=n.spouses.slice(0);q=0;for(r=p.length;q<r;q+=1)j=[n.id,p[q]],i.hasCommonChild(j)||(g+=1,k=new primitives.famdiagram.FamilyItem({id:g,isVisible:!1,isActive:!1,isLevelNeutral:!0,hideParentConnection:!0,hideChildrenConnection:!0,itemConfig:{title:"fake child #"+g,description:"This is fake child keeps spouses together."},
...
D.treeLevelsPositions[d.level].currentvisibility=d.currentvisibility;s();t();y();c=I.lineLevelShift;var f,e,g,k,i=d=0;f=8*J.linesWidth;switch(J.arrowsDirection){case 1:d=f;i=0;break;case 2:d=0,i=f}f=0;for(e=D.treeLevelsPositions.length;f<e;f+=1)g=D.treeLevelsPositions[f],k=h.getConnectorsStacksSizes(f),c+=g.setShift(c,w(g.actualVisibility),i,d,k.parentsStackSize);return new primitives.common.Rect(0,0,Math.round(p()),Math.round(r()))}function q(a,b){var c=!1;switch(I.pageFitMode){case 1:b.width>=a.width&&
(c=!0);break;case 2:b.height>=a.height&&(c=!0);break;case 3:b.height>=a.height&&b.width>=a.width&&(c=!0)}return c}function r(){var a=D.treeLevelsPositions[D.treeLevelsPositions.length-1];return a.shift+a.nextLevelShift}function p(){var a=0;C.loopLevels(this,function(b){var c=C.getLevelLength(b);0<c&&(b=C.getItemAtPosition(b,c-1),b=D.treeItemsPositions[b],a=Math.max(a,b.offset+b.actualSize.width+b.rightPadding))});return a}function s(){var a=k.getCursorTreeItem();D.treeItemsPositions={};C.loopLevels(this,
...
0;switch(a){case 1:b=I.normalLevelShift;break;case 2:b=I.dotLevelShift;break;case 3:case 4:b=I.lineLevelShift}return b}function t(){var a,b;a=0;for(b=D.treeLevelsPositions.length;a<b;a+=1)D.treeLevelsPositions[a].currentOffset=0;var c=C,d=E.getPlanarFamily(C),f=[],e,g={};a=0;c.loopLevels(this,function(b){c.loopLevelItems(this,b,function(e,k,h){if(!g.hasOwnProperty(e)){var i=d.countChildren(e);if(0<i){var j=new u(b,a);a+=1;j.addTop(h);d.loopChildren(this,e,function(a){j.addBottom(c.getItemPosition(a));
1==i&&d.loopParents(this,a,function(a){j.addTop(c.getItemPosition(a));g[a]=j;return d.SKIP});return d.SKIP});f.push(j);g[e]=j}}})});var h={},k=[],j=0,l,m;a=0;for(b=f.length;a<b;a+=1)if(e=f[a],l=e.topMiddle(),m=e.bottomMiddle(),null!=l&&null!=m){l=c.getItemAtPosition(e.level,l);var n=c.getItemAtPosition(e.level+1,m);m=h[l];null==m&&(m=new z(j),j+=1,m.add(e.level,l),h[l]=m,k.push(m));m.add(e.level+1,n);h[n]=m}c.loopLevels(this,function(a){c.loopLevelItems(this,a,function(b){var c=h[b];null==c&&(c=new z(j),
j+=1,c.add(a,b),h[b]=c,k.push(c))})});var q=new primitives.common.dependencies;c.loopLevels(this,function(a){var b=null;c.loopLevelItems(this,a,function(a){a=h[a];null!=b&&q.add(b,a.id,new v(null));b=a.id})});a=0;for(b=f.length;a<b;a+=1)e=f[a],e.loopDependencies(function(a,b,d,f,e){a=c.getItemAtPosition(b,a);f=c.getItemAtPosition(e,f);q.add(h[a].id,h[f].id,new v(d?a:f))});var r={},p=0;q.loopTopoForward(this,function(a){var b=0;q.loopBackward(this,a,function(c,d){var f=x(k[c],k[a],d.itemToMeasure);
b=Math.max(b,r[c]+f)});r[a]=b;p=Math.max(p,b)});var t={};a=0;for(b=f.length;a<b;a+=1)e=f[a],e.getRightPosition(this,function(a,b){var d=c.getItemAtPosition(a,b);t[h[d].id]=!0});q.loopTopoBackward(this,function(a){if(!t.hasOwnProperty(a)){var b=null;q.loopForward(this,a,function(c,d){var f=x(k[a],k[c],d.itemToMeasure);b=null==b?r[c]-f:Math.min(b,r[c]-f)});null!=b&&(r[a]=b)}});var H={};q.loopTopoBackward(this,function(a){var b=p;q.loopForward(this,a,function(c,d){var f=x(k[a],k[c],d.itemToMeasure);
b=Math.min(b,r[c]-f)});H[a]=b});var J={};a=0;for(b=f.length;a<b;a+=1)e=f[a],e.getLeftPosition(this,function(a,b){var d=c.getItemAtPosition(a,b);J[h[d].id]=!0});q.loopTopoForward(this,function(a,b){J.hasOwnProperty(a)||(b=null,q.loopBackward(this,a,function(c,d){var f=x(k[c],k[a],d.itemToMeasure);b=null==b?H[c]+f:Math.max(b,H[c]+f)}),null!=b&&(H[a]=b))});for(var s in r)r.hasOwnProperty(s)&&(r[s]=(r[s]+H[s])/2);var A=null;q.loopTopoForward(this,function(a,b,c){var b=k[a],d=r[a];if(0==c)b.loop(this,
function(a){a=D.treeItemsPositions[a];i.getInterval(a.actualVisibility);a=d-a.actualSize.width/2;A=null==A?a:Math.min(a,A)});else return!0});var A=A||0,B;b=0;for(e=k.length;b<e;b+=1)m=k[b],B=r[m.id]||0,m.loop(this,function(a){var a=D.treeItemsPositions[a],b=i.getInterval(a.actualVisibility)/2;a.leftPadding=b;a.rightPadding=b;a.offset=B-a.actualSize.width/2-A})}function u(a,b){this.id=b;this.level=a;this.bottomRight=this.bottomLeft=this.topRight=this.topLeft=null;this.topItems={};this.bottomItems=
...
primitives.famdiagram.LevelsTask=function(a,b,c){var d,e,f,g,h;function i(a){var b,c,f,e,g,h,i,m,r=[],u,z,t,y,M,P,Z,aa,ga,ha,ja,X=[],ia;if(0<a.hasNodes()){ja={};z=0;ia=[];a.loopRoots(this,function(b){var c=t=new primitives.famdiagram.Family(z),d,f=[],e,g,b=a.node(b),f=q(b.id,null,c.id,b.level,b.itemConfig);f.hideParentConnection=!0;f.isVisible=b.isVisible;f.isActive=b.isActive;f.hideParentConnection=b.hideParentConnection;f.hideChildrenConnection=b.hideChildrenConnection;c.items.push(f);ja[b.id]=
!0;b.familyId=c.id;for(f=n(b,a,ja,c);0<f.length;){e=[];b=0;for(d=f.length;b<d;b+=1)g=f[b],e=e.concat(n(g,a,ja,c));f=e}X.push(t);ia.push(t);z+=1});ia.sort(function(a,b){var c=a.items[0].level,d=b.items[0].level;return c!=d?c-d:b.items.length-a.items.length});r=[];u={};if(0<X.length){g=primitives.common.graph();b=0;for(c=X.length;b<c;b+=1){t=X[b];f=0;for(e=t.links.length;f<e;f+=1)h=t.links[f],m=a.node(h.fromItem).familyId,i=a.node(h.toItem).familyId,m!=i&&(g.addEdge(m,i,{weight:0}),g.edge(m,i).weight+=
1),X[i].backLinks.push(new primitives.famdiagram.FamLink(h.toItem,h.fromItem))}for(;r.length<X.length;){b=0;for(c=ia.length;b<c;b+=1)t=ia[b],u.hasOwnProperty(t.id)||(ga=g.getSpanningTree(t.id,function(a){return-a.weight}),null!=ga.node(t.id)?(ga.loopPostOrder(this,function(a,b,c){var b=X[a],d=X[c],f=[];null!=c&&(d.familyPriority+=b.familyPriority);f=[];ga.loopChildren(this,a,function(a){f.push(a)});f.sort(function(a,b){return X[a].familyPriority-X[b].familyPriority});ga.arrangeChildren(a,f)}),ga.loopPreOrder(this,
function(a){r.push(a);u[a]=!0})):(r.push(t.id),u[t.id]=!0))}}d+=1;m=q(d,null,null,w-1,null);m.hideParentConnection=!0;m.hideChildrenConnection=!0;m.title="internal root";m.isVisible=!1;m.isActive=!1;m.childIndex=0;e={};b=0;for(c=r.length;b<c;b+=1){t=X[r[b]];Z={};g=m;aa=0;i=t.links.concat(t.backLinks);for(f=0;f<i.length;f+=1)h=i[f],M=p.node(h.toItem),p.node(h.fromItem),!0===e[M.familyId]&&(y=t.items[0],P=M,P.level>=y.level&&p.loopParents(this,P.id,function(a,b){P=b;if(b.level<y.level)return!0}),Z[P.id]=
Z.hasOwnProperty(P.id)?Z[P.id]+1:1,aa<Z[P.id]&&(g=P,aa=Z[P.id]));f=t;h=void 0;i=f.items[0];M=null;M=g;for(h=g.level+1;h<i.level;h+=1)d+=1,M=q(d,M.id,null,h,null),M.title="shift",M.isVisible=!1,M.isActive=!1,M.hideParentConnection=!0,M.hideChildrenConnection=!0,f.items.push(M);i.hideParentConnection=!0;p.adopt(M.id,i.id,i);e[t.id]=!0}b={};for(ha in s)if(s.hasOwnProperty(ha)){c=p.node(ha);m=s[ha];e=0;for(g=m.length;e<g;e+=1)f=p.node(m[e]),l(b,f,c)}ha=j();k(p,b,ha)}}function j(){var a={};p.loopPostOrder(this,
function(b,c,d){w=null!=w?Math.min(w,c.level):c.level;t=null!=t?Math.max(t,c.level):c.level;if(null!=d&&(a[d]||(a[d]={}),c=c.level-1,a[d][c]=a[d][c]?a[d][c]+1:1,null!=a[b]))for(c in a[b])a[b].hasOwnProperty(c)&&(a[d][c]=a[d][c]?a[d][c]+a[b][c]:a[b][c])});return a}function k(a,b,c){var d,f,e,g,h,k,i,j,l,m,n;a.loopLevels(this,function(q,r){var p=primitives.common.graph(),t={},u=null,z;i=[];a.loopChildren(this,r.id,function(c,e,g){var i;null==u&&(u=e);t[e.id]={};if(b.hasOwnProperty(e.id))for(i in k=
b[e.id],k)if(k.hasOwnProperty(i)){m=k[i];t[e.id][i]={};d=0;for(f=m.length;d<f;d+=1)h=m[d],z=h.commonParent==r.id?h.toParent:a.node(h.fromParent).childIndex<a.node(h.toParent).childIndex?"__right__":"__left__",e.id!=z&&(p.addEdge(e.id,z,{weight:0}),p.edge(e.id,z).weight+=1,null==t[e.id][i][z]&&(t[e.id][i][z]=0),t[e.id][i][z]+=1)}0<g&&p.addEdge(e.id,u.id,{weight:0})});if(null!=u){n=p.getGrowthSequence(function(a){return a.weight});0===n.length&&(n=[u.id]);var s=n,y=[],w,T,V,L,S,$,Y,ka,la,U,ca,Q,O,W,
ma,R,ba,ea,fa,da;T=new primitives.famdiagram.Slots;T.add(new primitives.famdiagram.Slot("__left__"));T.add(new primitives.famdiagram.Slot(null));T.add(new primitives.famdiagram.Slot("__right__"));V=0;T.loop(function(a){V+=1;a.position=V});for(w=0;w<s.length;w+=1)if(L=s[w],"__left__"!=L&&"__right__"!=L)for(ba in la=ka=Y=$=S=null,T.loop(function(a){var b,d,f,e;if(null==a.itemId){W=c[L];O=Q=ca=U=0;for(b in a.crossings)a.crossings.hasOwnProperty(b)&&(W&&null!=W[b]&&(U+=a.crossings[b]*W[b]),O+=a.crossings[b]);
...
d;a+=1)f=u[a],g[f]=null!=e&&void 0!==e[f]?e[f]:b[f];p.add(c,g.id,g);return g}function r(a,b,c,d,f){var e,g,h,k,i,j,l,m,n,q={},r,p,t;c.loopLevels(this,function(u){var z=new primitives.orgdiagram.TreeLevelConnectorStackSize;b[u]=z;n=[];c.loopLevelItems(this,u,function(b,c){var h=[],k=[],i;if(!q.hasOwnProperty(b)){q[b]=!0;c.hideChildrenConnection||h.push(b);i=f[b];if(null!=i){e=0;for(g=i.length;e<g;e+=1){var j=i[e];q[j]=!0;h.push(j)}}d.loopChildren(this,b,function(a,b){b.hideParentConnection||k.push(a)});
if(1<h.length||0<k.length)m=new primitives.orgdiagram.ConnectorBundle,m.fromLevel=u,m.fromItems=h,m.toItems=k,a.push(m),1<h.length&&n.push(m)}});if(0<n.length){t=primitives.common.pile();h=0;for(k=n.length;h<k;h+=1){m=n[h];p=r=null;i=0;for(j=m.fromItems.length;i<j;i+=1)l=c.getItemPosition(m.fromItems[i]),r=null!=r?Math.min(r,l):l,p=null!=p?Math.max(p,l):l;t.add(r,p,m)}z.parentsStackSize=t.resolve(this,function(a,b,c,d){c.fromOffset=d+1})}})}h=g=f=e=d=null;var p,s,y={},w,t,u="title description image itemTitleColor groupTitle groupTitleColor isActive hasSelectorCheckbox hasButtons templateName showCallout calloutTemplateName label showLabel labelSize labelOrientation labelPlacement minimizedItemShapeType".split(" "),
z=new primitives.orgdiagram.TreeLevelConnectorStackSize;return{process:function(){var b=a.getLogicalFamily(),b=b.clone();p=primitives.common.tree();d=a.getMaximumId();s={};y={};t=w=null;i(b);e=primitives.common.TreeLevels();f=primitives.common.TreeLevels();p.loopLevels(this,function(a,b,d){var g=c.getTemplateParams(a);e.addItem(d,a,b);null!=g&&(g.isActive&&b.isVisible)&&f.addItem(d,a,b)});g=[];h=[];r(g,h,e,p,s);return!0},getMaximumId:function(){return d},getTreeLevels:function(){return e},getActiveTreeLevels:function(){return f},
...
primitives.orgdiagram.AlignDiagramTask=function(a,b,c,d,e,f,g,h,i){function j(a,b){var c=new primitives.common.Size(w.printPreviewPageSize),d,f,e;c.scale(1/u.scale);switch(y.orientationType){case 2:case 3:c.invert()}d=0;f=c.width;n.loopMerged(this,function(a){return r[a].actualPosition.x},function(b){var e=new primitives.orgdiagram.TreeItemPosition(r[b]);a[b]=e;e.actualPosition.left()+d<f&&e.actualPosition.right()+d>f&&(d+=f-e.actualPosition.left()-d+s.normalItemsInterval/2);e.actualPosition.translate(d,
0);e.actualPosition.left()>f&&(f+=c.width)});d=0;e=c.height;n.loopLevels(this,function(f){var g=new primitives.orgdiagram.TreeLevelPosition(p[f]);g.shift+d<e&&g.shift+g.depth+d>e&&(d+=e-g.shift-d+s.normalLevelShift/2);g.shiftDown(d);n.loopLevelItems(this,f,function(b){a[b].actualPosition.translate(0,d)});g.shift>e&&(e+=c.height);b.push(g)});return new primitives.common.Size(f+1,e+1)}var k={},l=[],m=null,n,q,r,p,s,y,w,t,u;return{process:function(){var z=new primitives.common.Size(h.getContentSize()),
v=new primitives.common.Size(f.getOptimalPanelSize());n=g.getTreeLevels();q=g.getActiveTreeLevels();r=h.getItemsPositions();p=h.getTreeLevelsPositions();s=b.getOptions();y=a.getOptions();w=e.getOptions();t=c.getOptions();u=d.getOptions();switch(y.orientationType){case 2:case 3:v.invert()}v.scale(1/u.scale);m=v;k=r;l=p;switch(s.pageFitMode){case 4:k={};l=[];m=j(k,l);break;case 5:m=new primitives.common.Size(z);break;default:m=new primitives.common.Size(z);if(z.width<v.width){k={};var x=z.width,A=v.width,
B;if(i)B=(A-x)/2;else switch(t.horizontalAlignment){case 1:B=0;break;case 2:B=A-x;break;case 0:B=(A-x)/2}var x=k,D;for(D in r)r.hasOwnProperty(D)&&(A=new primitives.orgdiagram.TreeItemPosition(r[D]),A.actualPosition.translate(B,0),x[D]=A);m.width=v.width}z.height<v.height&&(m.height=v.height)}switch(y.orientationType){case 2:case 3:m.invert()}return!0},getTreeLevelsPositions:function(){return l},getItemPosition:function(a){return k[a]},getItemsPositions:function(){return k},getContentSize:function(){return m},
...
k[a];if(1==b.actualVisibility)if(e=Math.abs(c-b.actualPosition.horizontalCenter()),e<f||null==f)f=e,d=a;else return!0});if(null!=f)return!0});return d},getNextTreeItem:function(a,b){var c=a.id,d;q.loopFromItem(this,a,b,function(a){d=r[a];if(1==d.actualVisibility)return c=a,!0});return c}}};
...
!1,c.size.width),height:new primitives.common.ValueReader(["number"],!1,c.size.height)},!1,c.size)}),!0,"name")}),!0,"name")});return{process:function(){var b={isChanged:!1,hash:f};e=g.read(e,a.getOptions(),"options",b);return b.isChanged},getOptions:function(){return e},description:"Checks items template options."}};
...
primitives.orgdiagram.DrawBackgroundAnnotationTask=function(a,b,c,d,e,f,g){function h(a,b,c){var d,e,g,h,s,y,w,t,u,z,v;d=0;for(e=a.length;d<e;d+=1)if(v=a[d],null!=v.items&&0<v.items.length){s=new primitives.common.Perimeter(i);s.transform=j;y=new primitives.orgdiagram.BackgroundAnnotationConfig;u=["opacity","lineWidth","borderColor","fillColor","lineType"];g=0;for(h=u.length;g<h;g+=1)z=u[g],s[z]=v.hasOwnProperty(z)?v[z]:y[z];i.activate("placeholder",2);w=[];t={};if(v.includeChildren){g=0;for(h=v.items.length;g<
h;g+=1)y=v.items[g],u=f.getItemPosition(y),null!=u&&(t[y]=!0,w.push(y),c.loopChildren(this,y,function(a){t[a]||(t[a]=!0,w.push(a))}))}else w=v.items;v=b.getMergedPerimeters(w);for(g=0;g<v.length;g+=1)s.draw(v[g])}}var i,j;return{process:function(){var c=d.getAnnotations(),f,m;i=a();i.reset("placeholder",2);0<c.length&&(j=b.getTransform(),f=g.getBackgroundManager(),m=e.getNavigationFamily(),h(c,f,m));return!1}}};
...
primitives.orgdiagram.DrawCursorTask=function(a,b,c,d,e,f,g,h){function i(a){var b;j.activate("placeholder",11);var c=e.getItemPosition(a),g=c.actualPosition,i=new primitives.common.Rect(c.contentPosition),p=f.getTemplateParams(a).template,s=p.templateConfig,c=s.cursorPadding;i.offset(c.left,c.top,c.right,c.bottom);b=new primitives.common.RenderEventArgs;b.context=d.getConfig(a);b.isCursor=!0;b.isSelected=h.isSelected(a);b.templateName=s.name;k.transformRect(g.x,g.y,g.width,g.height,!0,this,function(a,
c,d,f){j.template(a,c,d,f,i.x,i.y,i.width,i.height,p.cursorTemplate.template(),p.cursorTemplate.getHashCode(),p.cursorTemplate.render,b,{"border-width":s.cursorBorderWidth})})}var j,k;return{process:function(){var c=g.getCursorTreeItem();j=a();j.reset("placeholder",11);null!=c&&(k=b.getTransform(),i(c));return!1}}};
primitives.orgdiagram.DrawHighlightAnnotationTask=function(a,b,c,d,e,f,g,h,i,j,k,l,m){function n(a){var b,c,k,n,x,A,B=!0,D,E=i.getItemPosition(a),C=E.actualPosition;switch(E.actualVisibility){case 2:case 3:case 1:b=g.getItemOptions(a);switch(b.showCallout){case 2:B=!1;break;case 1:B=!1;break;default:B=s.showCallout}B?(q.activate("placeholder",12),r.transformRect(C.x,C.y,C.width,C.height,!0,this,function(g,r,C,F){var r=new primitives.common.Rect(g,r,C,F),g=new primitives.common.Point(r.horizontalCenter(),
r.verticalCenter()),C=e.getOptions().scale,F=new primitives.common.Point(j.getPlaceholderOffset()),B=i.getContentSize(),N=d.getOptimalPanelSize();F.scale(1/C);N.scale(1/C);C=new primitives.common.Rect(F.x,F.y,Math.min(N.width,B.width),Math.min(N.height,B.height));if(1!=E.actualVisibility||!C.overlaps(r)){x=!primitives.common.isNullOrEmpty(b.calloutTemplateName)?b.calloutTemplateName:!primitives.common.isNullOrEmpty(b.templateName)?b.templateName:!primitives.common.isNullOrEmpty(s.defaultCalloutTemplateName)?
s.defaultCalloutTemplateName:s.defaultTemplateName;A=h.getTemplate(x,h.DefaultWidgetTemplateName);r=A.templateConfig.itemSize;F=new primitives.common.Rect(g.x,g.y,r.width,r.height);switch(s.orientationType){case 0:case 1:F.y-=r.height/4;F.x=g.x<C.horizontalCenter()?F.x+s.calloutPlacementOffset:F.x-(s.calloutPlacementOffset+r.width);break;default:F.x-=r.width/4,F.y=g.y<C.verticalCenter()?F.y+s.calloutPlacementOffset:F.y-(s.calloutPlacementOffset+r.height)}F.x<C.x?F.x=C.x+5:F.right()>C.right()&&(F.x-=
...
15);q.template(k.x,k.y,k.width,k.height,0,0,k.width,k.height,A.itemTemplate.template(),A.itemTemplate.getHashCode(),A.itemTemplate.render,n,null);p.pointerPlacement=0;p.cornerRadius=s.calloutCornerRadius;p.offset=s.calloutOffset;p.opacity=s.calloutOpacity;p.lineWidth=s.calloutLineWidth;p.pointerWidth=s.calloutPointerWidth;p.borderColor=s.calloutBorderColor;p.fillColor=s.calloutfillColor;p.draw(g,k)}else y.calloutPlaceholder.css({display:"none",visibility:"hidden"})})):y.calloutPlaceholder.css({display:"none",
visibility:"hidden"});break;case 4:y.calloutPlaceholder.css({display:"none",visibility:"hidden"})}}var q,r,p=new primitives.common.Callout(b()),s,y;return{process:function(){var d=k.getHighlightTreeItem();q=b();q.reset("calloutplaceholder",15);null!==d&&(r=c.getTransform(),s=g.getOptions(),y=a(),n(d));return!1}}};
primitives.orgdiagram.DrawHighlightPathAnnotationTask=function(a,b,c,d,e){function f(a,b,c,d){var f,l,m,n,q,r,p,s,y,w,t,u,z;if(0<c.length){t=new primitives.common.PolylinesBuffer;switch(e){case 1:a.activate("placeholder",5);break;case 2:a.activate("placeholder",7)}var v={};f=0;for(l=c.length;f<l;f+=1)if(w=c[f],null!=w.items&&0<w.items.length&&(s=w.items.slice(0),q=s[0],d.hasNode(q))){m=1;for(n=s.length;m<n;m+=1)r=s[m],d.hasNode(r)&&(v.hasOwnProperty(q)?v[q].push(r):v[q]=[r],q=r)}var x={};for(u in v)x[u]=
{},v.hasOwnProperty(u)&&d.getShortestPath(this,u,v[u],function(a){return a.weight},function(a,b){x[u][b]=a});f=0;for(l=c.length;f<l;f+=1)if(w=c[f],m=new primitives.common.PaletteItem({lineColor:null!=w.color?w.color:b.highlightLinesColor,lineWidth:null!=w.lineWidth?w.lineWidth:b.highlightLinesWidth,lineType:null!=w.lineType?w.lineType:b.highlightLinesType,fillColor:null,opacity:w.opacity}),v=t.getPolyline(m),null!=w.items&&0<w.items.length&&(s=w.items.slice(0),q=s[0],d.hasNode(q))){m=1;for(n=s.length;m<
n;m+=1)if(r=s[m],d.hasNode(r)){p=x[q][r]||[];for(q=p.length-2;0<=q;q-=1)u=p[q+1],z=p[q],y=d.edge(u,z),y.from==u?y.polyline.clone().mergeTo(v):v.addInverted(y.polyline.clone()),w.showArrows&&(z==y.parentsArrowId||z==y.childrenArrowId)&&v.addArrow(w.lineWidth,function(a){a.mergeTo(t.getPolyline(a.paletteItem))});q=r}}a.polylinesBuffer(t)}}return{process:function(){var g=d.getGraph(),h=b.getOptions(),i=c.getAnnotations(),j=a();switch(e){case 1:j.reset("placeholder",5);break;case 2:j.reset("placeholder",
7)}f(j,h,i,g);return!1}}};
primitives.orgdiagram.DrawHighlightTask=function(a,b,c,d,e,f,g,h,i){function j(a){var b;k.activate("placeholder",8);var c=e.getItemPosition(a),g=c.actualPosition,j=f.getTemplateParams(a).template,s=j.templateConfig,y=s.highlightPadding;b=new primitives.common.RenderEventArgs;b.context=d.getConfig(a);b.isCursor=h.getCursorTreeItem()==a;b.isSelected=i.isSelected(a);b.templateName=s.name;l.transformRect(g.x,g.y,g.width,g.height,!0,this,function(a,d,f,e){var g=new primitives.common.Rect(0,0,Math.round(f),
...
e+1;g<p;g+=1)if(c=a[g],c.isActive)if(b.position.overlaps(c.position))if(b.weight>=c.weight)0==c.labelType&&(c.isActive=!1);else{0==b.labelType&&(b.isActive=!1);break}else break}}));h.activate("placeholder",10);s={"font-size":k.labelFontSize,"font-family":k.labelFontFamily,"font-style":k.labelFontStyle,"font-weight":k.labelFontWeight,"font-color":k.labelColor};j.loopLevels(this,function(a){if(1==k.showLabels||u[a]||t[a]){a=y[a];e=0;for(p=a.length;e<p;e+=1)if(b=a[e],b.isActive)switch(b.labelType){case 0:case 2:h.text(b.position.x,
b.position.y,b.position.width,b.position.height,b.text,b.labelOrientation,b.horizontalAlignmentType,b.verticalAlignmentType,s)}}})}var h,i,j,k;return{process:function(){h=a();i=b.getTransform();k=d.getOptions();j=e.getTreeLevels();h.reset("placeholder",10);g();return!1}}};
primitives.orgdiagram.DrawMinimizedItemsTask=function(a,b,c,d,e,f){function g(){var a=new primitives.common.PolylinesBuffer,b={},c,f=new primitives.common.Marker,g,s,y,w,t,u,z,v,x,A;for(A in l)l.hasOwnProperty(A)&&(t=l[A],u=t.actualPosition,z=d.getItemOptions(A),i.transformRect(u.x,u.y,u.width,u.height,!0,this,function(d,h,i,l){switch(t.actualVisibility){case 2:v=e.getTemplateParams(A);x=v.template.templateConfig;y=s=g=null;w=0;null!=z&&(s=g=z.itemTitleColor,y=z.minimizedItemShapeType);g=g||x.minimizedItemBorderColor||
"#000080";s=s||x.minimizedItemFillColor||"#000080";null==y&&(y=null!==x.minimizedItemShapeType?x.minimizedItemShapeType:k.minimizedItemShapeType);w=null===x.minimizedItemCornerRadius?x.minimizedItemSize.width/2:x.minimizedItemCornerRadius;null==y||6==y?(c=a.getPolyline(new primitives.common.PaletteItem({lineColor:g,lineWidth:x.minimizedItemLineWidth,lineType:x.minimizedItemLineType,fillColor:s,opacity:x.minimizedItemOpacity})),c.addSegment(new primitives.common.DotSegment(d,h,i,l,w))):f.draw(a,y,
new primitives.common.Rect(d,h,i,l),new primitives.common.PaletteItem({lineColor:g,lineWidth:x.minimizedItemLineWidth,lineType:x.minimizedItemLineType,fillColor:s,opacity:x.minimizedItemOpacity}));break;default:j&&(g="#ff0000",b.hasOwnProperty(g)||(b[g]=new primitives.common.PaletteItem({lineColor:g,lineWidth:1,lineType:0,fillColor:g,opacity:1})),c=a.getPolyline(b[g]),c.addSegment(new primitives.common.DotSegment(d-1,h-1,2,2,1)))}}));h.activate("placeholder",9);h.polylinesBuffer(a)}var h,i,j=!1,k,
...
primitives.orgdiagram.DrawTreeItemsTask=function(a,b,c,d,e,f,g,h,i,j,k,l){function m(){var a,b=h.getCursorTreeItem(),c,d,f;for(f in n)n.hasOwnProperty(f)&&(c=n[f],d=c.actualPosition,1==c.actualVisibility&&r.transformRect(d.x,d.y,d.width,d.height,!0,this,function(d,h,k,j){var l=g.getTemplateParams(f),n=l.template;a=new primitives.common.RenderEventArgs;a.context=e.getConfig(f);a.isCursor=f==b;a.isSelected=i.isSelected(f);a.templateName=n.templateConfig.name;q.activate("placeholder",12);q.template(d,
...
p.checkBoxPanelSize-4,y.template(),y.getHashCode(),y.render,a,null));l.hasButtons&&(q.activate("placeholder",16),q.template(d,h,k,j,k-(p.buttonsPanelSize-4),c.contentPosition.y,p.buttonsPanelSize-4,Math.max(c.contentPosition.height,j-c.contentPosition.y),s.template(),n.templateConfig.name+s.getHashCode(),s.render,l,null))}))}var n,q,r,p,s,y,w;return{process:function(){q=a();p=d.getOptions();n=f.getItemsPositions();r=b.getTransform();s=l.getTemplate();y=k.getTemplate();w=j.getTemplate();q.reset("placeholder",
...
primitives.orgdiagram.ItemTemplateParamsTask=function(a,b,c){function d(a,b,c){var d=!1;switch(b){case 0:switch(c){case 0:d=a;break;case 1:d=!0;break;case 2:d=!1}break;case 1:d=!0;break;case 2:d=!1}return d}var e={};return{process:function(){var f=a.getOptions(),g=0<f.buttons.length,h=b.getCursorItem(),i=f.items,j,k;e={};j=0;for(k=i.length;j<k;j+=1){var l=i[j],m=new primitives.orgdiagram.TemplateParams,n=h==l.id,q=c.getTemplate(l.templateName,f.defaultTemplateName,c.DefaultWidgetTemplateName),r=q.templateConfig,
p=null!=r.buttons&&0<r.buttons.length;m.template=q;m.hasSelectorCheckbox=d(n,l.hasSelectorCheckbox,f.hasSelectorCheckbox);m.hasButtons=(g||p)&&d(n,l.hasButtons,f.hasButtons);m.hasGroupTitle=!primitives.common.isNullOrEmpty(l.groupTitle);m.isActive=l.isActive&&r.isActive;m.hasButtons&&(m.buttons=p?r.buttons:f.buttons);e[l.id]=m}return!0},getTemplateParams:function(a){return e[a]}}};
...
new f(c,d,k,g?d:null,e?c:null,g||e?1E3:10))}function h(a){this.bundleid=this.y=this.x=this.id=null;this.hasElbow=!1;this.visibility=this.elbowPoint2=this.elbowPoint1=null;this.isSquared=!0;for(var b in a)a.hasOwnProperty(b)&&(this[b]=a[b])}function i(){var a="_"+t;t+=1;return a}function j(a,b,c){var e=y[b.fromLevel],g=d.getConnectorsStacksSizes(b.fromLevel),l,j,m,n,p,t,I,F,K;F=0===r.connectorType;K=0<b.fromOffset?e.shift+e.connectorShift-e.levelSpace/2*(g.parentsStackSize-b.fromOffset+1):e.shift+
e.connectorShift;g=[];if(0<b.fromItems.length){j=b.fromItems;p=0;for(l=j.length;p<l;p+=1)m=j[p],n=w[m],m=new h({id:m,bundleid:i(),x:n.actualPosition.horizontalCenter(),y:n.actualPosition.bottom(),isSquared:!0,visibility:n.actualVisibility}),g.push(m);g.sort(function(a,b){return a.x-b.x})}l=[];if(0<b.toItems.length){I=!1;j=b.toItems;for(p=0;p<j.length;p+=1){m=j[p];s.getLevelIndex(m);n=w[m];t=!0;if(c)switch(n.actualVisibility){case 2:case 3:t=F}m=new h({id:m,bundleid:i(),x:n.actualPosition.horizontalCenter()+
0,y:n.actualPosition.top(),isSquared:t,visibility:n.actualVisibility});l.push(m);I=I||m.isSquared}l.sort(function(a,b){return a.x-b.x})}F=1==l.length?l[0].x:1==g.length?g[0].x:0<l.length&&0<g.length?(g[0].x+g[g.length-1].x+l[0].x+l[l.length-1].x)/4:0<l.length?(l[0].x+l[l.length-1].x)/2:(g[0].x+g[g.length-1].x)/2;var N=null;0<g.length&&(N=new h({id:i(),x:F,y:K}),k(a,N,g,!0,c,!0,b.fromOffset,r.showExtraArrows&&0<l.length));var G=null;0<l.length&&(G=new h({id:i(),x:F,y:e.shift+e.connectorShift}),null!=
N&&G.y==N.y&&(G=N),k(a,G,l,I,c,!1,0,r.showExtraArrows&&0<g.length));null!=N&&(null!=G&&N.id!=G.id)&&q.transformPoints(N.x,N.y,G.x,G.y,!0,this,function(b,c,d,e){var g=new primitives.common.Polyline;g.addSegment(new primitives.common.MoveSegment(b,c));g.addSegment(new primitives.common.LineSegment(d,e));a.addEdge(N.id,G.id,new f(N.id,G.id,g,null,null,null,0))})}function k(a,b,c,d,e,g,k,i){var j,m,n,p=[],t,s;if(d){p=[];d=0;for(m=c.length;d<m;d+=1)if(n=c[d],n.x<b.x&&!n.isSquared)p.push(n);else break;
m=p.length;0<m&&(n=p[m-1],n=n.x==b.x?b:new h({id:n.bundleid,x:n.x,y:b.y}),l(a,n,p,!1));p=[];for(j=c.length-1;j>=d;j-=1)if(n=c[j],n.x>b.x&&!n.isSquared)p.push(n);else break;m=p.length;0<m&&(n=p[m-1],n=n.x==b.x?b:new h({id:n.bundleid,x:n.x,y:b.y}),l(a,n,p,!1));for(p=d;p<=j;p+=1){n=c[p];m=r.bevelSize;2>m&&(m=0);if(e)switch(r.elbowType){case 2:case 3:0<m&&(Math.abs(b.x-n.x)>m&&Math.abs(b.y-n.y)>m)&&(n.hasElbow=!0,n.elbowPoint1=new primitives.common.Point(n.x,b.y+(b.y>n.y?-m:m)),n.elbowPoint2=new primitives.common.Point(n.x+
(b.x>n.x?m:-m),b.y))}t=new primitives.common.Polyline;n.hasElbow?(q.transform3Points(n.elbowPoint2.x,n.elbowPoint2.y,n.elbowPoint1.x,n.elbowPoint2.y,n.elbowPoint1.x,n.elbowPoint1.y,!0,this,function(a,b,c,d,f,e){switch(r.elbowType){case 2:t.addSegment(new primitives.common.MoveSegment(a,b));t.addSegment(new primitives.common.LineSegment(f,e));break;case 3:t.addSegment(new primitives.common.MoveSegment(a,b)),t.addSegment(new primitives.common.CubicArcSegment(a,b,c,d,f,e))}}),q.transformPoints(n.elbowPoint1.x,
n.elbowPoint1.y,n.x,n.y,!0,this,function(a,b,c,d){t.addSegment(new primitives.common.LineSegment(c,d))})):q.transformPoints(n.x,b.y,n.x,n.y,!0,this,function(a,b,c,d){t.addSegment(new primitives.common.MoveSegment(a,b));t.addSegment(new primitives.common.LineSegment(c,d))});m=n.x==b.x?b.id:n.bundleid;s=4!==n.visibility;a.addEdge(m,n.id,new f(m,n.id,t,g&&s?n.id:null,!g&&s?n.id:null,null,s?1E3:10,k))}d=Math.max(d-1,0);j=Math.min(j+1,c.length-1);e=b;n=b.id;for(p=d;p<=j;p+=1)m=c[p],s=m.bundleid,m.x>e.x&&
(t=new primitives.common.Polyline,q.transformPoints(e.x,b.y,null!=m.elbowPoint2?m.elbowPoint2.x:m.x,b.y,!0,this,function(a,b,c,d){t.addSegment(new primitives.common.MoveSegment(a,b));t.addSegment(new primitives.common.LineSegment(c,d))}),a.addEdge(n,s,new f(n,s,t,null,null,n,Math.abs(m.x-e.x)/1E4,k,i,g?s:n)),e=m,n=s);e=b;n=b.id;for(p=j;p>=d;p-=1)m=c[p],s=m.bundleid,m.x<e.x&&(t=new primitives.common.Polyline,q.transformPoints(e.x,b.y,null!=m.elbowPoint2?m.elbowPoint2.x:m.x,b.y,!0,this,function(a,b,
c,d){t.addSegment(new primitives.common.MoveSegment(a,b));t.addSegment(new primitives.common.LineSegment(c,d))}),a.addEdge(n,s,new f(n,s,t,null,null,n,Math.abs(m.x-e.x)/1E4,k,i,g?s:n)),e=m,n=s)}else l(a,b,c,!0)}function l(a,b,c,d){var e,g,h,k,i;e=0;for(g=c.length;e<g;e+=1){k=c[e];i=new primitives.common.Polyline;q.transformPoint(b.x,b.y,!0,this,function(a,b){i.addSegment(new primitives.common.MoveSegment(a,b))});switch(r.connectorType){case 1:q.transformPoint(k.x,k.y,!0,this,function(a,b){i.addSegment(new primitives.common.LineSegment(a,
...
b,c,d){i.addSegment(new primitives.common.QuadraticArcSegment(a,b,c,d))}):q.transformPoints(h.right(),h.y,h.right(),h.bottom(),!0,this,function(a,b,c,d){i.addSegment(new primitives.common.QuadraticArcSegment(a,b,c,d))})}h=4!==k.visibility;a.addEdge(b.id,k.id,new f(b.id,k.id,i,null,h?k.id:null,h?1E3:10))}}var m=null,n,q,r,p,s,y,w,t;return{process:function(){n=a();q=b.getTransform();r=c.getOptions();p=d.getBundles();s=d.getTreeLevels();y=e.getTreeLevelsPositions();w=e.getItemsPositions();var f=primitives.common.graph(),
...
d?f.currentvisibility:d)/2,e,h,k,i,l,j,m,p;e=8*K.linesWidth;c.leftPadding=d+(0<f.currentOffset?d*b.relationDegree*G.cousinsIntervalMultiplier:0);c.rightPadding=d;0!=K.arrowsDirection&&(b.connectorPlacement&8&&(c.leftPadding+=e),b.connectorPlacement&2&&(c.rightPadding+=e));c.offset=f.currentOffset+c.leftPadding;f.currentOffset=c.offset+c.actualSize.width+c.rightPadding;if(H.hasChildren(a))if(c=A(b),0<c)D(b,c);else if(0>c&&(c=-c,B(b,c),h=null,k={},l=null,f=H.parent(b.id),null!==f&&(H.loopChildrenReversed(this,
f.id,function(a,c){if(c===b)h=[];else if(null!==h){var d=null,f=[],e,g,j,n;e=I[c.id];void 0===e&&(e=[]);e=e.slice();e.splice(0,0,c.id);g=0;for(j=e.length;g<j;g+=1)n=q[e[g]],f[g]=n.offset+n.actualSize.width+n.rightPadding;e=[];var m;g=J[b.id];void 0===g&&(g=[]);g=g.slice();g.splice(0,0,b.id);j=0;for(n=g.length;j<n;j+=1)m=q[g[j]],e[j]=m.offset-m.leftPadding;g=Math.min(f.length,e.length);for(j=0;j<g&&!(n=e[j]-f[j],d=null!==d?Math.min(d,n):n,0>=n);j+=1);i=Math.floor(d);k[c.id]=i;if(0<i)h.splice(0,0,c);
else return l=c,!0}}),0<h.length))){d=null;if(null!==l){j=[l];j=j.concat(h);j.push(b);d=[[l]];f=1;for(e=j.length;f<e;f+=1)m=j[f-1],p=j[f],2==m.gravity||1==p.gravity?d[d.length-1].push(p):d.push([p])}else d=[h.slice(0)],d[d.length-1].push(b);if(0<d.length){h=d[d.length-1];for(f=h.length-2;0<=f;f-=1)p=h[f],i=k[p.id],c=Math.min(i,c),B(p,c),D(p,c)}j=c/(d.length-1);for(e=d.length-2;0<e;e-=1){m=d[e];for(f=m.length-1;0<=f;f-=1)p=m[f],i=k[p.id],c=Math.min(e*j,Math.min(i,c)),B(p,c),D(p,c)}}})}function A(a){var b=
...
primitives.orgdiagram.VisualTreeLevelsTask=function(a,b){function c(a,b,c,d){var f,e,g,h,p,s,y,w={},t,u,z;c.loopLevels(this,function(v){var x=new primitives.orgdiagram.TreeLevelConnectorStackSize;b[v]=x;y=[];c.loopLevelItems(this,v,function(b,f){var e=[];if(!w.hasOwnProperty(b)&&(f.connectorPlacement&4&&e.push(b),e=e.concat(f.partners),0<e.length)){s=new primitives.orgdiagram.ConnectorBundle;s.fromLevel=v;s.fromItems=e;s.toItems=[];for(var g=0,h=e.length;g<h;g+=1)w[e[g]]=s;d.loopChildren(this,b,function(a,
b){b.connectorPlacement&1&&s.toItems.push(a)});1<e.length&&y.push(s);(1<s.fromItems.length||0<s.toItems.length)&&a.push(s)}f.connectorPlacement&8&&(s=new primitives.orgdiagram.ConnectorBundle,s.isVertical=!1,s.fromLevel=v,s.fromItems=[b],s.toItems=[c.getPrevItem(b)],a.push(s));f.connectorPlacement&2&&(s=new primitives.orgdiagram.ConnectorBundle,s.isVertical=!1,s.fromLevel=v,s.fromItems=[b],s.toItems=[c.getNextItem(b)],a.push(s))});if(0<y.length){z=primitives.common.pile();f=0;for(e=y.length;f<e;f+=
1){s=y[f];u=t=null;g=0;for(h=s.fromItems.length;g<h;g+=1)p=c.getItemPosition(s.fromItems[g]),t=null!=t?Math.min(t,p):p,u=null!=u?Math.max(u,p):p;z.add(t,u,s)}x.parentsStackSize=z.resolve(this,function(a,b,c,d){c.fromOffset=d+1})}})}var d=null,e=null,f=null,g=null,h=new primitives.orgdiagram.TreeLevelConnectorStackSize;return{process:function(){var h=a.getVisualTree();d=primitives.common.TreeLevels();e=primitives.common.TreeLevels();h.loopLevels(this,function(a,c,f){var g=b.getTemplateParams(a);d.addItem(f,
...
primitives.orgdiagram.VisualTreeTask=function(a,b,c,d){function e(a,b,c){var e,g,s,x,A,B,D,E,C,H,J,I,F={},K,N={},G,M,P,Z={},aa;a.loopPostOrder(this,function(a,b,c,d){b.hasVisibleChildren=b.isVisible||b.hasVisibleChildren;null!=d&&(d.hasVisibleChildren=d.hasVisibleChildren||b.hasVisibleChildren)});a.loopLevels(this,function(f,h){var i,D,s;if(!d&&!h.hasVisibleChildren)return a.SKIP;i=c.node(f);i||(i=q({visibility:4,connectorPlacement:0,parentId:null,actualItemType:0},h),c.add(null,f,i));P=M=0;if(null!=
(B=c.indexOf(f)))M=B,P=c.countSiblings(f)-B-1;D=[];a.loopChildren(this,f,function(a,b){if(d||b.hasVisibleChildren){e=q({parentId:f,actualItemType:b.itemType},b);switch(i.actualItemType){case 7:case 8:case 6:switch(e.actualItemType){case 7:case 8:case 6:e.actualItemType=2;break;case 0:e.actualItemType=1}}switch(e.actualItemType){case 5:r(i,e),e.connectorPlacement=5,s=q({visibility:4}),c.add(s.id,e.id,e),e=s;case 8:case 2:g=c.parent(f);if(i.connectorPlacement&2)x=l(c,p.navigationFamily,i),c.add(g.id,
e.id,e,x+1),e.connectorPlacement=6,e.gravity=2;else if(i.connectorPlacement&8)A=m(c,p.navigationFamily,i),c.add(g.id,e.id,e,A),e.connectorPlacement=12,e.gravity=1;else switch(b.adviserPlacementType){case 2:x=l(c,p.navigationFamily,i);c.add(g.id,e.id,e,x+1);e.connectorPlacement=6;e.gravity=2;break;default:A=m(c,p.navigationFamily,i),c.add(g.id,e.id,e,A),e.connectorPlacement=12,e.gravity=1}switch(e.actualItemType){case 8:null!=i.parentId?r(c.node(i.parentId),e):r(i,e,!0);break;case 2:r(i,e)}break;case 4:r(i,
e),e.connectorPlacement=5,s=q({visibility:4}),c.add(s.id,e.id,e),e=s;case 1:null===i.visualAggregatorId&&n(c,i,!1);switch(b.adviserPlacementType){case 2:c.add(f,e.id,e,0);e.connectorPlacement=6;e.gravity=2;break;default:c.add(f,e.id,e),e.connectorPlacement=12,e.gravity=1}1==e.actualItemType&&r(i,e);break;case 0:D.push(e);r(i,e);break;case 7:case 6:g=c.parent(f);if(i.connectorPlacement&2)c.add(g.id,e.id,e,M),e.connectorPlacement=6,e.gravity=2;else if(i.connectorPlacement&8)c.add(g.id,e.id,e,c.countChildren(g.id)-
P),e.connectorPlacement=12,e.gravity=1;else{switch(b.adviserPlacementType){case 2:c.add(g.id,e.id,e,M);e.gravity=2;break;default:c.add(g.id,e.id,e,c.countChildren(g.id)-P),e.gravity=1}switch(e.actualItemType){case 6:e.connectorPlacement=5;break;case 7:e.connectorPlacement=4}}null!=i.parentId?r(c.node(i.parentId),e):r(i,e,!0)}}});switch(i.actualItemType){case 7:case 8:case 6:break;default:aa=[],null!=(g=c.parent(f))&&c.loopChildrenRange(this,g.id,M,c.countChildren(g.id)-P,function(b,c){if(c.id==f)aa.push(c);
...
E.connectorPlacement=(W?0:8)|4,E.gravity=1}v[C]=[K];H[C]=[E];J=K}break;default:throw"Children placement is undefined!";}});a.loopPostOrder(this,function(a){var b=c.node(a),d,e,g;if(null!=b){d=N[a];e=F[a];H=h(c,b);if(0<H&&(b.visualDepth=H+1,null!==b.visualAggregatorId)){s=c.node(b.visualAggregatorId);g=c.hasChildren(s.id);for(B=0;B<H-1;B+=1)s=n(c,s,!g)}g=0;var k=c.parent(b.id),l,j,m;if(null!==k){l=c.indexOf(b.id);for(j=1;null!=(m=c.getChild(k.id,l+j));)if(m.connectorPlacement&8)g=Math.max(g,i(c,m)),
j+=1;else break;for(j=1;null!=(m=c.getChild(k.id,l-j));)if(m.connectorPlacement&2)g=Math.max(g,i(c,m)),j+=1;else break}H=g;if(1<H){b.visualDepth+=H-1;g=c.hasChildren(a);s=b;for(B=0;B<H-1;B+=1)s=n(c,s,!g)}J=[];B=0;for(D=d.length;B<D;B+=1){G=d[B];E=J[B]=0;for(C=G.length;E<C;E+=1)J[B]=Math.max(J[B],i(c,G[E]))}B=0;for(D=J.length;B<D;B+=1)if(I=J[B],1<I){E=0;for(C=e[B].length;E<C;E+=1)if(K=e[B][E],c.hasChildren(K.id))for(H=I;1<H;)K=n(c,K,!1),H-=1}null!=Z[a]&&f(c,b,Z[a])}})}function f(a,b,c){var d,e,f,h,
...
c,d){if(0<d)return b.BREAK;e[a]=!0});else return d=g,!0});return d}function n(a,b,c){c=q({visibility:4,visualAggregatorId:b.visualAggregatorId,connectorPlacement:4==b.visibility&&0===b.connectorPlacement||c?0:5});a.insert(b.id,c.id,c);b.visualAggregatorId=c.id;return c}function q(a,b){var c=new primitives.orgdiagram.TreeItem,d;for(d in a)a.hasOwnProperty(d)&&(c[d]=a[d]);null!=b?(c.id=b.id,c.visibility=b.isVisible?0:4):(s+=1,c.id=s);return c}function r(a,c,d){var e=[];d||4==a.visibility||!b.getTemplateParams(a.id).isActive?
p.navigationFamily.loopParents(this,a.id,function(a,c){if(4!=c.visibility&&b.getTemplateParams(a).isActive)return e.push(a),p.navigationFamily.SKIP}):e.push(a.id);null!=p.navigationFamily.node(c.id)?p.navigationFamily.adopt(e,c.id):p.navigationFamily.add(e,c.id,c)}var p={visualTree:null,navigationFamily:null},s;return{process:function(){var b=a.getOrgTree(),d=c.getOptions();p.visualTree=primitives.common.tree();p.navigationFamily=primitives.common.family();s=a.getMaximumId();b.hasNodes()&&e(b,d,p.visualTree);
...
primitives.orgdiagram.BaseControl=function(a,b,c,d){function e(a){switch(a){case 1:f(!0,w);break;case 2:a=w;p.layout.forceCenterOnCursor=!1;p.tasks.process("HighlightItemOptionTask",null,a);p.graphics.end();break;default:null!=p.mouse&&p.mouse.destroy();j(p.layout);p.layout.element.find("."+p.name).remove();var a=p.layout,b=p.name,e=new primitives.common.Rect(0,0,a.element.outerWidth(),a.element.outerHeight()),s=new primitives.common.Rect(e),x=a.element.offset(),A;A=jQuery('<div tabindex="0"></div>');
A.css({position:"relative",overflow:"auto","-webkit-overflow-scrolling":"touch",top:"0px",left:"0px",width:e.width+"px",height:e.height+"px",padding:"0px","margin-bottom":"0px","margin-right":"0px","margin-top":-x.top+Math.floor(x.top)+"px","margin-left":-x.left+Math.floor(x.left)+"px"});A.addClass(b);e=jQuery("<div></div>");e.css({position:"absolute",overflow:"hidden",top:"0px",left:"0px"});e.addClass(b);e.css(s.getCSS());x=jQuery("<div></div>");x.css({position:"absolute",overflow:"hidden",top:"0px",
left:"0px"});x.addClass("placeholder");x.addClass(b);x.css(s.getCSS());s=jQuery("<div></div>");s.css({position:"absolute",overflow:"visible"});s.addClass("calloutplaceholder");s.addClass(b);s.css({top:"0px",left:"0px",width:"0px",height:"0px"});A.append(e);e.append(x);x.append(s);a.element.append(A);a.scrollPanel=A;a.mousePanel=e;a.placeholder=x;a.calloutPlaceholder=s;p.options.enablePanning&&(p.mouse=new primitives.common.Mouse,p.mouse.init(p.layout.element,{name:p.name,onMouseDrag:k,onMouseStop:l,
...
a,h),e=primitives.common.indexOf(b,c),0<=e?b.splice(e,1):b.push(c),p.options.selectedItems=b,r("onSelectionChanged",a,h)):(h=d(p,null,c,void 0),r("onMouseClick",a,h),!h.cancel&&b.hasCursorEnabled()&&(q(a,c),p.layout.scrollPanel.focus()))))}y=!1}).dblclick(function(a){var b;b=p.tasks.getTask("HighlightItemTask").getHighlightTreeItem();null!==b&&!y&&(b=d(p,null,b,void 0),r("onMouseDblClick",a,b));y=!1});a.scrollPanel.keydown(function(a){var b=p.tasks.getTask("HighlightItemTask"),c=p.tasks.getTask("HighlightItemOptionTask"),
...
p.graphics.debug=w;f(!0,w)}}function f(a,b){var c;p.layout.forceCenterOnCursor=a;p.tasks.process("OptionsTask",null,b);p.graphics.end();a&&(c=p.tasks.getTask("CenterOnCursorTask"),c=c.getPlaceholderOffset(),p.layout.scrollPanel.scrollLeft(c.x),p.layout.scrollPanel.scrollTop(c.y))}function g(){return p.options}function h(){return p.graphics}function i(){return p.layout}function j(a){null!=a.mousePanel&&(a.mousePanel.unbind("mousemove"),a.mousePanel.unbind("click"),a.mousePanel.unbind("dblclick"));
null!=a.scrollPanel&&a.scrollPanel.unbind("keydown")}function k(a){var b=new primitives.common.Point(a.pageX,a.pageY),a=-b.x+s.x,b=-b.y+s.y,c=p.layout.scrollPanel;c.css("visibility","hidden");c.scrollLeft(a).scrollTop(b);c.css("visibility","inherit");return!1}function l(){y=!0}function m(a){var b=p.layout.scrollPanel;s=new primitives.common.Point(b.scrollLeft()+a.pageX,b.scrollTop()+a.pageY);return!0}function n(a,b){var c=!0,e;null!==b?b!==p.options.highlightItem&&(e=d(p,p.options.highlightItem,b,
void 0),p.options.highlightItem=b,r("onHighlightChanging",a,e),e.cancel?c=!1:(f(!1,!1),r("onHighlightChanged",a,e))):null!==p.options.highlightItem&&(e=d(p,p.options.highlightItem,null,void 0),p.options.highlightItem=null,r("onHighlightChanging",a,e),e.cancel?c=!1:(f(!1,!1),r("onHighlightChanged",a,e)));return c}function q(a,b){var c;b!==p.options.cursorItem&&(c=d(p,p.options.cursorItem,b,void 0),p.options.cursorItem=b,r("onCursorChanging",a,c),c.cancel||(f(!0,w),r("onCursorChanged",a,c)))}function r(a,
b,c){a=p.options[a];null!=a&&a(b,c)}var p={name:"orgdiagram",options:b,tasks:null,graphics:null,mouse:null,layout:{element:a,scrollPanel:null,mousePanel:null,placeholder:null,calloutPlaceholder:null,forceCenterOnCursor:!0}},s,y,w=!1;e();return{destroy:function(){j(p.layout);p.layout.element.find("."+p.name).remove();p.tasks=null;p.graphics=null},setOptions:function(a){for(var b in a)a.hasOwnProperty(b)&&(p.options[b]=a[b])},getOptions:g,setOption:function(a,b){return p.options[a]=b},getOption:function(a){return p.options[a]},
update:e,getProcessDiagramConfig:function(){return c(g,h,i).getProcessDiagramConfig()}}};
...
l;){m=k.segments.item(l);d.hasOwnProperty(m.oppositeKey)&&(j=d[m.oppositeKey],g.hasOwnProperty(j.id)&&!g[j.id]&&(g[j.id]=!0,j.segments.iterateBack(function(a){a.key!=m.oppositeKey&&k.segments.insertAfter(l,a.key,a)},m.oppositeKey,null),j.segments.iterateBack(function(a){k.segments.insertAfter(l,a.key,a)},null,m.oppositeKey)));j=k.segments;for(var n=m,q=j.nextKey(n.key),r=void 0;null!=n&&n.oppositeKey==(r=q||j.startKey());)null!=q&&(q=j.nextKey(q)),j.remove(n.key),j.remove(r),n=j.item(null!=q?j.prevKey(q):
...
primitives.common.mergeSort=function(a,b,c){var d=null,e,f,g,h,i,j,k,l,m,n,q,r;switch(a.length){case 0:d=[];break;default:d=[];for(g=0;g<a.length;g+=1){e=a[g];f=[];j=d.length;k=e.length;i=h=0;q=m=n=l=null;0<j&&(l=d[h],n=!b?l:b(l));0<k&&(m=e[i],q=!b?m:b(m));for(r=null;h<j||i<k;)if(h>=j){if(!c||r!=m)f.push(m),r=m;i+=1;i<k&&(m=e[i],q=!b?m:b(m))}else if(i>=k){if(!c||r!=l)f.push(l),r=l;h+=1;h<j&&(l=d[h],n=!b?l:b(l))}else if(n<q){if(!c||r!=l)f.push(l),r=l;h+=1;h<j&&(l=d[h],n=!b?l:b(l))}else{if(!c||r!=m)f.push(m),
r=m;i+=1;i<k&&(m=e[i],q=!b?m:b(m))}d=f}}return d};primitives.common.binarySearch=function(a,b){var c=null,d,e,f=0,g=a.length-1,h,i;if(0<a.length&&(c=a[f],d=b(c),0<d))if(e=Math.abs(d),i=a[g],d=b(i),0<=d)c=i;else{d=Math.abs(d);e>d&&(e=d,c=i);for(;f+1<g;)if(h=Math.round((f+g)/2),i=a[h],d=b(i),0===d){c=i;break}else 0<d?f=h:g=h,d=Math.abs(d),e>d&&(e=d,c=i)}return c};
primitives.common.dependencies=function(){function a(a,b,c,d){var e,b=b[c];if(null!=b)for(e in b)if(b.hasOwnProperty(e)&&d.call(a,e,b[e]))break}function b(b,c,d,e,f,l){var m,n,q,r,p;if(null!=l){d=[];n={};for(m in f)f.hasOwnProperty(m)&&(n[m]=f[m]);for(m in c)c.hasOwnProperty(m)&&!n.hasOwnProperty(m)&&(n[m]=0,d.push(m));for(p=r=0;0<d.length;){q=[];f=0;for(e=d.length;f<e;f+=1){m=d[f];if(l.call(b,m,r,p)){q=[];break}r+=1;a(this,c,m,function(a){n[a]-=1;0===n[a]&&q.push(a)})}d=q;p+=1}}}var c={},d={},e=
...
z,v,x,A,!0)},optimizeReferences:function(a){var c={},d={},e={},g,h,i,j,l,n;l=0;var p=10,r;if(null!=a){for(g in B)l+=1,B.hasOwnProperty(g)&&(h=new m,b(this,z,g,function(a){h.children.push(a);h.childrenHash[a]=!0}),h.children.sort(),h.id=g,h.key=h.children.join(","),e[h.id]=h);for(p=Math.pow(10,l.toString().length);!primitives.common.isEmptyObject(e);){i={};r={};j=q(e);for(g in e)e.hasOwnProperty(g)&&(l=e[g],l.processed||(n=j.getSpanningTree(g,function(a){return a.weight*p+p-a.difference}),n.loopLevels(this,
function(b,g){e[b].processed=!0;n.loopChildren(this,b,function(h,l){var n=j.edge(b,h),p=null,q,s,t,u,y,w;e[h].processed=!0;if(1<n.weight){s=n.items.join(",");if(c.hasOwnProperty(s))p=c[s];else{q=a();B[q.id]=q;p=new m;p.id=q.id;p.key=s;s=0;for(t=n.items.length;s<t;s+=1)w=n.items[s],p.children.push(w),p.childrenHash[w]=!0,r[w]=!0;p.children.sort();c[p.key]=p;d[p.id]=p;i[p.id]=p;r[p.id]=p;u=p.children.slice(0);f(this,g.replacementItem||b,function(a){!p.childrenHash[a]&&null!=d[a]&&(y=!0,f(this,a,function(a){if(!p.childrenHash[a])return y=
!1,1;if(!r.hasOwnProperty(a))return 2}),y&&u.push(a));return 2});k(g.replacementItem||b,u,p.id,q,x,A,z,v,!1);if(1>=(v[b]||0)&&null==g.replacementItem)g.replacementItem=p.id}if(p.id!=h&&(u=p.children.slice(0),f(this,l.replacementItem||h,function(a){null!=d[a]&&!p.childrenHash[a]&&(y=!0,f(this,a,function(a){return!p.childrenHash[a]?(y=!1,1):(r.hasOwnProperty(a),2)}),y&&u.push(a));return 2}),k(l.replacementItem||h,u,p.id,null,x,A,z,v,!1),1>=(v[h]||0)&&null==l.replacementItem))l.replacementItem=p.id}})})));
e=i}}},eliminateManyToMany:function(a){var c,d;for(c in z)z.hasOwnProperty(c)&&1<(v[c]||0)&&b(this,z,c,function(b){if(1<(A[b]||0))d=a(),l(c,[b],d.id,d)})},getPlanarFamily:function(a){var b=new primitives.common.family,c,d;a.loopLevels(this,function(e){var g=new primitives.common.LinkedHashItems,h={},k={},i=[];a.loopLevelItems(this,e,function(b){f(this,b,function(c){var d=a.getItemPosition(c),e=new r(b,c);k[e.key]=e;var f=[];g.isEmpty()?g.add(d,[e]):(g.iterateBack(function(a,c){if(c<d)return g.insertAfter(c,
d,[e]),!0;if(c==d)return a.push(e),!0;for(var h=0,k=a.length;h<k;h+=1){var i=a[h];i.parentid!=b&&f.push(i)}}),g.startKey()>d&&g.unshift(d,[e]));h[e.key]=f;for(var c=0,i=f.length;c<i;c+=1)h[f[c].key].push(e);return 2});if(1==p(b)){var c=y(b);1==s(c)&&(c=new r(b,c),i.push(c.key))}});var e=[],j,l;for(l in h){j=h[l];var n=j.length;null!=e[n]?e[n].push(l):e[n]=[l]}n={};e.unshift(i);for(var m=0,q=e.length;m<q;m+=1){var t=e[m];if(null!=t){c=0;for(d=t.length;c<d;c+=1)if(l=t[c],!n.hasOwnProperty(l)){n[l]=
!0;j=k[l];null==b.node(j.parentid)&&b.add(null,j.parentid,{});null==b.node(j.childid)?b.add([j.parentid],j.childid,{}):b.adopt([j.parentid],j.childid);j=h[l];l=0;for(var u=j.length;l<u;l+=1)n[j[l].key]=!0}}}});return b},removeNode:function(a){null!=B[a]&&(b(this,z,a,function(b){delete x[b][a];A[b]-=1;A[b]||(delete x[b],delete A[b],null==t[null]&&(t[null]={},u[null]=0),t[null][b]||(t[null][b]=!0,u[null]+=1))}),b(this,x,a,function(b){delete z[b][a];v[b]-=1;v[b]||(delete z[b],delete v[b])}),null!=t[null]&&
...
!0,c.call(a,b,e,2)&&(d[b]=2));return d[b]})));return d[b]}))},countChildren:p,countParents:s,firstParent:function(a){var b=null,a=x[a]||{};for(b in a)if(a.hasOwnProperty(b))return b;return null},firstChild:y,validate:function(a){function c(a){var b=0,d;if(null!=a)for(d in a)a.hasOwnProperty(d)&&(b+=1);return b}var e,f;d(this,function(c){b(this,z,c,function(b){if(!x.hasOwnProperty(b)||!x[b].hasOwnProperty(c))return null!=a&&(a.message="Child #"+b+" does not reference parent #"+c),!1});b(this,x,c,function(b){if(!z.hasOwnProperty(b)||
...
null==l?(f.add(j,k,null),h[j]=g.key.toString()):l<=k&&(f.setPriority(j,k),h[j]=g.key.toString()));e.add(h[g.key],g.key.toString(),{})}return e},getGrowthSequence:function(a){var d=[],e,f={},g;e=[];var h,i={},j=0,k,l,m,n,q,r;if(null!=a){e=null;m=0;n=null;for(h in b)if(b.hasOwnProperty(h)){l=b[h];m=0;for(k in l)l.hasOwnProperty(k)&&(m+=a(l[k]));if(m>n||null==n)e=h,n=m}if(null!=e){d.push(e);f[e]=!0;j+=1;for(i[e]=null;0<j;){e=[];l=k=null;m={};for(g in f)if(f.hasOwnProperty(g)){n=b[g];h=!1;for(q in n)if(n.hasOwnProperty(q)&&
!i.hasOwnProperty(q)&&(r=a(n[q]),h=!0,null==m[q]&&(m[q]=0),m[q]+=r,!l||m[q]>l))k=q,l=m[q];h||e.push(g)}if(null==k)break;else f[k]=!0,j+=1,i[k]=!0,d.push(k);h=0;for(k=e.length;h<k;h+=1)delete f[e[h]],j-=1}}}return d},getShortestPath:function(a,d,e,f,g){var h=primitives.common.FibonacciHeap(!1),i={},j={},k,l,m={},n=0,q=0,i=0;for(l=e.length;i<l;i+=1)k=e[i],m.hasOwnProperty(k)||(n+=1,m[k]=!0);h.add(d,0,null);for(j[d]=null;null!=(d=h.extractRoot());){e=b[d.key];for(k in e)e.hasOwnProperty(k)&&(l=d.priority+
