 ...
 */
@Embeddable
public class EvaluacionDocentesMateriaResultados4PK implements Serializable {
    ...
    public EvaluacionDocentesMateriaResultados4PK() {
    }

    public EvaluacionDocentesMateriaResultados4PK(int evaluacion, int evaluador, String cveMateria, int evaluado) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof EvaluacionDocentesMateriaResultados4PK)) {
            return false;
        }
        EvaluacionDocentesMateriaResultados4PK other = (EvaluacionDocentesMateriaResultados4PK) object;
    ...
    public String toString() {
        return "mx.edu.utxj.pye.sgi.entity.ch.EvaluacionDocentesMateriaResultados4PK[ evaluacion=" + evaluacion + ", evaluador=" + evaluador + ", cveMateria=" + cveMateria + ", evaluado=" + evaluado + " ]";
    }
