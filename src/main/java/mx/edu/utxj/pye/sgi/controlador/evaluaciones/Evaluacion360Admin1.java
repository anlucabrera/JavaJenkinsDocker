...
@Named
@ViewScoped
public class Evaluacion360Admin1 extends ViewScopedRol implements Desarrollable{
...
@Getter private Boolean cargado = false;
    ...
    public void init() {
        try {
            ...
            cargada = true;
            setVistaControlador(ControlEscolarVistaControlador.EVALUACION_360);
            
            ResultadoEJB<Evaluaciones360> resEvaluacion = ejbEvaluacion360.obtenerEvaluacionActiva();
            if(!resEvaluacion.getCorrecto()) return;
            evaluacion = resEvaluacion.getValor();
            ResultadoEJB<ListaPersonal> resValidacion = ejbEvaluacion360.validarPersona(Integer.parseInt(logonMB.getListaUsuarioClaveNomina().getNumeroNomina()));
            if(!resValidacion.getCorrecto()){ mostrarMensajeResultadoEJB(resValidacion);return; }//cortar el flujo si no se pudo validar
            directivoSeleccionado = resValidacion.getValor();
            tieneAcceso = Boolean.TRUE;
            if(!tieneAcceso){mostrarMensajeNoAcceso(); return;} //cortar el flujo si no tiene acceso
            
            periodoEscolar = ejbEvaluacion360.obtenerPeriodo(evaluacion.getPeriodo()).getValor();
            respuestasPosibles = ejbEvaluacion360.getRespuestasPosibles();
            apartados = ejbEvaluacion360.getApartados();
            listaSubordinados = ejbEvaluacion360.getListaSubordinados(evaluacion, directivoSeleccionado);
...
//            System.out.println("mx.edu.utxj.pye.sgi.controlador.evaluaciones.Evaluacion360Admin1.init(9) clave: " + clave);
            opciones.put(index, new ArrayList<>());
            //facade.setEntityClass(ListaPersonal.class);
            ListaPersonal lpPrimero = ejbEvaluacion360.validarPersona(clave).getValor();//(ListaPersonal) facade.find(clave);
            opciones.get(index).add(lpPrimero);
            //opcionesSelect.get(index).add(e)
            for (ListaPersonal lp : listaSubordinados) {
//                System.out.println("mx.edu.utxj.pye.sgi.controlador.evaluaciones.Evaluacion360Admin1.init(9) res: " + (!clavesOpciones.contains(lp.getClave()) || clave.equals(lp.getClave())) + ", lp: " + lp);
            ...
            Evaluaciones360Resultados resultado = ejbEvaluacion360.obtenerResultados(evaluacion, directivoSeleccionado, clave).getValor();
...
//            System.out.println("mx.edu.utxj.pye.sgi.controlador.evaluaciones.Evaluacion360Admin1.initRespuestas() el subordinado es : " + subordinado.getNombre());
...
//            System.out.println("mx.edu.utxj.pye.sgi.controlador.evaluaciones.Evaluacion360Admin1.init(10) resultado: " + resultado);
...
//            System.out.println("mx.edu.utxj.pye.sgi.controlador.evaluaciones.Evaluacion360Admin1.initPersonalEvaluando() lpde: " + lpde);
...
//            listaPersonalEvaluando.add((ListaPersonalDesempenioEvaluacion)facade.find(new DesempenioEvaluacionResultadosPK(evaluacion.getEvaluacion(), directivoSeleccionado.getClave(), clave)));
        });//        System.out.println("mx.edu.utxj.pye.sgi.controlador.evaluaciones.Evaluacion360Admin1.init(11) evaluando: " + listaPersonalEvaluando.toString());
    }
...
//        listaPersonalEvaluado.forEach(lp -> System.out.println("mx.edu.utxj.pye.sgi.controlador.evaluaciones.Evaluacion360Admin1.initPersonalEvaluado() lp: " + lp));
...
//        System.out.println("mx.edu.utxj.pye.sgi.controlador.evaluaciones.Evaluacion360Admin1.guardarRespuesta(" + pregunta_id + ") evaluado: " + clave + ", respuesta: " + e.getNewValue() );
...
//        System.out.println("mx.edu.utxj.pye.sgi.controlador.evaluaciones.Evaluacion360Admin1.guardarRespuesta() evaluacion: " + evaluacion);
    }

    public void cambiarOpciones(ValueChangeEvent e) throws IOException {
//        System.out.println("mx.edu.utxj.pye.sgi.controlador.evaluaciones.Evaluacion360Admin1.cambiarOpciones():" + e.getNewValue());
...
//        System.out.println("mx.edu.utxj.pye.sgi.controlador.evaluaciones.Evaluacion360Admin1.cambiarOpciones() id: " + id);
//        System.out.println("mx.edu.utxj.pye.sgi.controlador.evaluaciones.Evaluacion360Admin1.cambiarOpciones() claveSeleccionada: " + claveSeleccionada);
//        System.out.println("mx.edu.utxj.pye.sgi.controlador.evaluaciones.Evaluacion360Admin1.cambiarOpciones() posición: " + posicion);
...
//        listaPersonalEvaluado.stream().forEach(p -> System.out.println("mx.edu.utxj.pye.sgi.controlador.evaluaciones.Evaluacion360Admin1.continuarEvaluando() lpe: " + p));
        clavesOpciones.clear();
        int total = 0;
