...
public class AdministracionEvaluacionesRolFortalecimiento extends AbstractRol {


    /**
     * Representa la referencia al personal de psicopedagogia
     */
    @Getter @NonNull private PersonalActivo personalFortalecimiento;
    /**
    ...
    public AdministracionEvaluacionesRolFortalecimiento(Filter<PersonalActivo> filtro, PersonalActivo personalFortalecimiento, AreasUniversidad programa) {
        super(filtro);
        this.personalFortalecimiento = personalFortalecimiento;
        this.programa = programa;
    }


    public void setPersonalPsicopedagogia(PersonalActivo personalPsicopedagogia) { this.personalFortalecimiento = personalPsicopedagogia; }
