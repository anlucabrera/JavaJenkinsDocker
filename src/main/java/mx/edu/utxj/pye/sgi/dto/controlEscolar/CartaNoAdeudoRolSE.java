...
public class CartaNoAdeudoRolSE extends AbstractRol {
    /**
     * Representa la referencia hacia el director de carrera
     */
    @Getter @NonNull private PersonalActivo serviciosE;
    ...
    public CartaNoAdeudoRolSE(Filter<PersonalActivo> filtro, PersonalActivo serviciosE) {
        super(filtro);
        this.serviciosE = serviciosE;
    }

    public void setServiciosE(PersonalActivo serviciosE) { this.serviciosE = serviciosE; }
