...
public class GeneracionConcentradoCalificaciones implements Serializable{
    ...
    public void generarPdf(Grupo grupo, List<DtoVistaCalificacionestitulosTabla> titulos, PeriodosEscolares periodoSelect, List<DtoPresentacionCalificacionesReporte> calificaciones, AreasUniversidad areasUniversidad) throws IOException, DocumentException {
        ...
        String description = "";
        if(director.getCategoriaOperativa().getCategoria() == 18){
            description = "Nombre y firma del director de la carrera";
        }
        
        if(director.getCategoriaOperativa().getCategoria() == 48){
            description = "Nombre y firma del encargado de la carrera";
        }
    ...
    public void generarPdfNewFormat(Grupo grupo, List<DtoVistaCalificacionestitulosTabla> titulos, PeriodosEscolares periodoSelect, List<DtoPresentacionCalificacionesReporte> calificaciones, PlanEstudio areasUniversidad) throws IOException, DocumentException {
        //Se crean las variables a utilizar para la creación del pdf
        Personal director = ejb.obtenerDirector(grupo.getPlan()).getValor();
        String description = "";
        if(director.getCategoriaOperativa().getCategoria() == 18){
