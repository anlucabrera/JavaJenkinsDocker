...
public class DtoRegistroPrevioAlineacionEducativa implements Serializable, Comparable<DtoRegistroPrevioAlineacionEducativa>{
    ...
    public DtoRegistroPrevioAlineacionEducativa() {
    }
    
    @Override
    public int compareTo(DtoRegistroPrevioAlineacionEducativa o) {
        return toLabel(this).compareTo(toLabel(o));
    }

    public static String toLabel(DtoRegistroPrevioAlineacionEducativa dtoRegistroPrevioEvidInstEval){
