...
@Getter private Boolean cargado = false;
 ...
 cargado = true;
        ...
        System.out.println("mx.edu.utxj.pye.sgi.controlador.evaluaciones.Evaluacion360Admin.init() evaluacion: " + evaluaciones360);
        respuestasPosibles = ejbEvaluacion360.getRespuestasPosibles();
        System.out.println("mx.edu.utxj.pye.sgi.controlador.evaluaciones.Evaluacion360Admin.init() respuestas posibles: " + respuestasPosibles);
        ...
        System.out.println("mx.edu.utxj.pye.sgi.controlador.evaluaciones.Evaluacion360Admin.init() evaluador: " + evaluador);
        ...
        listaPersonalEvaluado.forEach(lpe -> System.out.println("mx.edu.utxj.pye.sgi.controlador.evaluaciones.Evaluacion360Admin.init() lpe: " + lpe));
        evaluados = (int)listaPersonalEvaluado.stream().filter(lpe -> lpe.getCompleto()).count();
        System.out.println("mx.edu.utxj.pye.sgi.controlador.evaluaciones.Evaluacion360Admin.init() evaluados: " + evaluados);
        ...
        listaPersonalEvaluando.forEach(lpe ->System.out.println("mx.edu.utxj.pye.sgi.controlador.evaluaciones.Evaluacion360Admin.init() evaluando a: " + lpe));
        ...
        System.out.println("mx.edu.utxj.pye.sgi.controlador.evaluaciones.Evaluacion360Admin.init() claves opciones: " + clavesOpciones);

        initOpciones();

        initRespuestas();

        System.out.println("mx.edu.utxj.pye.sgi.controlador.evaluaciones.Evaluacion360Admin.init() fin");
    }
...
//            System.out.println("mx.edu.utxj.pye.sgi.controlador.evaluaciones.Evaluacion360Admin.init(9) clave: " + clave);
...
//                System.out.println("mx.edu.utxj.pye.sgi.controlador.evaluaciones.Evaluacion360Admin.init(9) res: " + (!clavesOpciones.contains(lp.getPk().getEvaluado())) + ", lp: " + lp);
...
//            System.out.println("mx.edu.utxj.pye.sgi.controlador.evaluaciones.Evaluacion360Admin.initOpciones() ah: " + apartadosHabilidades);
            index++;
        }
//        opciones.forEach((k,v) -> System.out.println("mx.edu.utxj.pye.sgi.controlador.evaluaciones.Evaluacion360Admin.initOpciones(" + k + "): " +  v ));
    }
    ...
    private void initRespuestas(){
        listaPersonalEvaluado.stream().map((subordinado) -> {
            ...
            System.out.println("mx.edu.utxj.pye.sgi.controlador.evaluaciones.Evaluacion360Admin.initRespuestas(10) resultado: " + resultado);
    ...
    private void initPersonalEvaluando(){
        ...
        for(Integer clave:clavesOpciones){
            ...
            System.out.println("mx.edu.utxj.pye.sgi.controlador.evaluaciones.EvaluacionDesempenioAdmin.initPersonalEvaluando() lpde: " + lpde);
    ...
    public void guardarRespuesta(ValueChangeEvent e){
        System.out.println("mx.edu.utxj.pye.sgi.controlador.evaluaciones.Evaluacion360Admin.guardarRespuesta() : " + e.getNewValue());
        ...
        System.out.println("mx.edu.utxj.pye.sgi.controlador.evaluaciones.Evaluacion360Admin.guardarRespuesta(" + pregunta_id + ") evaluado: " + clave + ", respuesta: " + e.getNewValue().toString() );
...
//        System.out.println("mx.edu.utxj.pye.sgi.controlador.evaluaciones.Evaluacion360Admin.guardarRespuesta() lpe: " + lpe);
//
...
//        listaPersonalEvaluando.forEach(lpe -> System.out.println("mx.edu.utxj.pye.sgi.controlador.evaluaciones.Evaluacion360Admin.cambiarOpciones() lpe: " + lpe));
//        System.out.println("mx.edu.utxj.pye.sgi.controlador.evaluaciones.Evaluacion360Admin.cambiarOpciones() evaluando: " + listaPersonalEvaluando);
...
//        System.out.println("mx.edu.utxj.pye.sgi.controlador.evaluaciones.Evaluacion360Admin.cambiarOpciones(" + listaPersonalEvaluado.contains(new ListaPersonalEvaluacion360(pk)) + ") pk: " + pk);
        ListaPersonalEvaluacion360 lpe = listaPersonalEvaluado.get(listaPersonalEvaluado.indexOf(new ListaPersonalEvaluacion360(pk)));
//        System.out.println("mx.edu.utxj.pye.sgi.controlador.evaluaciones.Evaluacion360Admin.cambiarOpciones() lpe: " + lpe);
        listaPersonalEvaluando.set(posicion, lpe);
        listaPersonalEvaluando.forEach(lpe1 -> System.out.println("mx.edu.utxj.pye.sgi.controlador.evaluaciones.Evaluacion360Admin.cambiarOpciones(" + listaPersonalEvaluado.size() + "," + clavesOpciones.size() + ") lpe1: " + lpe1));
        Faces.refresh();
//        initPersonalEvaluando();
    }
