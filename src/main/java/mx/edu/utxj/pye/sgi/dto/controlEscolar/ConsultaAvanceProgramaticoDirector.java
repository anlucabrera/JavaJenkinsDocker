...
public class ConsultaAvanceProgramaticoDirector extends AbstractRol{
...
// Variables Basicas   
    ...
    public ConsultaAvanceProgramaticoDirector(Filter<PersonalActivo> filtro, PersonalActivo director, AreasUniversidad programa) {
        super(filtro);
