...
public class RegistroFichaAdmisionRolServiciosEscolares extends AbstractRol {

    @Getter @NonNull Boolean tieneAcceso = false;

    @Getter @Setter @NonNull private PersonalActivo serviciosEscolares;
    ...
    @Getter         @Setter     private     Boolean soloLecPer;
    // /// Datos del Apirante /////////////////
    ...
    public RegistroFichaAdmisionRolServiciosEscolares(Filter<PersonalActivo> filtro, PersonalActivo serviciosEscolares, AreasUniversidad programa) {
        super(filtro);
