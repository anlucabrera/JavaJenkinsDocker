 ...
 * @author UTXJ
 */
public class ConsultaListasAsistenciaDirector extends AbstractRol{
...
// Variables de tipo de Map
    ...
    public ConsultaListasAsistenciaDirector(Filter<PersonalActivo> filtro, PersonalActivo director, AreasUniversidad programa) {
        super(filtro);
