 ...
 * @author UTXJ
 */
public class AperturaExtCartaRespCursoIMSSRolVinculacion extends AbstractRol{
    /**
     * Representa la referencia hacia al personal de coordinación de estadías
     */
     ...
     */
    @Getter @NonNull private EventoVinculacion actividad;
    
    /**
     * Lista de actividades
     */
    @Getter @NonNull private List<EventoVinculacion> actividades;
    ...
    /**
     * Habilita o deshabilita el botón para registrar apertura
     */
    @Getter @NonNull private Boolean desactivarRegistro;
    
     /**
     * Número de aperturas registradas de una actividad del estudiante
     */
    @Getter @NonNull private Integer numeroAperturasRegistradas;
   
    /**
     * Lista de aperturas extemporáneas de vinculación
     */
    @Getter @NonNull private List<DtoApertExtCartaResponsivaCursoIMSS> listaAperturasExtemporaneas;
      
    public AperturaExtCartaRespCursoIMSSRolVinculacion(Filter<PersonalActivo> filtro, PersonalActivo usuario) {
        super(filtro);
    ...
    public void setActividad(EventoVinculacion actividad) {
        this.actividad = actividad;
    }

    public void setActividades(List<EventoVinculacion> actividades) {
    ...
    public void setListaAperturasExtemporaneas(List<DtoApertExtCartaResponsivaCursoIMSS> listaAperturasExtemporaneas) {
