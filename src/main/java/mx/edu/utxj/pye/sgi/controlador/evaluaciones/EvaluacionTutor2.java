...
public class EvaluacionTutor2 extends ViewScopedRol {
    ...
    public void init() {
        ...
        if (resEvaluacion.getCorrecto() == true) {
            ...
            //System.out.println("mx.edu.utxj.pye.sgi.controlador.evaluaciones.EvaluacionTutor2.init()-->Entro al initi evaluacion no nula -- Periodo de la evaluacion" + evaluacion.getPeriodo());
