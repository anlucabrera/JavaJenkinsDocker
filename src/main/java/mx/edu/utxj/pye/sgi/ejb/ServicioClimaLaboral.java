...
public class ServicioClimaLaboral implements EjbClimaLaboral {
    ...
    public void actualizarRespuestaPorPregunta(EvaluacionesClimaLaboralResultados resultado, String pregunta, String respuesta) {
        switch (pregunta.trim()) {
            ...
            case "p6_1": resultado.setR6_1(Short.parseShort(respuesta)); break;
            case "p6_2": resultado.setR6_2(Short.parseShort(respuesta)); break;
            case "p7": resultado.setR7(respuesta); break;
            case "p8": resultado.setR8(respuesta); break;
            case "p8_1": resultado.setR8_1(respuesta); break;
            ...
            case "p61": resultado.setR6_1(Short.parseShort(respuesta)); break;
            case "p62": resultado.setR6_2(Short.parseShort(respuesta)); break;
    ...
    public void vaciarRespuestas(@NonNull EvaluacionesClimaLaboralResultados resultado, @NonNull Map<String, String> respuestas) {
        ...
        respuestas.put("p6_1", resultado.getR6_1()!=null?resultado.getR6_1().toString():null);
        respuestas.put("p6_2", resultado.getR6_2()!=null?resultado.getR6_2().toString():null);
        respuestas.put("p7", resultado.getR7());
        respuestas.put("p8", resultado.getR8());
        respuestas.put("p8_1", resultado.getR8_1());
        ...
        respuestas.put("p61", resultado.getR6_1()!=null?resultado.getR6_1().toString():null);
        respuestas.put("p62", resultado.getR6_2()!=null?resultado.getR6_2().toString():null);
