...
public class CartaNoAdeudoRolRecursosMateriales extends AbstractRol {
    /**
     * Representa la referencia hacia el director de carrera
     */
    @Getter @NonNull private PersonalActivo recursosM;
    ...
    public CartaNoAdeudoRolRecursosMateriales(Filter<PersonalActivo> filtro, PersonalActivo recursosM) {
        super(filtro);
        this.recursosM = recursosM;
    }

    public void setRecursosM(PersonalActivo recursosM) { this.recursosM = recursosM; }
