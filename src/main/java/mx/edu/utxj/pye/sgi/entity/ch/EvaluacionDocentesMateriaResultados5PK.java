 ...
 */
@Embeddable
public class EvaluacionDocentesMateriaResultados5PK implements Serializable {
    ...
    public EvaluacionDocentesMateriaResultados5PK() {
    }

    public EvaluacionDocentesMateriaResultados5PK(int evaluacion, int evaluador, String cveMateria, int evaluado) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof EvaluacionDocentesMateriaResultados5PK)) {
            return false;
        }
        EvaluacionDocentesMateriaResultados5PK other = (EvaluacionDocentesMateriaResultados5PK) object;
    ...
    public String toString() {
        return "mx.edu.utxj.pye.sgi.entity.ch.EvaluacionDocentesMateriaResultados5PK[ evaluacion=" + evaluacion + ", evaluador=" + evaluador + ", cveMateria=" + cveMateria + ", evaluado=" + evaluado + " ]";
    }
