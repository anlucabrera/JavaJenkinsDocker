...
public class cuadroMandoIntegralUniversidad implements Serializable {
    ...
    public void cmiEnGeneral() {
        ...
        cmiGeneral = new ResultadosCMI(controladorEmpleado.getNuevoOBJListaPersonal().getAreaOperativaNombre(), 0, 0, 0D,0D, grafSP,grafCP, new MeterGaugeChartModel(), false);
