 ...
 */
@Embeddable
public class EvaluacionDocentesMateriaResultadosPK implements Serializable {
    ...
    public EvaluacionDocentesMateriaResultadosPK() {
    }

    public EvaluacionDocentesMateriaResultadosPK(int evaluacion, int evaluador, String cveMateria, int evaluado) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof EvaluacionDocentesMateriaResultadosPK)) {
            return false;
        }
        EvaluacionDocentesMateriaResultadosPK other = (EvaluacionDocentesMateriaResultadosPK) object;
    ...
    public String toString() {
        return "mx.edu.utxj.pye.sgi.entity.ch.EvaluacionDocentesMateriaResultadosPK[ evaluacion=" + evaluacion + ", evaluador=" + evaluador + ", cveMateria=" + cveMateria + ", evaluado=" + evaluado + " ]";
    }
