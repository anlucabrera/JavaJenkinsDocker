...
@Named
@ViewScoped
public class ConcentradoCalificacionesDirector extends ViewScopedRol implements Desarrollable{
    @Getter @Setter ConsultaReporteCalificacionesDirector rol;
...
@Getter private Boolean cargado = false;
    ...
    public void init() {
        try {
            ...
            cargado = true;
            setVistaControlador(ControlEscolarVistaControlador.CONCENTRADO_CALIFICACIONES_DIRECTOR);
            ...
            rol = new ConsultaReporteCalificacionesDirector(filtro, director, director.getAreaOficial());
    ...
    public Boolean mostrarEnDesarrollo(HttpServletRequest request) {
        String valor = "concentrado calificaciones director";
