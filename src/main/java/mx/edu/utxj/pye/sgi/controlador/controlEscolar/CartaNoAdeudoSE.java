...
@Named
@ViewScoped
public class CartaNoAdeudoSE extends ViewScopedRol implements Desarrollable {
    ...
    public void init(){
        ...
        cargado = true;
        try{
            setVistaControlador(ControlEscolarVistaControlador.CARTA_NO_ADUEDO_SE);
...
//            System.out.println("tieneAcceso2 = " + tieneAcceso);
    ...
    public void  getCatalogoArea(){
        try{
            ResultadoEJB<List<CatalogoNoAdeudoArea>> resCatalogo= ejb.getCatalogoAduedobyArea(AreaCartaNoAdeudo.SERVICIOS_ESCOLARES);
    ...
    public void getListaDtoNoAdeudo(){
        try {
            ...
            ResultadoEJB<List<DtoNoAdeudoEstudiante.NoAdeudoEstudianteGeneral>> resList= ejb.packSEList(rol.getGeneracionSelect(),rol.getNivelEstudios(), AreaCartaNoAdeudo.SERVICIOS_ESCOLARES,rol.getServiciosE().getPersonal());
...
//        Object newValue = event.getNewValue();
        ...
        ResultadoEJB<DtoNoAdeudoEstudiante.ServiciosEscolares> resUpdate= ejb.updateNoAdeudoEscolares(registroNew.getServciosEscolares(),rol.getServiciosE().getPersonal());
    ...
    public void updateCarta(){
        try{
            rol.getEstudiantes().stream().forEach(e->{
                ResultadoEJB<DtoNoAdeudoEstudiante.ServiciosEscolares> resUpdate= ejb.updateNoAdeudoEscolares(e.getServciosEscolares(),rol.getServiciosE().getPersonal());
