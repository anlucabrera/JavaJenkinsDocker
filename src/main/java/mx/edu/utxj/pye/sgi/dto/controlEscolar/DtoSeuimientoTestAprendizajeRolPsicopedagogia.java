 ...
 * @author Planeacion
 */
public class DtoSeuimientoTestAprendizajeRolPsicopedagogia extends AbstractRol{
    
    @Getter @Setter @NonNull private PersonalActivo personalActivo;
    @Getter @Setter @NonNull private CordinadoresTutores cordinadorTutor;
    ...
    @Getter @Setter private VariablesProntuario variable1;
    @Getter @Setter private VariablesProntuario variable2;
    @Getter @Setter private VariablesProntuario variable3;
    @Getter @Setter private VariablesProntuario variable4;
    ...
    @Getter @Setter @NonNull private List<DtoAlumnosEncuesta.DtoAlumnosTest> listaAlumnosTestCompleto = new ArrayList<>();
    @Getter @Setter @NonNull private List<DtoAlumnosEncuesta.DtoAlumnosTest> listaAlumnosTestIncompleto = new ArrayList<>();
    ...
    public DtoSeuimientoTestAprendizajeRolPsicopedagogia(Filter<PersonalActivo> filtro,PersonalActivo psicopedagogia) {
        super(filtro);
