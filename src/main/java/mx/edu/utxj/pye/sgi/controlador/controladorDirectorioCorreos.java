...
public class controladorDirectorioCorreos implements Serializable {
    ...
    public List<dtoCorreosAreas> correosAreas(){
        ...
        listCorrreosAreas.add(new dtoCorreosAreas("Extensión  y Vinculación","vinculacion@utxicotepec.edu.mx","luly.saavedra@utxicotepec.edu.mx"));
        ...
        listCorrreosAreas.add(new dtoCorreosAreas("Académia de Idiomas","academia.idiomas@utxicotepec.edu.mx","baltazar.lucas@utxicotepec.edu.mx"));
