...
public class ListadoGeneralEvaluacionesPersonal {
    ...
    @Getter @Setter private Double promedioDesempenio;
    @Getter @Setter private Double promedioDocente;
    @Getter @Setter private Double promediogeneral;
//    @Getter @Setter private Double promediogeneralBase10;
}
