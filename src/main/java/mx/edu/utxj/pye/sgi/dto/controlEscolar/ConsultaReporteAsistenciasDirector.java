 ...
 * @author UTXJ
 */
public class ConsultaReporteAsistenciasDirector extends AbstractRol{
...
// Variables de tipo de Map
    ...
    public ConsultaReporteAsistenciasDirector(Filter<PersonalActivo> filtro, PersonalActivo director, AreasUniversidad programa) {
        super(filtro);
