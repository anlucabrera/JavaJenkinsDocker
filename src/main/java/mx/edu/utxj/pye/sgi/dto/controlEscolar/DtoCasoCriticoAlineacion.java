...
public class DtoCasoCriticoAlineacion implements Serializable {
    ...
    public DtoCasoCriticoAlineacion(CasoCritico casoCritico, CasoCriticoTipo tipo, CasoCriticoEstado estado, DtoEstudiante dtoEstudiante) {
    ...
    public static String toLabel(DtoCasoCriticoAlineacion dtoCasoCritico){
