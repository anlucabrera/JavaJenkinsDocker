...
public class ValidacionPlanAccionTutorialPsicopedagogia extends ViewScopedRol implements Desarrollable{
    ...
    public Boolean mostrarEnDesarrollo(HttpServletRequest request) {
        String valor = "validación plan accion tutorial psicopedagogia";
    ...
    public void init(){
        try {
            ...
            setVistaControlador(ControlEscolarVistaControlador.VALIDACION_PLAN_ACCION_TUTORIAL_PSICOPEDAGOGIA);
            ResultadoEJB<Filter<PersonalActivo>> resAcceso = ejbValidacion.validarPsicopedagogia(logonMB.getPersonal().getClave());
    ...
    public void cambiarPeriodo(){
        ...
        ResultadoEJB<List<AreasUniversidad>> resProgramasEducativos = ejb.getProgramasEducativosConPlanAccionTutorialPsicopedagogia(rol.getPeriodoSeleccionado());
