...
import mx.edu.utxj.pye.sgi.ejb.evaluaciones.EjbClimaLaboral;
...
@Getter private Boolean cargado = false;
 ...
 cargado = true;
    ...
    public void guardarRespuesta(ValueChangeEvent e){
        ...
        System.out.println("mx.edu.utxj.pye.sgi.controlador.evaluaciones.ClimaLaboral.guardarRespuesta(" + origen.getId() + "): " + valor);
        respuestas.put(origen.getId(), valor);
        comprobarEnvio();
//        System.out.println("mx.edu.utxj.pye.sgi.controlador.evaluaciones.ClimaLaboral.guardarRespuesta() enviable: " + enviable);
        
        ejb.actualizarRespuestaPorPregunta(resultado, origen.getId(), valor);
        verificarFinalizado();
//        System.out.println("mx.edu.utxj.pye.sgi.controlador.evaluaciones.ClimaLaboral.guardarRespuesta() finalizado: " + finalizado);
    }
