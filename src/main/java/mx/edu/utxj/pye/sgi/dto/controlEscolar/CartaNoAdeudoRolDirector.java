...
public class CartaNoAdeudoRolDirector extends AbstractRol {
    /**
    ...
    @Getter @NonNull private  long totalFaltantes;

    public CartaNoAdeudoRolDirector(Filter<PersonalActivo> filtro, PersonalActivo directorCarrera) {
        super(filtro);
        this.directorCarrera = directorCarrera;
    }

    public void setDirectorCarrera(PersonalActivo directorCarrera) { this.directorCarrera = directorCarrera; }
    ...
    public void setTotalFaltantes(long totalFaltantes) { this.totalFaltantes = totalFaltantes; }
}
