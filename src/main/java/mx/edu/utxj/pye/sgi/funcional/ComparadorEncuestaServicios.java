 ...
 * @author UTXJ
 */
public class ComparadorEncuestaServicios implements Comparador<EncuestaServiciosResultados>{

    @Override
    public boolean isCompleto(EncuestaServiciosResultados resultado) {
