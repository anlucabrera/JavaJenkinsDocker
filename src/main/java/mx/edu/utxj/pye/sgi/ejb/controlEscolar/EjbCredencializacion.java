...
public class EjbCredencializacion {
    ...
    public ResultadoEJB<AreasUniversidad> getAreabyClave (CredencializacionRolServiciosE rol){
        try{
            ...
            if(rol==null){return ResultadoEJB.crearErroneo(2, "El estudiante no debe ser nulo");}
            else{
                //TODO: Se hace la consulta
                ...
                else{return ResultadoEJB.crearErroneo(3, "No se encontró el aréa");}
            }
        }catch (Exception e){
        ...
        try {
            if(estudiante!=null){
                ...
                PdfStamper pdfStamper = new PdfStamper(pdfReader, baos);
                 //Foto del estudiante
                Image imageEstudiante = Image.getInstance("http://siip.utxicotepec.edu.mx/archivos/evidencias2/control_escolar/fotos/" + estudiante.getMatricula()+".jpg");
                ...
                Image imageFirma = Image.getInstance("http://siip.utxicotepec.edu.mx/archivos/evidencias2/control_escolar/firmas/" + estudiante.getMatricula()+".png");
