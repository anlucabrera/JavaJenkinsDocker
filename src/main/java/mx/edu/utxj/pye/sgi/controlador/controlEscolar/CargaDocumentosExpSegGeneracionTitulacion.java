...
@Named
@ViewScoped
public class CargaDocumentosExpSegGeneracionTitulacion implements Serializable{
    ...
    @Inject SeguimientoExpedienteIndividualTitulacion seguimientoExpedienteIndividualTitulacion;
