 ...
 */
@Entity
@Table(name = "proyectos", catalog = "poa", schema = "")
@XmlRootElement
@NamedQueries({
...
public class Proyectos implements Serializable {
    ...
    public Proyectos(Integer proyecto, short numero, String nombre, short area) {
        this.proyecto = proyecto;
        this.numero = numero;
        this.nombre = nombre;
        this.area = area;
    ...
    public String toString() {
        return "mx.edu.utxj.pye.sgi.poa.entyti.Proyectos[ proyecto=" + proyecto + " ]";
    }
