...
public class InformeResultadosEvaluacionesRolMultiple {
    ...
    @Getter @NonNull private    AreasUniversidad areaDocente;
    ...
    public void setAreaDocente(AreasUniversidad areaDocente) { this.areaDocente = areaDocente; }
}
