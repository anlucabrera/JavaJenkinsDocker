...
public class ControladorPOARegistro implements Serializable {
    ...
    public void consultarListasInit() {
        ...
        if (!poaSelectec.mostrarEjesRegistrosAreas(controladorEmpleado.getNuevoOBJListaPersonal().getAreaOperativa(), ejercicioFiscal).isEmpty()) {
            poaSelectec.mostrarEjesRegistrosAreas(controladorEmpleado.getNuevoOBJListaPersonal().getAreaOperativa(), ejercicioFiscal).forEach((ej) -> {
                switch (ej.getEje()) {
                    case 1:
                        ejesEsLaAp.add(new listaEjesEsLaAp(ej, listaEstrategiaActividadesesEje1));
                        break;
                    case 2:
                        ejesEsLaAp.add(new listaEjesEsLaAp(ej, listaEstrategiaActividadesesEje2));
                        break;
                    case 3:
                        ejesEsLaAp.add(new listaEjesEsLaAp(ej, listaEstrategiaActividadesesEje3));
                        break;
                    case 4:
                        ejesEsLaAp.add(new listaEjesEsLaAp(ej, listaEstrategiaActividadesesEje4));
                        break;
                    case 5:
                        ejesEsLaAp.add(new listaEjesEsLaAp(ej, listaEstrategiaActividadesesEje5));
                        break;
                }
            });
        }
    ...
    public void asignarUnidadMedida(ValueChangeEvent event) {
        if ("medida".equals(event.getComponent().getId())) {
    ...
    public void asignarNumerosProgramadosEdicion(ValueChangeEvent event) {
        switch (event.getComponent().getId()) {
            case "mes1":
                actividadPoaEditando.setNPEnero(Short.parseShort(event.getNewValue().toString()));
                break;
            case "mes2":
                actividadPoaEditando.setNPFebrero(Short.parseShort(event.getNewValue().toString()));
                break;
            case "mes3":
                actividadPoaEditando.setNPMarzo(Short.parseShort(event.getNewValue().toString()));
                break;
            case "mes4":
                actividadPoaEditando.setNPAbril(Short.parseShort(event.getNewValue().toString()));
                break;
            case "mes5":
                actividadPoaEditando.setNPMayo(Short.parseShort(event.getNewValue().toString()));
                break;
            case "mes6":
                actividadPoaEditando.setNPJunio(Short.parseShort(event.getNewValue().toString()));
                break;
            case "mes7":
                actividadPoaEditando.setNPJulio(Short.parseShort(event.getNewValue().toString()));
                break;
            case "mes8":
                actividadPoaEditando.setNPAgosto(Short.parseShort(event.getNewValue().toString()));
                break;
            case "mes9":
                actividadPoaEditando.setNPSeptiembre(Short.parseShort(event.getNewValue().toString()));
                break;
            case "mes10":
                actividadPoaEditando.setNPOctubre(Short.parseShort(event.getNewValue().toString()));
                break;
            case "mes11":
                actividadPoaEditando.setNPNoviembre(Short.parseShort(event.getNewValue().toString()));
                break;
            case "mes12":
                actividadPoaEditando.setNPDiciembre(Short.parseShort(event.getNewValue().toString()));
                break;
        }
    ...
    public void anadirNuavActividad() {
        System.out.println("mx.edu.utxj.pye.sgi.controladores.poa.ControladorPOARegistro.anadirNuavActividad(1)"+actividadPoaPrincipal.getNumeroP());
        mes1 = 0;        mes2 = 0;        mes3 = 0;        mes4 = 0;        mes5 = 0;        mes6 = 0;        mes7 = 0;
        mes8 = 0;        mes9 = 0;        mes10 = 0;        mes11 = 0;        mes12 = 0;        totalProgramado = 0;
        
        numeroActividadPrincipal = 0;
        numeroActividadSecuendaria = 0;
        if ("Actividad".equals(tipo)) {
            ...
            System.out.println("mx.edu.utxj.pye.sgi.controladores.poa.ControladorPOARegistro.anadirNuavActividad(2)"+numeroActividadSecuendaria);
        ...
        System.out.println("mx.edu.utxj.pye.sgi.controladores.poa.ControladorPOARegistro.anadirNuavActividad(4)" + actividadesPoa.getNumeroP());
    ...
    public void eliminarActividad(ActividadesPoa pOa) {
        ...
        mes1 = 0;        mes2 = 0;        mes3 = 0;        mes4 = 0;        mes5 = 0;        mes6 = 0;        mes7 = 0;
        mes8 = 0;        mes9 = 0;        mes10 = 0;        mes11 = 0;        mes12 = 0;        numeroActividadPrincipal = 1;        numeroActividadSecuendaria = 1;
        listaActividadesPoasPadres.clear();
        listaActividadesPoasHijas.clear();
    ...
    public void asignarNumeroP(ValueChangeEvent event) {
        ...
        System.out.println("mx.edu.utxj.pye.sgi.controladores.poa.ControladorPOARegistro.asignarNumeroP(1)"+numeroActividadPrincipal);
        System.out.println("mx.edu.utxj.pye.sgi.controladores.poa.ControladorPOARegistro.asignarNumeroP(2)"+numeroActividadPrincipalAnterior);
        ...
        System.out.println("mx.edu.utxj.pye.sgi.controladores.poa.ControladorPOARegistro.asignarNumeroP(1)"+actividadPoaPrincipalEditada.getCuadroMandoInt());
        System.out.println("mx.edu.utxj.pye.sgi.controladores.poa.ControladorPOARegistro.asignarNumeroP(2)"+actividadPoaPrincipalEditadaAnterior.getCuadroMandoInt());
    ...
    public void buscarActividadesVariasPlaneacionCuatrimestral(ActividadesPoa actividadesPoa) {
        System.out.println("mx.edu.utxj.pye.sgi.controladores.poa.ControladorPOARegistro.buscarActividadesVariasPlaneacionCuatrimestral()"+actividadesPoa.getActividadPadre());
        actividadPoaPrincipalEditada = new ActividadesPoa();
        actividadPoaPrincipalEditadaAnterior = new ActividadesPoa();
        Integer tamaño = 0;
        unidadDMedida = 0;
    ...
    public void onRowEdit() {
        ...
        listaActividadesPoasHijas.clear();
        mes1 = 0;        mes2 = 0;        mes3 = 0;        mes4 = 0;        mes5 = 0;        mes6 = 0;        mes7 = 0;
        mes8 = 0;        mes9 = 0;        mes10 = 0;        mes11 = 0;        mes12 = 0;        numeroActividadSecuendaria = 0;        totalProgramado = 0;
        totalProgramado = actividadPoaEditando.getNPEnero() + actividadPoaEditando.getNPFebrero() + actividadPoaEditando.getNPMarzo() + actividadPoaEditando.getNPAbril() + actividadPoaEditando.getNPMayo() + actividadPoaEditando.getNPJunio() + actividadPoaEditando.getNPJulio() + actividadPoaEditando.getNPAgosto() + actividadPoaEditando.getNPSeptiembre() + actividadPoaEditando.getNPOctubre() + actividadPoaEditando.getNPNoviembre() + actividadPoaEditando.getNPDiciembre();
        System.out.println("mx.edu.utxj.pye.sgi.controladores.poa.ControladorPOARegistro.onRowEdit(a)" + actividadPoaPrincipalEditada.getNumeroP() + " -- " + actividadPoaPrincipalEditada.getCuadroMandoInt());
        System.out.println("mx.edu.utxj.pye.sgi.controladores.poa.ControladorPOARegistro.onRowEdit(b)" + actividadPoaPrincipalEditadaAnterior.getNumeroP() + " -- " + actividadPoaPrincipalEditadaAnterior.getCuadroMandoInt());
        ...
        System.out.println("mx.edu.utxj.pye.sgi.controladores.poa.ControladorRegistroActividadesPOA.onRowEdit(1)" + actividadPoaEditando.getCuadroMandoInt());

        totalProgramado = 0;

        System.out.println("mx.edu.utxj.pye.sgi.controladores.poa.ControladorPOARegistro.onRowEdit(2)");
        ...
        resetearValores();
        System.out.println("mx.edu.utxj.pye.sgi.controladores.poa.ControladorPOARegistro.onRowEdit()"+ejesRegistro);
        if (ejesRegistro.equals(null)) {
            consultarListasInit();
        } else {
            consultarListas();
    ...
    public static class listaEjeEstrategia {
        ...
        @Getter
        @Setter
        private EjesRegistro ejess;
        @Getter
        @Setter
        private List<Estrategias> listaEstrategiases1;
    ...
    public static class listaEstrategiaActividades {
        ...
        @Getter
        @Setter
        private List<ActividadesPoa> actividadesPoas;
