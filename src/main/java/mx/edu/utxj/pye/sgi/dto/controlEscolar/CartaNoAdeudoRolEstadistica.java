...
public class CartaNoAdeudoRolEstadistica extends AbstractRol {
    /**
    ...
    public CartaNoAdeudoRolEstadistica(Filter<PersonalActivo> filtro, PersonalActivo personalActivo) {
        super(filtro);
