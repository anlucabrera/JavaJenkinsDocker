...
public class UsuariosPK implements Serializable {
    ...
    public UsuariosPK(int cvePersona, int cveUniversidad) {
    ...
    public String toString() {
        return "mx.edu.utxj.pye.sgi.ejb.saiiut.entity.UsuariosPK[ cvePersona=" + cvePersona + ", cveUniversidad=" + cveUniversidad + " ]";
    }
