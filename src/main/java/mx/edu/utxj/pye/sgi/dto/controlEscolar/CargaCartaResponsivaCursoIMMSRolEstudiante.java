 ...
 * @author UTXJ
 */
public class CargaCartaResponsivaCursoIMMSRolEstudiante {
     ...
     * Lista generaciones
     */
    @Getter @NonNull private List<EventoVinculacion> eventosVinculacion;
     ...
     */
    @Getter @NonNull private DtoCartaResponsivaCursoIMMSEstudiante  dtoCartaResponsivaCursoIMMSEstudiante;
    ...
    public void setEventosVinculacion(List<EventoVinculacion> eventosVinculacion) {
        this.eventosVinculacion = eventosVinculacion;
    }
    ...
    public void setDtoCartaResponsivaCursoIMMSEstudiante(DtoCartaResponsivaCursoIMMSEstudiante dtoCartaResponsivaCursoIMMSEstudiante) {
        this.dtoCartaResponsivaCursoIMMSEstudiante = dtoCartaResponsivaCursoIMMSEstudiante;
    }
