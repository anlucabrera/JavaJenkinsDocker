...
public class AdministracionEvaluacionTutor extends ViewScopedRol implements Serializable {
    ...
    public void init(){
        ...
        getPersona();
        System.out.println("Obtuvo persona -->" + persona);
        getEvaluacionTutorActiva();
        System.out.println("Evaluacion activa!-->" + evaluacion.getEvaluacion());
        getPeriodoEvaluacion();
        System.out.println("Periodo Evalaucion!-->" + evaluacion.getEvaluacion());
    ...
    public void  getEvaluacionTutorActiva(){
        try{
            ...
            if (resEvaluacion.getCorrecto()==true){
                System.out.println("EVALUACION EN METODO" + resEvaluacion.getValor().getEvaluacion());
                evaluacion = resEvaluacion.getValor();
                System.out.println("EVALUACION BIEN!");
    ...
    public void getEstudiantesActivosbyPeriodo(){
        System.out.println("Entro a generar lista general");
        ...
        if(resListaGeneral.getCorrecto()==true){
            ...
            System.out.println("Genero bien la lista general de Estudiantes " + listGeneral.size());
...
public void generalListas(List<dtoEstudiantesEvalauciones> estudiantes){
        ...
        System.out.println("Entro a generar Listas");
        System.out.println("Estudiantes que recibe!");
        ...
        estudiantes.forEach(e->{
            ...
            System.out.println("Reusltado del estudiante" + res.getValor());
            if(res.getCorrecto()==true){
                ...
                if(resultado!=null){
                    ...
                    if(finalizado){
                        System.out.println("Evaluacion Completa");
                        System.out.println("e--->"+ e);
                        listCompleto.add(e);
                        totalCompletos = totalCompletos +1;
                    }
                    if(!finalizado){
                        System.out.println("Evaluacion incompleta");
                        listIncompletos.add(e);
                        totalIncompletos = totalIncompletos +1;
                    }
                }
            }else{
                System.out.println("No ha ingresado al sistema");
                listNoIngreso.add(e);
    ...
    //TODO: Hace calculos de avance de la evalaucion
        public void generarAvaance(){
            ...
            System.out.println("Total de alumnos faltantes" + totalFaltantes + "POrcentaje " + porcentaje);
...
public void seguimientoTutor(){
    try {
        System.out.println("ENTRA COMO TUTOR");
            listGeneral = new ArrayList<>();
            getEstudiantesActivosbyPeriodo();
            System.out.println("TOTAL ESTUDIANTES" + listGeneral.size());
            ...
            System.out.println("Total de alumnos ya filtrados " + listEstudiantesFiltrados.size());
...
//TODO: Obtiene lista de resultados de evaluaciones completas o inclompletas de sus estudiantes bajo su direccion, ademas del total de los estudiantes que tiene a su cargo
    public void seguimientoDirector(){
        try{
            System.out.println("Entra como director");
            listGeneral = new ArrayList<>();
            getEstudiantesActivosbyPeriodo();
            System.out.println("TOTAL ESTUDIANTES" + listGeneral.size());
...
//TODO: Obtiene lista de resultados de evaluaciones completas o inclompletas de sus estudiantes activos
    public void seguimientoSE(){
        try{
            System.out.println("ENTRA COMO SE");
            listGeneral = new ArrayList<>();
            getEstudiantesActivosbyPeriodo();
            System.out.println("TOTAL ESTUDIANTES" + listGeneral.size());
