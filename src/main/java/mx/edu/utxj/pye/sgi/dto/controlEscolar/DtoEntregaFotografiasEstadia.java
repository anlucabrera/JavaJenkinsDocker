...
public class DtoEntregaFotografiasEstadia implements Serializable, Comparable<DtoEntregaFotografiasEstadia>{
    ...
    public static String toLabel(DtoEntregaFotografiasEstadia dtoEntregaFotografiasEstadia){
         return dtoEntregaFotografiasEstadia.getProgramaEducativo().getNombre().concat(" ")
                 .concat(dtoEntregaFotografiasEstadia.getEstudiante().getAspirante().getIdPersona().getApellidoPaterno().concat(" "))
                 .concat(dtoEntregaFotografiasEstadia.getEstudiante().getAspirante().getIdPersona().getApellidoMaterno().concat(" "))
                 .concat(dtoEntregaFotografiasEstadia.getEstudiante().getAspirante().getIdPersona().getNombre());
    }
}
