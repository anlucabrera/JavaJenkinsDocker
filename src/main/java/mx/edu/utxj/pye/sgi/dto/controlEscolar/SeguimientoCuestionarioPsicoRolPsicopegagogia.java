...
public class SeguimientoCuestionarioPsicoRolPsicopegagogia extends AbstractRol {
    ...
    public SeguimientoCuestionarioPsicoRolPsicopegagogia(Filter<PersonalActivo> filtro, PersonalActivo personalPsicopedagogia, AreasUniversidad programa) {
        super(filtro);
