...
public class CartaNoAdeudoRolSeguimientoEgresados extends AbstractRol {
    /**
    ...
    public CartaNoAdeudoRolSeguimientoEgresados(Filter<PersonalActivo> filtro, PersonalActivo personalActivo) {
        super(filtro);
