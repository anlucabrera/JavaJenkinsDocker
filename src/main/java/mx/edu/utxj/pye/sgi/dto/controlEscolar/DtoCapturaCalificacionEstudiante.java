...
@ToString
@EqualsAndHashCode
public class DtoCapturaCalificacionEstudiante implements Serializable {
    ...
    @Getter @Setter @NonNull private List<DtoCapturaCalificacionEstudiante.Captura> capturas;
    ...
    public static DtoCapturaCalificacionEstudiante.Captura crearCaptura(DtoUnidadConfiguracion.Detalle detalle, Calificacion calificacion){
        return new DtoCapturaCalificacionEstudiante.Captura(detalle, calificacion);
    }
