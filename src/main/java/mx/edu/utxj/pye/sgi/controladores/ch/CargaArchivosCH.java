 ...
 * @author Finanzas1
 */
public class CargaArchivosCH implements Serializable{
    
    private static final long serialVersionUID = -6498066911720542488L;
    
    public static String carpetaRaiz;
    private static final String carpetaW = "C:\\archivos\\evidenciasCapitalHumano\\";
    private static final String carpetaL = "/home/admin/archivos/evidenciasCapitalHumano/";
    ...
    public static void eliminarArchivo(String ruta) {
        try {
            ...
            Logger.getLogger(CargaArchivosCH.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
