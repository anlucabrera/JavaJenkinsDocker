...
public class CartaNoAdeudoRolTitulacion extends AbstractRol {
    /**
    ...
    @Getter @NonNull private  List<NoAdeudoEstudiante> adeudoEstudiantes;


    public CartaNoAdeudoRolTitulacion(Filter<PersonalActivo> filtro, PersonalActivo personalActivo) {
        super(filtro);
    ...
    public void setAdeudoEstudiantes(List<NoAdeudoEstudiante> adeudoEstudiantes) { this.adeudoEstudiantes = adeudoEstudiantes; }
}
