...
public class CartaNoAdeudoRolBiblioteca extends AbstractRol {
    /**
     * Representa la referencia hacia el director de carrera
     */
    @Getter @NonNull private PersonalActivo encargadoBiblioteca;
    ...
    public CartaNoAdeudoRolBiblioteca(Filter<PersonalActivo> filtro, PersonalActivo encargadoBiblioteca) {
        super(filtro);
        this.encargadoBiblioteca = encargadoBiblioteca;
    }

    public void setEncargadoBiblioteca(PersonalActivo encargadoBiblioteca) { this.encargadoBiblioteca = encargadoBiblioteca; }
