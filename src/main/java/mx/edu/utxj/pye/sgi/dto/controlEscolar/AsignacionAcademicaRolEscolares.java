 ...
 * @author UTXJ
 */
public class AsignacionAcademicaRolEscolares extends AbstractRol{
    
    /**
     * Representa la referencia hacia el personal de escolares
     */
    @Getter @NonNull private PersonalActivo escolares;
    ...
    public AsignacionAcademicaRolEscolares(Filter<PersonalActivo> filtro, PersonalActivo escolares, AreasUniversidad programa) {
        super(filtro);
    ...
    public void setEscolares(PersonalActivo escolares) {
        this.escolares = escolares;
    }
