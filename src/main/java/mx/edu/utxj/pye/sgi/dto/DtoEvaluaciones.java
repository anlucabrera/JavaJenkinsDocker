...
public class DtoEvaluaciones implements Serializable{
    ...
    /////////////////////////General wrappers\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
    @Getter @Setter public Boolean cargada, finalizado, estSexto, estOnceavo ,esDeIyE,director, tutor, tutorCe,esSecretario, planeacion,esPsicopedagogia, ESActiva, ESTsuActiva,
