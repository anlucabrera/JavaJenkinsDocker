...
public class ConsultaReporteCalificacionesDirector extends AbstractRol{
...
// Variables de tipo de Map
    ...
    public ConsultaReporteCalificacionesDirector(Filter<PersonalActivo> filtro, PersonalActivo director, AreasUniversidad programa) {
        super(filtro);
