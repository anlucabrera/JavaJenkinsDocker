...
@Named
@ViewScoped
public class EvaluacionDesempenioAmbientalEstudiante19 extends ViewScopedRol implements Desarrollable {
    @Getter @Setter private EvaluacionRolMultiple.EvaluacionRolEstudiante19 rol = new EvaluacionRolMultiple.EvaluacionRolEstudiante19();
