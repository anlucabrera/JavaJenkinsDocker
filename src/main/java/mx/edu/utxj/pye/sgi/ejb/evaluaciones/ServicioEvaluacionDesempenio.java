...
//            System.out.println("mx.edu.utxj.pye.sgi.ejb.evaluaciones.ServicioEvaluacionDesempenio.getApartados() p: " + p);
            if (a == null || !a.getId().equals(p.getApartado())) {//si el apartado es nulo o si la pregunta pertenece a un apartado diferente al de la pregunta anterior se crea un nuevo apartado
                if (a != null) {
                    ...
                    l.add(a);
                    i++;
//                    System.out.println("mx.edu.utxj.pye.sgi.ejb.evaluaciones.ServicioEvaluacionDesempenio.getApartados(1<>" + i + "): a" + a);
                }

                a = new Apartado(p.getApartado(), "", new ArrayList<>());
                a.getPreguntas().add(p);
//                System.out.println("mx.edu.utxj.pye.sgi.ejb.evaluaciones.ServicioEvaluacionDesempenio.getApartados(2<>" + i + ") a: " + a);
            } else {
                a.getPreguntas().add(p);
//                System.out.println("mx.edu.utxj.pye.sgi.ejb.evaluaciones.ServicioEvaluacionDesempenio.getApartados(3<>" + i + ") a:" + a);
            }
        }
...
//        l.forEach((a2) -> {
//            System.out.println("mx.edu.utxj.pye.sgi.ejb.evaluaciones.ServicioEvaluacionDesempenio.getApartados() a2: " + a2);
//        });
        return l;
    }
...
//        System.out.println("mx.edu.utxj.pye.sgi.ejb.evaluaciones.ServicioEvaluacionDesempenio.getListaEvaluados(): " + (directivo.getActividad() == 2));
...
//        System.out.println("mx.edu.utxj.pye.sgi.ejb.evaluaciones.ServicioEvaluacionDesempenio.cargarResultadosAlmacenados() la clave : " + directivo.getClave() + " lista de subordinados : " + subordinados);
        //System.out.println("mx.edu.utxj.pye.sgi.ejb.evaluaciones.ServicioEvaluacionDesempenio.cargarResultadosAlmacenados() subordinados: " + subordinados);
        List<Integer> claves = new ArrayList<>();
        subordinados.forEach((lp) -> {
            if (lp.getClave().equals(directivo.getClave())) {
//                System.out.println("mx.edu.utxj.pye.sgi.ejb.evaluaciones.ServicioEvaluacionDesempenio.cargarResultadosAlmacenados() es director : " + directivo.getNombre());
            } else {
                claves.add(lp.getClave());
            }
        });

//        System.out.println("mx.edu.utxj.pye.sgi.ejb.evaluaciones.ServicioEvaluacionDesempenio.cargarResultadosAlmacenados() claves: " + claves);
...
//        System.out.println("mx.edu.utxj.pye.sgi.ejb.evaluaciones.ServicioEvaluacionDesempenio.obtenerRespuestaPorPregunta(): " + res);
        return res;
    }
