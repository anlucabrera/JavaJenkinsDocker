...
//            String ruta = "/sii2/media".concat(file.toURI().toString().split("archivos")[1]);
    ...
    public void generarPdfNoveno(DtoEstudiante estudiante)throws IOException, DocumentException{
        Document document;
        ...
        PdfPTable tablaPromedio = new PdfPTable(2);     PdfPTable table4 = new PdfPTable(2);          PdfPTable table5 = new PdfPTable(2);
        PdfPTable table6 = new PdfPTable(2);            PdfPTable table7 = new PdfPTable(2);          PdfPTable table8 = new PdfPTable(2);
        PdfPTable table2 = new PdfPTable(2);            PdfPTable table1 = new PdfPTable(2);          PdfPTable table9 = new PdfPTable(2);
        
        PdfPCell c1 = new PdfPCell(), c2 = new PdfPCell(), c3 = new PdfPCell(), c4 = new PdfPCell(), c5 = new PdfPCell(), c6 = new PdfPCell(), c7 = new PdfPCell(),
                c8 = new PdfPCell(), c9 = new PdfPCell(), c10 = new PdfPCell(), c11 = new PdfPCell(), c12 = new PdfPCell(); 
        PdfPCell cuatri1, cuatri2, cuatri3, cuatri4, cuatri5, cuatri6, cuatri7, cuatri8, cuatri9;
        PdfPCell texto, avg;
        //Se abre el pdf para iniciar a darle formato
        document.open();
        //Se coloca los elementos necesarios que contendra el pdf
        ...
        table7.setWidthPercentage(100);          table7.setHorizontalAlignment(Element.ALIGN_LEFT);           table7.setWidths(new float[] {43f, 7f});
        table8.setWidthPercentage(100);          table8.setHorizontalAlignment(Element.ALIGN_LEFT);           table8.setWidths(new float[] {43f, 7f});
        table9.setWidthPercentage(100);          table9.setHorizontalAlignment(Element.ALIGN_LEFT);           table9.setWidths(new float[] {43f, 7f});
        tablaPromedio.setWidthPercentage(100);   tablaPromedio.setHorizontalAlignment(Element.ALIGN_LEFT);    tablaPromedio.setWidths(new float[] {43f, 7f});
        ...
        Estudiante estudiante7 = estudiante.getInscripciones().stream().filter(est -> est.getGrupo().getGrado() == 7).findFirst().get().getInscripcion();
        Estudiante estudiante8 = estudiante.getInscripciones().stream().filter(est -> est.getGrupo().getGrado() == 8).findFirst().get().getInscripcion();
        Estudiante estudiante9 = estudiante.getInscripciones().stream().filter(est -> est.getGrupo().getGrado() == 9).findFirst().get().getInscripcion();
        ...
        List<DtoCargaAcademica> lista8 = controlador.getCargasAcademicas(estudiante8);
        lista8.sort((DtoCargaAcademica o1, DtoCargaAcademica o2) -> o1.getPlanEstudioMateria().getClaveMateria().compareTo(o2.getPlanEstudioMateria().getClaveMateria()));
        List<DtoCargaAcademica> lista9 = controlador.getCargasAcademicas(estudiante9);
        lista9.sort((DtoCargaAcademica o1, DtoCargaAcademica o2) -> o1.getPlanEstudioMateria().getClaveMateria().compareTo(o2.getPlanEstudioMateria().getClaveMateria()));
        ...
        Integer cargas = (int)estudiante9.getGrupo().getCargaAcademicaList().stream().mapToInt(CargaAcademica::getCarga).count();
        Integer calificaciones = (int)estudiante8.getCalificacionPromedioList().stream().mapToInt((cp) -> cp.getCargaAcademica().getCarga()).count();
        BigDecimal promedioC = controlador.getPromedioCuatrimestral(estudiante9);
        
        if(!cargas.equals(calificaciones) || promedioC.compareTo(new BigDecimal(8)) == -1) {
            Integer contador;
                BigDecimal p = estudiante.getInscripciones().stream().filter(e -> e.getInscripcion().getGrupo().getGrado() == 9)
                        .map(dtoInscripcion -> controlador.getPromedioCuatrimestral(dtoInscripcion.getInscripcion())).map(BigDecimal::plus)
                        .reduce(BigDecimal.ZERO, BigDecimal::add).setScale(2, RoundingMode.HALF_DOWN);
                if(p.compareTo(new BigDecimal(8)) == -1){
                    contador = 7;
                ...
                texto = new PdfPCell(new Paragraph("Promedio", fontBold));   avg = new PdfPCell(new Paragraph(promedioA.setScale(2, RoundingMode.HALF_DOWN).toString(), fontBold));
                tablaPromedio.addCell(texto);     tablaPromedio.addCell(avg);
                c6.addElement(tablaPromedio);
        }else{
            cuatri9 = new PdfPCell(new Paragraph("NOVENO", fontBold1));      cuatri9.setColspan(3);       cuatri9.setHorizontalAlignment(Element.ALIGN_CENTER);
            table9.addCell(cuatri9);
            lista9.forEach(dtoCargaAcademica -> {
                BigDecimal promedio = new BigDecimal(ejb.obtenerPromedioEstudiante(dtoCargaAcademica.getCargaAcademica(), estudiante9).getValor().getValor()).setScale(2, RoundingMode.HALF_DOWN);
                BigDecimal nivelacion = new BigDecimal(controlador.getNivelacion(dtoCargaAcademica, estudiante9).getCalificacionNivelacion().getValor()).setScale(2, RoundingMode.HALF_DOWN);
                PdfPCell materias2 = new PdfPCell(new Paragraph(dtoCargaAcademica.getMateria().getNombre(), fontMateria2));
                materias2.setHorizontalAlignment(Element.ALIGN_LEFT);   PdfPCell promedios2;
                    if(nivelacion.compareTo(BigDecimal.ZERO) == 0){
                        promedios2 = new PdfPCell(new Paragraph(promedio.toString(), fontMateria2));
                ...
                table9.addCell(materias2);
                table9.addCell(promedios2);
            });
            c6.addElement(table9);
        }
    ...
    public void generarPdfDecimo(DtoEstudiante estudiante)throws IOException, DocumentException{
        Document document;
        ...
        PdfPCell c1 = new PdfPCell(), c2 = new PdfPCell(), c3 = new PdfPCell(), c4 = new PdfPCell(), c5 = new PdfPCell(), c6 = new PdfPCell(), c7 = new PdfPCell(),
                c8 = new PdfPCell(), c9 = new PdfPCell(), c10 = new PdfPCell(), c11 = new PdfPCell(), c12 = new PdfPCell(); 
        PdfPCell cuatri1, cuatri2, cuatri3, cuatri4, cuatri5, cuatri6, cuatri7, cuatri8, cuatri9, cuatri10;
        PdfPCell texto, avg;
        //Se abre el pdf para iniciar a darle formato
        document.open();
        //Se coloca los elementos necesarios que contendra el pdf
        ...
        table8.setWidthPercentage(100);           table8.setHorizontalAlignment(Element.ALIGN_LEFT);            table8.setWidths(new float[] {43f, 7f});
        table9.setWidthPercentage(100);           table9.setHorizontalAlignment(Element.ALIGN_LEFT);            table9.setWidths(new float[] {43f, 7f});
        table10.setWidthPercentage(100);          table10.setHorizontalAlignment(Element.ALIGN_LEFT);           table10.setWidths(new float[] {43f, 7f});
        tablaPromedio.setWidthPercentage(100);    tablaPromedio.setHorizontalAlignment(Element.ALIGN_LEFT);     tablaPromedio.setWidths(new float[] {43f, 7f});
        ...
        Estudiante estudiante8  = estudiante.getInscripciones().stream().filter(est -> est.getGrupo().getGrado() == 8).findFirst().get().getInscripcion();
        Estudiante estudiante9  = estudiante.getInscripciones().stream().filter(est -> est.getGrupo().getGrado() == 9).findFirst().get().getInscripcion();
        Estudiante estudiante10 = estudiante.getInscripciones().stream().filter(est -> est.getGrupo().getGrado() == 10).findFirst().get().getInscripcion();
        ...
        List<DtoCargaAcademica> lista9 = controlador.getCargasAcademicas(estudiante9);
        lista9.sort((DtoCargaAcademica o1, DtoCargaAcademica o2) -> o1.getPlanEstudioMateria().getClaveMateria().compareTo(o2.getPlanEstudioMateria().getClaveMateria()));
        List<DtoCargaAcademica> lista10 = controlador.getCargasAcademicas(estudiante10);
        lista10.sort((DtoCargaAcademica o1, DtoCargaAcademica o2) -> o1.getPlanEstudioMateria().getClaveMateria().compareTo(o2.getPlanEstudioMateria().getClaveMateria()));
        ...
        Integer cargas = (int)estudiante10.getGrupo().getCargaAcademicaList().stream().mapToInt(CargaAcademica::getCarga).count();
        Integer calificaciones = (int)estudiante10.getCalificacionPromedioList().stream().mapToInt((cp) -> cp.getCargaAcademica().getCarga()).count();
        BigDecimal promedioC = controlador.getPromedioCuatrimestral(estudiante10);
        
        if(!cargas.equals(calificaciones) || promedioC.compareTo(new BigDecimal(8)) == -1) {
            Integer contador;
                BigDecimal p = estudiante.getInscripciones().stream().filter(e -> e.getInscripcion().getGrupo().getGrado() == 10)
                        .map(dtoInscripcion -> controlador.getPromedioCuatrimestral(dtoInscripcion.getInscripcion())).map(BigDecimal::plus)
                        .reduce(BigDecimal.ZERO, BigDecimal::add).setScale(2, RoundingMode.HALF_DOWN);
                if(p.compareTo(new BigDecimal(8)) == -1){
                    contador = 8;
                ...
                texto = new PdfPCell(new Paragraph("Promedio", fontBold));   avg = new PdfPCell(new Paragraph(promedioA.setScale(2, RoundingMode.HALF_DOWN).toString(), fontBold));
                tablaPromedio.addCell(texto);     tablaPromedio.addCell(avg);
                c8.addElement(tablaPromedio);
        }else{
            cuatri10 = new PdfPCell(new Paragraph("DECIMO", fontBold1));      cuatri10.setColspan(3);       cuatri10.setHorizontalAlignment(Element.ALIGN_CENTER);
            table10.addCell(cuatri10);
            lista10.forEach(dtoCargaAcademica -> {
                BigDecimal promedio = new BigDecimal(ejb.obtenerPromedioEstudiante(dtoCargaAcademica.getCargaAcademica(), estudiante10).getValor().getValor()).setScale(2, RoundingMode.HALF_DOWN);
                BigDecimal nivelacion = new BigDecimal(controlador.getNivelacion(dtoCargaAcademica, estudiante10).getCalificacionNivelacion().getValor()).setScale(2, RoundingMode.HALF_DOWN);
                PdfPCell materias2 = new PdfPCell(new Paragraph(dtoCargaAcademica.getMateria().getNombre(), fontMateria2));
                materias2.setHorizontalAlignment(Element.ALIGN_LEFT);   PdfPCell promedios2;
                    if(nivelacion.compareTo(BigDecimal.ZERO) == 0){
                        promedios2 = new PdfPCell(new Paragraph(promedio.toString(), fontMateria2));
                ...
                table10.addCell(materias2);
                table10.addCell(promedios2);
            });
            c8.addElement(table10);
        }
