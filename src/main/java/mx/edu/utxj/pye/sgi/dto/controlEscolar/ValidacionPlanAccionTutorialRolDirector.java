 ...
 * @author UTXJ
 */
public class ValidacionPlanAccionTutorialRolDirector extends AbstractRol{
    ...
    public ValidacionPlanAccionTutorialRolDirector(Filter<PersonalActivo> filtro,PersonalActivo director, AreasUniversidad programa) {
        super(filtro);
