...
//            System.out.println("mx.edu.utxj.pye.sgi.funcional.ComparadorEvaluacionEstudioEgresados.isCompleto() no trabaja");
            ...
            if (resultado.getR63() != null) {
                switch (resultado.getR63()) {
                    case 1:
                        System.out.println("mx.edu.utxj.pye.sgi.funcional.ComparadorEvaluacionEstudioEgresados.isCompleto() trabaja actualmente");
                        if (resultado.getR1() == null
                                || resultado.getR4() == null
                                || resultado.getR5() == null
                                || resultado.getR6() == null
                                ...
                                //                    || resultado.getR64a() == null
                                //                    || resultado.getR64b() == null
...
//                                    || resultado.getR73().trim().isEmpty()
//                                    || resultado.getR74().trim().isEmpty()
//                                    || resultado.getR75().trim().isEmpty()
//                                    || resultado.getR76().trim().isEmpty()
//                                    || resultado.getR77() == null
                                    || resultado.getR78() == null
                                    || resultado.getR79() == null
                                    || resultado.getR80() == null
                    ...
                    case 2:
                        System.out.println("mx.edu.utxj.pye.sgi.funcional.ComparadorEvaluacionEstudioEgresados.isCompleto() no esta trabajandoa pero si ah trabajado");
                        if (resultado.getR1() == null
                                || resultado.getR4() == null
                                || resultado.getR5() == null
                                || resultado.getR6() == null
