...
//            System.out.println("mx.edu.utxj.pye.sgi.ejb.evaluaciones.ServicioEvaluacion360Combinaciones.getEvaluadoresAnteriores() periodo: " + periodo);
...
//            System.out.println("mx.edu.utxj.pye.sgi.ejb.evaluaciones.ServicioEvaluacion360Combinaciones.getSubordinado() random: " + random);
...
//        System.out.println("mx.edu.utxj.pye.sgi.ejb.evaluaciones.ServicioEvaluacion360Combinaciones.detectarConfiguracion(" + o + ") class: " + o.getClass());

        Long count = (Long) o;
//        System.out.println("mx.edu.utxj.pye.sgi.ejb.evaluaciones.ServicioEvaluacion360Combinaciones.detectarConfiguracion() count: " + count);
...
//                System.out.println("mx.edu.utxj.pye.sgi.ejb.evaluaciones.ServicioEvaluacion360Combinaciones.getIgual() random: " + random);
...
//                System.out.println("mx.edu.utxj.pye.sgi.ejb.evaluaciones.ServicioEvaluacion360Combinaciones.getIgual() es secretaria de area: " + evaluado);
...
//                System.out.println("mx.edu.utxj.pye.sgi.ejb.evaluaciones.ServicioEvaluacion360Combinaciones.getIgual() evaluadores posibles: " + iguales);
            }

            //si es un PTC
            if (evaluado.getCategoriaOperativa().getCategoria() == 32) {
//                System.out.println("mx.edu.utxj.pye.sgi.ejb.evaluaciones.ServicioEvaluacion360Combinaciones.getIgual() es un PTC");
...
//                System.out.println("mx.edu.utxj.pye.sgi.ejb.evaluaciones.ServicioEvaluacion360Combinaciones.getIgual() es un PA");
...
//                System.out.println("mx.edu.utxj.pye.sgi.ejb.evaluaciones.ServicioEvaluacion360Combinaciones.getIgual() es un LAB");
...
//        System.out.println("mx.edu.utxj.pye.sgi.ejb.evaluaciones.ServicioEvaluacion360Combinaciones.getCategorias() EJB lista de categorias");
...
//            System.out.println("mx.edu.utxj.pye.sgi.ejb.evaluaciones.ServicioEvaluacion360Combinaciones.getCombinacionDesempenio() EJB combinacion : " + l.get(0));
            return l.get(0);
        }
    }
...
//        System.out.println("mx.edu.utxj.pye.sgi.ejb.evaluaciones.ServicioEvaluacion360Combinaciones.editaCombinacion360() evaluacion anterior para eliminar : " + viejaEvaluacion.getEvaluaciones360ResultadosPK());
...
//        System.out.println("mx.edu.utxj.pye.sgi.ejb.evaluaciones.ServicioEvaluacion360Combinaciones.editaCombinacion360() evaluacion recien creada= : " + nuevaEvaluacion.getEvaluaciones360ResultadosPK());
...
//        System.out.println("mx.edu.utxj.pye.sgi.ejb.evaluaciones.ServicioEvaluacion360Combinaciones.editaCombinacion360() item personal categoirias : " + personaC.getNombre());
    ...
    public DesempenioEvaluacionResultados editaCombinacionDesempenio(DesempenioEvaluacionResultados evaluacion, Integer evaluado, Integer evaluador) {
        ...
        Integer evaluadorClave = evaluador, evaluadoClave = evaluado;
//        System.out.println("mx.edu.utxj.pye.sgi.ejb.evaluaciones.ServicioEvaluacion360Combinaciones.editaCombinacionDesempenio() la evaluacion a eliminar : " + evaluacionAntigua.getDesempenioEvaluacionResultadosPK());
...
//        System.out.println("mx.edu.utxj.pye.sgi.ejb.evaluaciones.ServicioEvaluacion360Combinaciones.editaCombinacion360() item personal categoirias : " + personaC.getNombre());
    ...
    public Evaluaciones360Resultados eliminaCombinacion360(ListaEvaluacion360Combinaciones combinacion) {
        f.setEntityClass(Evaluaciones360Resultados.class);
//        System.out.println("mx.edu.utxj.pye.sgi.ejb.evaluaciones.ServicioEvaluacion360Combinaciones.eliminaCombinacion360() llega la combinacion : " + combinacion);
        ...
        List<Evaluaciones360Resultados> l = q.getResultList();
        if (l.isEmpty() || l == null) {
//            System.out.println("mx.edu.utxj.pye.sgi.ejb.evaluaciones.ServicioEvaluacion360Combinaciones.eliminaCombinacion360() no se pudo encontrar la ecombinacion por lo tanto no se elimino");
            return null;
        } else {
...
//        System.out.println("mx.edu.utxj.pye.sgi.ejb.evaluaciones.ServicioEvaluacion360Combinaciones.eliminaCombinacionDes() llega la combinacion : " + combinacion);
        ...
        List<DesempenioEvaluacionResultados> l = q.getResultList();
        if (l.isEmpty() || l == null) {
//            System.out.println("mx.edu.utxj.pye.sgi.ejb.evaluaciones.ServicioEvaluacion360Combinaciones.eliminaCombinacionDes() no se pudo encontrar la combinacion po lo tanto no se elimino");
            return null;
        } else {
//            System.out.println("mx.edu.utxj.pye.sgi.ejb.evaluaciones.ServicioEvaluacion360Combinaciones.eliminaCombinacionDes() pasa la validacion y encuentra la combinacion : " + l.get(0).getDesempenioEvaluacionResultadosPK());
