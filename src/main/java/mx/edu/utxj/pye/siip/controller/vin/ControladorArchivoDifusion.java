   ...
   //    Variables de Lectura
    ...
    public void consultaAreaRegistro() {
        try {
            ...
            System.out.println("mx.edu.utxj.pye.siip.controller.vin.ControladorArchivoDifusion.consultaAreaRegistro(): " + e.getMessage());
        }
    }
    ...
    public void subirExcelDifusion() {
        if (file != null) {
            rutaArchivo = ejbCarga.subirExcelRegistroMensual(String.valueOf(ejercicio),String.valueOf(area.getSiglas()),eje,ejbModulos.getEventoRegistro().getMes(),"difusion_iems",file);
