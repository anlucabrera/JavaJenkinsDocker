...
public class ControladorArchivoActFormIntegral implements Serializable{
    ...
    @Inject
    ControladorActFormacionIntegral controladorActFormacionIntegral;
    
    @Inject
    ControladorPartActFormInt controladorPartActFormInt;
    ...
    //ActionListener
    public void subirExcelActFormInt() {
         
       if (file != null) {
            rutaArchivo = ejbCarga.subirExcelRegistro(String.valueOf(ejercicio),String.valueOf(area),eje,"actividades_formacion_integral",file);
