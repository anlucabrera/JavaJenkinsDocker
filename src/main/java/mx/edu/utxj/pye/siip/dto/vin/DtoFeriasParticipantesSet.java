 ...
 * @author Planeacion
 */
public class DtoFeriasParticipantesSet {
    ...
    @Getter private List<FeriasParticipantes> listaFetiasParticipantesE;
    @Getter private List<ListaFeriasParticipantesDTO> listaFeriasParticipantesDTO;
    ...
    @Getter private ListaFeriasParticipantesDTO registro;//representa al registro seleccionado o al registro circulante en la tabla de datos.
    ...
    public DtoFeriasParticipantesSet() {        
    ...
    public void setListaFeriasParticipantes(ListaFeriasParticipantes listaFeriasParticipantes) {
        this.listaFeriasParticipantes = listaFeriasParticipantes;
    }
    ...
    public void setListaFetiasParticipantesE(List<FeriasParticipantes> listaFetiasParticipantesE) {
        this.listaFetiasParticipantesE = listaFetiasParticipantesE;
    }

    public void setListaFeriasParticipantesDTO(List<ListaFeriasParticipantesDTO> listaFeriasParticipantesDTO) {
        this.listaFeriasParticipantesDTO = listaFeriasParticipantesDTO;
    }
    public void setRegistro(ListaFeriasParticipantesDTO registro) {
