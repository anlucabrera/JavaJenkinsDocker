...
public class ControladorArchivoServicioEnfermeriaCP implements Serializable{
    ...
    @Inject
    ControladorServiciosEnfermeriaCicloPeriodos controladorServiciosEnfermeriaCicloPeriodos;
    ...
    public void subirExcelServiciosEnfermeria() throws IOException{
        if (file != null) {
            rutaArchivo = ejbCarga.subirExcelRegistro(String.valueOf(ejercicio),String.valueOf(area),eje,"servicios_enfermeria",file);
