 ...
 * @author UTXJ
 */
@Named(value = "reprobacionPerPYE")
@ManagedBean
@ViewScoped
public class ControladorDesercionReprobacionPYE implements Serializable {
...
//            Messages.addGlobalWarn("No hay registros de Deserción por Reprobación en el mes " + mes + " y el ejercicio fiscal " + ejercicio);
    ...
    public void alinearRegistro(){
        Boolean alineado = ejbModulos.alinearRegistroActividad(dto.getAlineacionActividad(), dto.getRegistro().getDesercionReprobacionMaterias().getRegistro());
        if(alineado){
            filtroReprobacion(dto.getMes(), dto.getEjercicioFiscal());
