...
public class ControladorArchivoCuerpAcad implements Serializable{
    ...
    @Inject
    ControladorCuerposAcademicos controladorCuerposAcademicos;
    @EJB
    EjbCarga ejbCarga;
    ...
    public void subirExcelCuerposAcademicos() throws IOException{
        if (file != null) {
            rutaArchivo = ejbCarga.subirExcelRegistro(String.valueOf(ejercicio),String.valueOf(area),eje,"cuerpos_academicos",file);
