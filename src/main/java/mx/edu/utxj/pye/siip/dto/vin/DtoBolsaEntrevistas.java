 ...
 * @author UTXJ
 */
public class DtoBolsaEntrevistas {
    
    @Getter private AreasUniversidad areaPOA;
    @Getter private DTOBolsaEntrevistas registro;//representa al registro seleccionado o al registro circulante en la tabla de datos.
    ...
    @Getter private List<DTOBolsaEntrevistas> lista;
    ...
    public void setLista(List<DTOBolsaEntrevistas> lista) {
        this.lista = lista;
    }
   ...
   public void setEventoActual(EventosRegistros eventoActual) {
    ...
    public void setRegistro(DTOBolsaEntrevistas registro) {
