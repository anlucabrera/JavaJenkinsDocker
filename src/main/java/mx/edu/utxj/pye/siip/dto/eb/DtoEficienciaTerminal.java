 ...
 * @author UTXJ
 */
public final class DtoEficienciaTerminal {
    ...
    @Getter private DTOEficienciaTerminalTitulacionRegistro registro;
    ...
    @Getter @Setter private List<DTOEficienciaTerminalTitulacionRegistro> listaEficienciaTerminal;
    
    public DtoEficienciaTerminal(){
        setRegistroTipo(new RegistrosTipo((short)4));
        setEjesRegistro(new EjesRegistro(5));
        setRegistros(new ArrayList<>(Arrays.asList(registroTipo.getRegistroTipo())));
        tieneEvidencia = false;
        forzarAperturaDialogo = false;
    }
    
    public void setRegistro(DTOEficienciaTerminalTitulacionRegistro registro){
