...
public class ControladorArchivoEstimulos implements Serializable{
    ...
    @Inject
    ControladorProgramasEstimulos controladorProgramasEstimulos;
    ...
    //ActionListener
    public void subirExcelProgEst() {
        if (file != null) {
            rutaArchivo = ejbCarga.subirExcelRegistro(String.valueOf(ejercicio),String.valueOf(area),eje,"programas_estimulos",file);
