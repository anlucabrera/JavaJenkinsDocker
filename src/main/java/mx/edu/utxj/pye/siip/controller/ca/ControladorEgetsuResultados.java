...
public class ControladorEgetsuResultados implements Serializable{
    ...
    @Getter @Setter private ListaEgetsuResultados listaEgetsuResultados = new  ListaEgetsuResultados();
    
    @EJB
    EjbEgetsuResultados ejbEgetsuResultados;
    ...
    public void init(){
        ...
        registroTipo.setRegistroTipo((short)10);
    ...
    public void listaEgetsuResultadosPrevia(String rutaArchivo) {
       try {
            listaEgetsuResultados = ejbEgetsuResultados.getListaEgetsuResultados(rutaArchivo);
        } catch (Throwable ex) {
    ...
    public void guardaEgetsuResultados() {
       try {
            ejbEgetsuResultados.guardaEgetsuResultados(listaEgetsuResultados,registroTipo, ejesRegistro, area, controladorModulosRegistro.getEventosRegistros());
    ...
    public void cancelarArchivo(){
         listaEgetsuResultados.getEgetsus().clear();
    }
