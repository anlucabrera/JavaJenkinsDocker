...
public class DtoRegistrosMovilidad {
    ...
    @Getter private List<DTORegistroMovilidad> lista;
    ...
    public void setLista(List<DTORegistroMovilidad> lista) {
        this.lista = lista;
    }
    ...
    public void setEventosPorPeriodo(List<EventosRegistros> eventosPorPeriodo) {
     ...
     public void setRegistro(DTORegistroMovilidad registro) {
