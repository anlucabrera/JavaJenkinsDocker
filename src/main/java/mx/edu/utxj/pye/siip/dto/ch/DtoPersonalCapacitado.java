 ...
 * @author UTXJ
 */
public class DtoPersonalCapacitado {
    @Getter private AreasUniversidad areaPOA;
    @Getter private DTOPersonalCapacitado registro;//representa al registro seleccionado o al registro circulante en la tabla de datos.
    ...
    @Getter private List<DTOPersonalCapacitado> lista;
    ...
    public DtoPersonalCapacitado() {
        setRegistroTipo(new RegistrosTipo((short)45));
    ...
    public void setLista(List<DTOPersonalCapacitado> lista) {
        this.lista = lista;
    }
    ...
    public void setEventosPorPeriodo(List<EventosRegistros> eventosPorPeriodo) {
     ...
     public void setRegistro(DTOPersonalCapacitado registro) {
