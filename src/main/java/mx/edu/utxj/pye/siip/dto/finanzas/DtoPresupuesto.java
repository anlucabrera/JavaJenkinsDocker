...
public class DtoPresupuesto {
    ...
    @Getter private DTOPresupuestos registro;//representa al registro seleccionado o al registro circulante en la tabla de datos.
    ...
    @Getter private List<DTOPresupuestos> lista;
    ...
    public void setLista(List<DTOPresupuestos> lista) {
        this.lista = lista;
    }
   ...
   public void setEventoActual(EventosRegistros eventoActual) {
    ...
    public void setRegistro(DTOPresupuestos registro) {
