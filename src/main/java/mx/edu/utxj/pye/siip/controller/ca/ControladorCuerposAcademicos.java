...
public class ControladorCuerposAcademicos implements Serializable{
    ...
    public void init(){
        ...
        if(dtoCuerposAcademicos.getArea() == null){
            return;
        }
    ...
    public void consultaAreaRegistro() {
        try {
            ...
            if (areaRegistro == null) {
                ...
                if(area.getCorrecto()){
                    dtoCuerposAcademicos.setArea(area.getValor());
                }else{
                    dtoCuerposAcademicos.setArea(null);
                }
            } else {
    ...
    public void listaCuerposAcademicosPrevia(String rutaArchivo) {
        try {
            if (rutaArchivo != null) {
                dtoCuerposAcademicos.setRutaArchivo(rutaArchivo);
                inicializarListas();
                dtoCuerposAcademicos.setLstDtoCuerposAcademicosR(ejbCuerposAcademicos.getListaCuerposAcademicos(rutaArchivo));
                dtoCuerposAcademicos.setLstDtoCuerpAcadIntegrantes(ejbCuerposAcademicos.getListaCuerpAcadIntegrantes(rutaArchivo));
                dtoCuerposAcademicos.setLstCuerpAcadLineas(ejbCuerposAcademicos.getListaCuerpAcadLineas(rutaArchivo));
            }
        } catch (Throwable ex) {
            Messages.addGlobalFatal("Ocurrió un error (" + (new Date()) + "): " + ex.getCause().getMessage());
            Logger.getLogger(ControladorCuerposAcademicos.class.getName()).log(Level.SEVERE, null, ex);
            if (dtoCuerposAcademicos.getRutaArchivo() != null) {
                ServicioArchivos.eliminarArchivo(dtoCuerposAcademicos.getRutaArchivo());
                dtoCuerposAcademicos.setRutaArchivo(null);
            }
        }
    }
    
    public void guardaCuerposAcademicos() {
        if (dtoCuerposAcademicos.getLstDtoCuerposAcademicosR() != null) {
            try {
                ejbCuerposAcademicos.guardaCuerposAcademicos(dtoCuerposAcademicos.getLstDtoCuerposAcademicosR(), dtoCuerposAcademicos.getRegistrosTipoCA(), dtoCuerposAcademicos.getEjesRegistro(), dtoCuerposAcademicos.getArea().getArea(), controladorModulosRegistro.getEventosRegistros());
                ejbCuerposAcademicos.guardaCuerpAcadIntegrantes(dtoCuerposAcademicos.getLstDtoCuerpAcadIntegrantes(), dtoCuerposAcademicos.getRegistrosTipoCAP(), dtoCuerposAcademicos.getEjesRegistro(), dtoCuerposAcademicos.getArea().getArea(), controladorModulosRegistro.getEventosRegistros());
                ejbCuerposAcademicos.guardaCuerpAcadLineas(dtoCuerposAcademicos.getLstCuerpAcadLineas(), dtoCuerposAcademicos.getRegistrosTipoCALI(), dtoCuerposAcademicos.getEjesRegistro(), dtoCuerposAcademicos.getArea().getArea(), controladorModulosRegistro.getEventosRegistros());
                ...
                dtoCuerposAcademicos.getLstDtoCuerposAcademicosR().clear();
                dtoCuerposAcademicos.getLstDtoCuerpAcadIntegrantes().clear();
                dtoCuerposAcademicos.getLstCuerpAcadLineas().clear();
                dtoCuerposAcademicos.setRutaArchivo(null);
            }
        } else {
    ...
    public void filtros(){
        dtoCuerposAcademicos.setAniosConsulta(ejbModulos.getEjercicioRegistros(dtoCuerposAcademicos.getRegistros(), dtoCuerposAcademicos.getArea()));
        if(!dtoCuerposAcademicos.getAniosConsulta().isEmpty()){
            dtoCuerposAcademicos.setAnioConsulta((short)dtoCuerposAcademicos.getAniosConsulta().get(dtoCuerposAcademicos.getAniosConsulta().size()-1));
        }
        dtoCuerposAcademicos.setMesesConsulta(ejbModulos.getMesesRegistros(dtoCuerposAcademicos.getAnioConsulta(), dtoCuerposAcademicos.getRegistros(), dtoCuerposAcademicos.getArea()));
        if(!dtoCuerposAcademicos.getMesesConsulta().isEmpty()){
            dtoCuerposAcademicos.setMesConsulta(dtoCuerposAcademicos.getMesesConsulta().stream()
            .filter(t -> ejbModulos.getEventoRegistro().getMes().equals(t))
            .findAny()
            .orElse(dtoCuerposAcademicos.getMesesConsulta().get(dtoCuerposAcademicos.getMesesConsulta().size()-1)));
        }
    ...
    public void actualizarEjes(Short ejercicio){
        dtoCuerposAcademicos.setEjes(ejbFiscalizacion.getEjes(ejercicio, dtoCuerposAcademicos.getArea()));
        if(!dtoCuerposAcademicos.getEjes().isEmpty() && dtoCuerposAcademicos.getAlineacionEje() == null){
            ...
            dtoCuerposAcademicos.setEstrategias(ejbFiscalizacion.getEstrategiasPorEje(dtoCuerposAcademicos.getAlineacionEje(), dtoCuerposAcademicos.getArea()));
        }
    ...
    public void cargarAlineacionXActividad() {
        if (dtoCuerposAcademicos.getAlineacionActividad() != null) {
            ...
            dtoCuerposAcademicos.setLineasAccion(ejbFiscalizacion.getLineasAccionPorEstrategia(dtoCuerposAcademicos.getAlineacionEstrategia(), dtoCuerposAcademicos.getArea()));
            ...
            dtoCuerposAcademicos.setActividades(ejbFiscalizacion.getActividadesPorLineaAccion(dtoCuerposAcademicos.getAlineacionLinea(), dtoCuerposAcademicos.getArea(),dtoCuerposAcademicos.getRegistroCuerposAcademicosR().getCuerposAcademicosRegistro().getRegistros().getEventoRegistro().getEjercicioFiscal().getAnio()));
...
//    Áreas Académicas Asignadas a Cuerpos Académicos
    ...
    public void guardarCuerpoAcademico(CuerposAcademicosRegistro cuerpoAcademicoRegistro){
        ...
        if(ejbCuerposAcademicos.getCuerpoAcademico(cuerpoAcademicoRegistro) != null){
            ...
            ejbCuerposAcademicos.guardaCuerpoAcademico(cuerpoAcademicoRegistro, dtoCuerposAcademicos.getRegistrosTipoCA(), dtoCuerposAcademicos.getEjesRegistro(), dtoCuerposAcademicos.getArea().getArea(), controladorModulosRegistro.getEventosRegistros());
    ...
    public void guardarCuerpoAcademicoIntegrante(CuerpacadIntegrantes cuerpacadIntegrante){
        ...
        if(ejbCuerposAcademicos.getCuerpacadIntegrantes(cuerpacadIntegrante) != null){
            ...
            ejbCuerposAcademicos.guardaCuerpoAcademicoIntegrante(cuerpacadIntegrante, dtoCuerposAcademicos.getRegistrosTipoCAP(), dtoCuerposAcademicos.getEjesRegistro(), dtoCuerposAcademicos.getArea().getArea(), controladorModulosRegistro.getEventosRegistros());
            dtoCuerposAcademicos.setMensaje("El registro ha sido guardado con exito en la base de datos");
            buscarCuerposAcademicos();
            DTOCuerpAcadIntegrantes dtoCAI = new DTOCuerpAcadIntegrantes();
            dtoCAI.setCuerpoAcademicoIntegrantes(new CuerpacadIntegrantes());
    ...
    public void guardarCuerpoAcademicoLineaInvestigacion(CuerpacadLineas cuerpacadLineas){
        ...
        if(ejbCuerposAcademicos.getCuerpacadLineas(cuerpacadLineas) != null){
            ...
            ejbCuerposAcademicos.guardaCuerpoAcademicoLineaInvestigacion(cuerpacadLineas, dtoCuerposAcademicos.getRegistrosTipoCALI(), dtoCuerposAcademicos.getEjesRegistro(), dtoCuerposAcademicos.getArea().getArea(), controladorModulosRegistro.getEventosRegistros());
            dtoCuerposAcademicos.setMensaje("El registro ha sido guardado con exito en la base de datos");
            buscarCuerposAcademicos();
            DTOCuerpAcadLineas dtoCALI = new DTOCuerpAcadLineas();
