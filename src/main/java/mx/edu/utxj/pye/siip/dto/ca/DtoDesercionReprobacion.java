 ...
 * @author Planeacion
 */
public class DtoDesercionReprobacion {
    /*Propiedades originales del contolador*/
    ...
    @Getter private ListaDesercionReprobacion listaDesercionReprobacion = new  ListaDesercionReprobacion();
    ...
    @Getter private List<DesercionReprobacionMaterias> listaReprobacion;
    @Getter private List<ListaDtoReprobacion> listaDtoReprobacion = new ArrayList<>();
    //**Cambio de lista directa de una entitie para mostrar datos por un DTO **//
    @Getter private List<DTOReprobacion> listaReprobacionDTO;
    
    
    /*Controles para la carga de evidencia*/
    
    @Getter private AreasUniversidad areaPOA;
    @Getter private ListaDtoReprobacion registro;//representa al registro seleccionado o al registro circulante en la tabla de datos.
    ...
    public void setListaDesercionReprobacion(ListaDesercionReprobacion listaDesercionReprobacion) {
        this.listaDesercionReprobacion = listaDesercionReprobacion;
    }
    ...
    public void setListaReprobacion(List<DesercionReprobacionMaterias> listaReprobacion) {
        this.listaReprobacion = listaReprobacion;
    }

    public void setListaReprobacionDTO(List<DTOReprobacion> listaReprobacionDTO) {
        this.listaReprobacionDTO = listaReprobacionDTO;
    }

    public void setListaDtoReprobacion(List<ListaDtoReprobacion> listaDtoReprobacion) {
        this.listaDtoReprobacion = listaDtoReprobacion;
    }
    public void setRegistro(ListaDtoReprobacion registro) {
