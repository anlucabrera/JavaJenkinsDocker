 ...
 * @author UTXJ
 */
public class DtoProgramasPertCal {
    @Getter private AreasUniversidad areaPOA;
    @Getter private DTOProgramasPertCalidad registro;//representa al registro seleccionado o al registro circulante en la tabla de datos.
    ...
    @Getter private List<DTOProgramasPertCalidad> lista;
    ...
    public DtoProgramasPertCal() {
        setRegistroTipo(new RegistrosTipo((short)44));
    ...
    public void setLista(List<DTOProgramasPertCalidad> lista) {
        this.lista = lista;
    }
    ...
    public void setRegistro(DTOProgramasPertCalidad registro) {
