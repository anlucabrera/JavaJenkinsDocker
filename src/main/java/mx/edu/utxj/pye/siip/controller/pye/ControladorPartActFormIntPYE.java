 ...
 * @author UTXJ
 */
@Named(value = "partActFormIntPYE")
@ViewScoped
public class ControladorPartActFormIntPYE implements Serializable{
    ...
    public void init(){
        ...
        try {
            ...
            Logger.getLogger(ControladorPartActFormIntPYE.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public void subirEvidencias(){
        ...
        if(res.getKey()){ 
            controladorActFormacionIntegralPYE.cargarListaPorEvento();
