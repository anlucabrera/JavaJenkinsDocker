...
public class ControladorArchivoIngPropios implements Serializable{
    ...
    @Inject
    ControladorIngPropios controladorIngPropios;
    ...
    //ActionListener
    public void subirExcelIngPropios() {
        
         if (file != null) {
            rutaArchivo = ejbCarga.subirExcelRegistro(String.valueOf(ejercicio),String.valueOf(area),eje,"ingresos_propios",file);
