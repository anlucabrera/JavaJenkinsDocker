...
public class ControladorProgramasPertCalidad implements Serializable{
    ...
    private static final long serialVersionUID = -7938536445647774548L;
    //Variables para almacenar el registro
    @Getter RegistrosTipo registroTipo;    
    @Getter EjesRegistro ejesRegistro;
    @Getter Short area;
    
    @Getter @Setter private ListaProgramasPertCalidad listaProgramasPertCalidad = new ListaProgramasPertCalidad();
    
    @EJB
    EjbProgramasPertCalidad ejbProgramasPertCalidad;
    ...
    public void init(){
        ...
        registroTipo.setRegistroTipo((short)44);
    ...
    public void listaProgramasPertCalidadPrevia(String rutaArchivo){
        try {
            listaProgramasPertCalidad = ejbProgramasPertCalidad.getListaProgramasPertCalidad(rutaArchivo);
        } catch (Throwable ex) {
    ...
    public void guardaProgramasPertCalidad(){
        try {
            ejbProgramasPertCalidad.guardaProgramasPertCalidad(listaProgramasPertCalidad,registroTipo, ejesRegistro, area, controladorModulosRegistro.getEventosRegistros());
    ...
    public void cancelarArchivo(){
        listaProgramasPertCalidad.getProgramasPertCalidad().clear();
    }
