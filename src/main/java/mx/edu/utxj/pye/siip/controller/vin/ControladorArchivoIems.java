...
@ManagedBean
@ViewScoped
public class ControladorArchivoIems implements Serializable{

    private static final long serialVersionUID = -945178638567842734L;
    ...
    @Inject
    ControladorIems controladorIems;
    ...
    public void consultaAreaRegistro() {
        try {
            ...
            areaRegistro = controladorModulosRegistro.consultaAreaRegistro((short) 28);
            ...
            System.out.println("mx.edu.utxj.pye.siip.controller.vin.ControladorArchivoIems.consultaAreaRegistro(): " + e.getMessage());
        }
    }
