 ...
 * @author UTXJ
 */
public class DtoComisionesAcademicas {
    
    @Getter private AreasUniversidad areaPOA;
    @Getter private DTOComisionesAcademicas registro;//representa al registro seleccionado o al registro circulante en la tabla de datos.
    ...
    @Getter private List<DTOComisionesAcademicas> lista;
    ...
    public DtoComisionesAcademicas() {
    ...
    public void setLista(List<DTOComisionesAcademicas> lista) {
        this.lista = lista;
    }
    ...
    public void setEventoActual(EventosRegistros eventoActual) {
     ...
     public void setRegistro(DTOComisionesAcademicas registro) {
