 ...
 * @author UTXJ
 */
public class DtoMovilidadDocente {
    
    @Getter private AreasUniversidad areaPOA;
    @Getter private DTOMovilidadDocente registro;//representa al registro seleccionado o al registro circulante en la tabla de datos.
    ...
    @Getter private List<DTOMovilidadDocente> lista;
    ...
    @Getter private List<RegistrosMovilidad> docentesPorMovilidad;

    public DtoMovilidadDocente() {
        setRegistroTipo(new RegistrosTipo((short)33));
    ...
    public void setLista(List<DTOMovilidadDocente> lista) {
        this.lista = lista;
    }
   ...
   public void setEventoActual(EventosRegistros eventoActual) {
    ...
    public void setRegistro(DTOMovilidadDocente registro) {
