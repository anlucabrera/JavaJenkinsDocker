...
public class ControladorDifusionIems implements Serializable{
    ...
    @Getter @Setter private ListaDifusionIems listaDifusionIems = new ListaDifusionIems();
    
    @EJB
    EjbDifusionIems ejbDifusionIems;
    ...
    public void init(){
        ...
        registroTipo.setRegistroTipo((short)29);
    ...
    public void listaDifusionIemsPrevia(String rutaArchivo) {
       try {
            listaDifusionIems = ejbDifusionIems.getListaDifusionIems(rutaArchivo);
        } catch (Throwable ex) {
    ...
    public void guardaDifusionIems() {
        try {
            ejbDifusionIems.guardaDifusionIems(listaDifusionIems,registroTipo, ejesRegistro, area, controladorModulosRegistro.getEventosRegistros());
