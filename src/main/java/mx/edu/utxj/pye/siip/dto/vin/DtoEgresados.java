 ...
 * @author UTXJ
 */
public final class DtoEgresados {
    /************************** Lista áreas ****************************************/
    ...
    /************************** Evidencias *************************************/
    @Getter private DTOActividadEgresadoGeneracion registroActividadEgresado;
    @Getter private DTOActividadEconomicaEgresadoG registroActividadEconomicaEgresado;
    @Getter private DTONivelOcupacionEgresadosG registroNivelOcupacionEgresado;
    @Getter private DTONivelIngresoEgresadosG registroNivelngresoEgresado;
    ...
    @Getter @Setter RegistrosTipo regTipoActividadEgresado;
    @Getter @Setter RegistrosTipo regTipoActividadEconomicaEgresado;
    @Getter @Setter RegistrosTipo regTipoNivelOcupacionEgresado;
    @Getter @Setter RegistrosTipo regTipoNivelIngresoEgresado;
    @Getter @Setter EjesRegistro ejesRegistro;
    
    @Getter @Setter AreasUniversidad area;
    @Getter @Setter String rutaArchivo;
    
    @Getter @Setter private List<DTOActividadEgresadoGeneracion> listaActividadEgresado;
    ...
    public DtoEgresados() {
        ...
        setRegTipoActividadEconomicaEgresado(new RegistrosTipo((short)22));
        setRegTipoNivelOcupacionEgresado(new RegistrosTipo((short)23));
        setRegTipoNivelIngresoEgresado(new RegistrosTipo((short)24));
        setRegistros(new ArrayList<>(Arrays.asList(regTipoActividadEgresado.getRegistroTipo(),regTipoActividadEconomicaEgresado.getRegistroTipo(),regTipoNivelOcupacionEgresado.getRegistroTipo(),regTipoNivelIngresoEgresado.getRegistroTipo())));
        setEjesRegistro(new EjesRegistro(4));
        tieneEvidencia = false;
        forzarAperturaDialogo = false;
    }

    public void setRegistroActividadEgresado(DTOActividadEgresadoGeneracion registroActividadEgresado) {
        this.registroActividadEgresado = registroActividadEgresado;
    }

    public void setRegistroActividadEconomicaEgresado(DTOActividadEconomicaEgresadoG registroActividadEconomicaEgresado) {
        this.registroActividadEconomicaEgresado = registroActividadEconomicaEgresado;
    }

    public void setRegistroNivelOcupacionEgresado(DTONivelOcupacionEgresadosG registroNivelOcupacionEgresado) {
        this.registroNivelOcupacionEgresado = registroNivelOcupacionEgresado;
    }

    public void setRegistroNivelngresoEgresado(DTONivelIngresoEgresadosG registroNivelngresoEgresado) {
        this.registroNivelngresoEgresado = registroNivelngresoEgresado;
    }
