...
public class DtoBecas {
    ...
    @Getter private List<BecasPeriodosEscolares> listaBecasPE;
    @Getter private List<ListaBecasDto>listaBecasDto;
    ...
    @Getter private ListaBecasDto registro;//representa al registro seleccionado o al registro circulante en la tabla de datos.
    ...
    public void setListaBecasPeriodo(ListaBecasPeriodo listaBecasPeriodo) {
        this.listaBecasPeriodo = listaBecasPeriodo;
    }
    ...
    public void setListaBecasPE(List<BecasPeriodosEscolares> listaBecasPE) {
        this.listaBecasPE = listaBecasPE;
    }

    public void setListaBecasDto(List<ListaBecasDto> listaBecasDto) {
        this.listaBecasDto = listaBecasDto;
    }
    public void setRegistro(ListaBecasDto registro) {
