 ...
 * @author UTXJ
 */
public class DtoIngresosPropios {
    
    @Getter private AreasUniversidad areaPOA;
    @Getter private DTOIngPropios registro;//representa al registro seleccionado o al registro circulante en la tabla de datos.
    ...
    @Getter private List<DTOIngPropios> lista;
    ...
    public void setLista(List<DTOIngPropios> lista) {
        this.lista = lista;
    }
    ...
    public void setEventosPorPeriodo(List<EventosRegistros> eventosPorPeriodo) {
     ...
     public void setRegistro(DTOIngPropios registro) {
