...
//Variables para almacenar el registro
    ...
    @Getter @Setter private ListaBolsaEntrevistas listaBolsaEntrevistas = new  ListaBolsaEntrevistas();
    
    @EJB
    EjbBolsaEntrevistas ejbBolsaEntrevistas;
    ...
    public void init(){
        ...
        registroTipo.setRegistroTipo((short)2);
    ...
    public void listaBolsaEntrevistasPrevia(String rutaArchivo) {
        try {
            listaBolsaEntrevistas = ejbBolsaEntrevistas.getListaBolsaEntrevistas(rutaArchivo);
        } catch (Throwable ex) {
    ...
    public void guardaBolsaEntrevistas() {
        try {
            ejbBolsaEntrevistas.guardaBolsaEntrevistas(listaBolsaEntrevistas,registroTipo, ejesRegistro, area, controladorModulosRegistro.getEventosRegistros());
    ...
    public void cancelarArchivo(){
        listaBolsaEntrevistas.getBolsaEntrevistas().clear();
    }
