 ...
 * @author UTXJ
 */
public class DtoMovilidadEstudiantil {
    
    @Getter private AreasUniversidad areaPOA;
    @Getter private DTOMovilidadEstudiante registro;//representa al registro seleccionado o al registro circulante en la tabla de datos.
    ...
    @Getter private List<DTOMovilidadEstudiante> lista;
    ...
    @Getter private List<RegistrosMovilidad> estudiantesPorMovilidad;

   public DtoMovilidadEstudiantil() {
        setRegistroTipo(new RegistrosTipo((short)32));
    ...
    public void setLista(List<DTOMovilidadEstudiante> lista) {
        this.lista = lista;
    }
   ...
   public void setEventoActual(EventosRegistros eventoActual) {
    ...
    public void setRegistro(DTOMovilidadEstudiante registro) {
