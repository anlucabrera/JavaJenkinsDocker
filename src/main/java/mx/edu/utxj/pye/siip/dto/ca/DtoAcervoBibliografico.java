 ...
 * @author UTXJ
 */
public class DtoAcervoBibliografico {
    
    @Getter private AreasUniversidad areaPOA;
    @Getter private DTOAcervoBibliograficoPeriodosEscolares registro;//representa al registro seleccionado o al registro circulante en la tabla de datos.
    ...
    @Getter private List<DTOAcervoBibliograficoPeriodosEscolares> lista;
    ...
    @Getter private List<Short> clavesAreasSubordinadas;//claves de areas subordinas que no tienes poa
     ...
     public DtoAcervoBibliografico() {
        setRegistroTipo(new RegistrosTipo((short)6));
    ...
    public void setLista(List<DTOAcervoBibliograficoPeriodosEscolares> lista) {
        this.lista = lista;
    }
    ...
    public void setEventosPorPeriodo(List<EventosRegistros> eventosPorPeriodo) {
     ...
     public void setRegistro(DTOAcervoBibliograficoPeriodosEscolares registro) {
