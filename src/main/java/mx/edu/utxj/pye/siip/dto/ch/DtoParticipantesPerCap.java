 ...
 * @author UTXJ
 */
public class DtoParticipantesPerCap {
    
    @Getter private AreasUniversidad areaPOA;
    @Getter private DTOPerCapParticipantes registro;//representa al registro seleccionado o al registro circulante en la tabla de datos.
    ...
    @Getter private List<PersonalCapacitado> participantesPorCapacitacion;

    public DtoParticipantesPerCap() {
        setRegistroTipo(new RegistrosTipo((short)46));
    ...
    public void setLista(List<DTOPerCapParticipantes> lista) {
        this.lista = lista;
    }
   ...
   public void setEventoActual(EventosRegistros eventoActual) {
    ...
    public void setRegistro(DTOPerCapParticipantes registro) {
