...
public class DtoActividadesFormInt {
    ...
    @Getter private List<DTOActFormacionIntegral> lista;
    ...
    @Getter @Setter private List<AreasUniversidad> listaAFIAreasConRegistroMensualGeneral;
    ...
    public void setLista(List<DTOActFormacionIntegral> lista) {
        this.lista = lista;
    }
...
//        }
     ...
     public void setRegistro(DTOActFormacionIntegral registro) {
