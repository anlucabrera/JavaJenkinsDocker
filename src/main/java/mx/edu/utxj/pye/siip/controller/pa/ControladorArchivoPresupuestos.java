...
@ManagedBean
@ViewScoped
public class ControladorArchivoPresupuestos implements Serializable{
...
//    Variables de Lectura
    ...
    public void consultaAreaRegistro() {
        try {
            ...
            System.out.println("mx.edu.utxj.pye.siip.controller.pa.ControladorArchivoPresupuestos.consultaAreaRegistro(): " + e.getMessage());
        }
    }
    ...
    //ActionListener
    public void subirExcelPresupuestos() {
         if (file != null) {
            rutaArchivo = ejbCarga.subirExcelRegistroMensual(String.valueOf(ejercicio),String.valueOf(area.getSiglas()),eje,ejbModulos.getEventoRegistro().getMes(),"presupuestos",file);
            if (!"Error: No se pudo leer el archivo".equals(rutaArchivo)) {
                setEtapa(RegistroSiipEtapa.CARGAR);
                controladorPresupuestos.listaPresupuestosPrevia(rutaArchivo);
                rutaArchivo = null;
            } else {
                rutaArchivo = null;
