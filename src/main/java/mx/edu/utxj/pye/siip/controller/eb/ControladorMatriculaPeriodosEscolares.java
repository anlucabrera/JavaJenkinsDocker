...
@ManagedBean
@ViewScoped
public class ControladorMatriculaPeriodosEscolares implements Serializable{
    ...
    public void init() {
        ...
        try {
            ...
            Logger.getLogger(ControladorMatriculaPeriodosEscolares.class.getName()).log(Level.SEVERE, null, ex);
        }
        initFiltros();
        } catch (Throwable ex) {
    ...
    public void consultaAreaRegistro() {
        try {
            ...
            areaRegistro = controladorModulosRegistro.consultaAreaRegistro((short) 51);
            ...
            System.out.println("ControladorMatriculaPeriodosEscolares.consultaAreaRegistro: " + ex.getMessage());
        }
    }
    
    public void cargarListaPorEvento(){
        dto.setLista(ejb.getListaRegistrosPorEventoAreaPeriodo(dto.getAreaPOA().getArea(), dto.getPeriodo(), dto.getRegistroTipo()));
    ...
    public void listaMatriculaPeriodosEscolaresPrevia(String rutaArchivo) {
        try {
            if (rutaArchivo != null) {
                dto.setRutaArchivo(rutaArchivo);
                dto.setLista(ejb.getListaMatriculaPeriodosEscolares(rutaArchivo));
            }
        } catch (Throwable ex) {
    ...
    public void guardarMatriculaPeriodosEscolares(){
        if(dto.getLista()!=null){
            try {
                ejb.guardaMatriculaPeriodosEscolares(dto.getLista(), dto.getRegistroTipo(), dto.getEje(), dto.getAreaPOA().getArea(), controladorModulosRegistro.getEventosRegistros());
            } catch (Throwable ex) {
                Messages.addGlobalFatal("Ocurrió un error (" + (new Date()) + "): " + ex.getCause().getMessage());
                Logger.getLogger(ControladorMatriculaPeriodosEscolares.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public void actualizarEjes(){
        dto.setEjes(ejbFiscalizacion.getEjes(dto.getRegistro().getMatricula().getRegistros().getEventoRegistro().getEjercicioFiscal().getAnio(), dto.getAreaPOA()));
