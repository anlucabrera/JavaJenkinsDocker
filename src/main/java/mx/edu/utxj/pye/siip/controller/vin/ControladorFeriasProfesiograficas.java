...
public class ControladorFeriasProfesiograficas implements Serializable{
    ...
    @Getter @Setter private ListaFeriasProfesiograficas listaFeriasProfesiograficas = new ListaFeriasProfesiograficas();
    ...
    public void init(){
        ...
        registroTipo.setRegistroTipo((short)34);
    ...
    public void listaFeriasProfesiograficasPrevia(String rutaArchivo) {
        try {
            listaFeriasProfesiograficas = ejbFeriasProfesiograficas.getListaFeriasProfesiograficas(rutaArchivo);
        } catch (Throwable ex) {
    ...
    public void guardaFeriasProfesiograficas() {
        try {
            ejbFeriasProfesiograficas.guardaFeriasProfesiograficas(listaFeriasProfesiograficas,registroTipo, ejesRegistro, area, controladorModulosRegistro.getEventosRegistros());
    ...
    public void cancelarArchivo(){
        listaFeriasProfesiograficas.getFerias().clear();
    }
