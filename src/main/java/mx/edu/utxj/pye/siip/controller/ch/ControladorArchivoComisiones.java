...
public class ControladorArchivoComisiones implements Serializable{
    ...
    public void consultaAreaRegistro() {
        try {
            ...
            System.out.println("ControladorArchivoComisiones.consultaAreaRegistro: " + ex.getMessage());
        }
    }
    ...
    //ActionListener
    public void subirExcelComAcad() throws IOException {
        if (file != null) {
            rutaArchivo = ejbCarga.subirExcelRegistroMensual(String.valueOf(ejercicio),String.valueOf(area.getSiglas()),eje,ejbModulos.getEventoRegistro().getMes(),"comisiones_academicas",file);
