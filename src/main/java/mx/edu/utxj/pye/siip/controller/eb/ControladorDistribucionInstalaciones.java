...
public class ControladorDistribucionInstalaciones implements Serializable{
    ...
    public void cargarListaPorEvento(){
        dto.setListaCapIns(ejb.getListaCapacidadInstaladaPorEventoAreaPeriodo(dto.getEventoSeleccionado(), dto.getAreaPOA().getArea(), dto.getPeriodo(), dto.getRegTipoCapIns()));
        ...
        dto.setListaDisAulas(ejb.getListaDistribucionAulasPorEventoAreaPeriodo(dto.getEventoSeleccionado(), dto.getAreaPOA().getArea(), dto.getPeriodo(), dto.getRegTipoDistAu()));
        ...
        dto.setListaDisLabTall(ejb.getListaDistribucionLabTallPorEventoAreaPeriodo(dto.getEventoSeleccionado(), dto.getAreaPOA().getArea(), dto.getPeriodo(), dto.getRegTipoDistLabTal()));
    ...
    public void initFiltros(){
        dto.setPeriodos(ejb.getPeriodosConregistro(dto.getRegTipoCapIns(),dto.getRegTipoDistAu(),dto.getRegTipoDistLabTal(),dto.getEventoActual(),dto.getAreaPOA()));
        dto.setEventosPorPeriodo(ejbModulos.getEventosPorPeriodo(dto.getPeriodo()));
        try {
            Map.Entry<List<PeriodosEscolares>,List<EventosRegistros>> entrada = ejb.comprobarEventoActual(dto.getPeriodos(), dto.getEventosPorPeriodo(), dto.getEventoActual(), dto.getRegTipoCapIns(),dto.getRegTipoDistAu(),dto.getRegTipoDistLabTal(),dto.getAreaPOA());
            if(entrada != null){
    ...
    public void listaDistribucionInstalacionesPrevia(String rutaArchivo) {
        try {
            if (rutaArchivo != null) {
                ...
                dto.setListaCapIns(ejb.getListaCapacidadInstaladaCiclosEScolares(rutaArchivo));
                dto.setListaDisAulas(ejb.getListaDistribucionAulasCPE(rutaArchivo));
                dto.setListaDisLabTall(ejb.getListaDistribucionLabTall(rutaArchivo));
            }
        } catch (Throwable ex) {
    ...
    public void guardaDistribucionInstalaciones(){
        if (dto.getListaCapIns() != null) {
            try {
                ejb.guardaCapacidadInstalada(dto.getListaCapIns(), dto.getRegTipoCapIns(), dto.getEje(), dto.getAreaPOA().getArea(), controladorModulosRegistro.getEventosRegistros());
                ejb.guardaDistribucionAulas(dto.getListaDisAulas(), dto.getRegTipoDistAu(), dto.getEje(), dto.getAreaPOA().getArea(), controladorModulosRegistro.getEventosRegistros());
                ejb.guardaDistribucionLabTall(dto.getListaDisLabTall(), dto.getRegTipoDistLabTal(), dto.getEje(), dto.getAreaPOA().getArea(), controladorModulosRegistro.getEventosRegistros());
            } catch (Throwable ex) {
                Messages.addGlobalFatal("Ocurrió un error (" + (new Date()) + "): " + ex.getCause().getMessage());
                Logger.getLogger(ControladorDistribucionInstalaciones.class.getName()).log(Level.SEVERE, null, ex);
                ...
                dto.getListaCapIns().clear();
                dto.getListaDisAulas().clear();
                dto.getListaDisLabTall().clear();
                dto.setRutaArchivo(null);
            }
        } else {
    ...
    public void actualizarEjes(){
        dto.setEjes(ejbFiscalizacion.getEjes(dto.getRegistroCapacidadInstalada().getCapacidadInstaladaCiclosEscolares().getRegistros().getEventoRegistro().getEjercicioFiscal().getAnio(), dto.getAreaPOA()));
    ...
    public void actualizarEjesDA(){
        dto.setEjes(ejbFiscalizacion.getEjes(dto.getRegistroDistribucionAulas().getDistribucionAulasCicloPeriodosEscolares().getRegistros().getEventoRegistro().getEjercicioFiscal().getAnio(), dto.getAreaPOA()));
        if(!dto.getEjes().isEmpty() && dto.getAlineacionEje() == null){
            dto.setAlineacionEje(dto.getEjes().get(0));
            dto.setEstrategias(ejbFiscalizacion.getEstrategiasPorEje(dto.getAlineacionEje(), dto.getAreaPOA()));
        }
    ...
    public void actualizarEjesDLT(){
        dto.setEjes(ejbFiscalizacion.getEjes(dto.getRegistroDistribucionLabTall().getDistribucionLabtallCicloPeriodosEscolares().getRegistros().getEventoRegistro().getEjercicioFiscal().getAnio(), dto.getAreaPOA()));
        if(!dto.getEjes().isEmpty() && dto.getAlineacionEje() == null){
            dto.setAlineacionEje(dto.getEjes().get(0));
            dto.setEstrategias(ejbFiscalizacion.getEstrategiasPorEje(dto.getAlineacionEje(), dto.getAreaPOA()));
        }
