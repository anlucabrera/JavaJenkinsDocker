 ...
 * @author UTXJ
 */
public class DtoExani {
    @Getter private AreasUniversidad areaPOA;
    @Getter private DTOExani registro;//representa al registro seleccionado o al registro circulante en la tabla de datos.
    ...
    @Getter private List<DTOExani> lista;
    ...
    public DtoExani() {
        ...
        setRegistroTipo(new RegistrosTipo((short)11));
    ...
    public void setLista(List<DTOExani> lista) {
        this.lista = lista;
    }
    ...
    public void setRegistro(DTOExani registro) {
