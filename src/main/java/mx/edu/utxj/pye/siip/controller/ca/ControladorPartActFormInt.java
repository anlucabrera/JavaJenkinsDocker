...
public class ControladorPartActFormInt implements Serializable{
    ...
    @Getter @Setter private ListaPartActFormInt listaPartActFormInt = new  ListaPartActFormInt();
    
    @EJB
    EjbPartFormInt ejbPartFormInt;
    ...
    public void init(){
        ...
        registroTipo.setRegistroTipo((short)17);
    ...
    public void listaParticipantesActformacionintPrevia(String rutaArchivo) {
       try {
            listaPartActFormInt = ejbPartFormInt.getListaPartActFormInt(rutaArchivo);
        } catch (Throwable ex) {
    ...
    public void guardaPartActFormInt() {
       try {
            ejbPartFormInt.guardaPartActFormInt(listaPartActFormInt,registroTipo, ejesRegistro, area, controladorModulosRegistro.getEventosRegistros());
    ...
    public void cancelarArchivo(){
        listaPartActFormInt.getParticipantesActFormInt().clear();
    }
