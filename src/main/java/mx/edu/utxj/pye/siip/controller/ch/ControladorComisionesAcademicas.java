...
public class ControladorComisionesAcademicas implements Serializable{
    ...
    public void init(){
        ...
        dtopart.setArea((short) controladorEmpleado.getNuevoOBJListaPersonal().getAreaOperativa()); 
        dtopart.setAreaPOA(ejbFiscalizacion.getAreaConPOA(dto.getArea()));
        dtopart.setClavesAreasSubordinadas(ejbFiscalizacion.getAreasSubordinadasSinPOA(dto.getAreaPOA()));
