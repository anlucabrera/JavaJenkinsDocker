...
public class ControladorArchivoExani implements Serializable{
    ...
    @Inject
    ControladorExaniResultados controladorExaniResultados;
    ...
    //ActionListener
    public void subirExcelExani() {
        
       if (file != null) {
            rutaArchivo = ejbCarga.subirExcelRegistro(String.valueOf(ejercicio),String.valueOf(area),eje,"exani",file);
