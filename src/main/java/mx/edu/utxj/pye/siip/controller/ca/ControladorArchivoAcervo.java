...
public class ControladorArchivoAcervo implements Serializable{
    ...
    @Inject
    ControladorAcervoBibliografico controladorAcervoBibliografico;
    ...
    //ActionListener
    public void subirExcelAcervo() {
        
       if (file != null) {
            rutaArchivo = ejbCarga.subirExcelRegistro(String.valueOf(ejercicio),String.valueOf(area),eje,"acervo_bibliografico",file);
