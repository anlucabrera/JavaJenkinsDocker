 ...
 * @author UTXJ
 */
public class DtoEvaluacionSatEduCont {
    /************************** Lectura de plantilla ************************/
    @Getter @Setter private List<DTOEvaluacionSatEduContAnioMes.LecturaPlantilla> lstEvaluacionSatEducontAnioMes;
    
    /************************** Edición ****************************************/
    @Getter @Setter private List<ServiciosTecnologicosAnioMes> servicios;
    ...
    /************************** Evidencias *************************************/
    @Getter private DTOEvaluacionSatEduContAnioMes.ConsultaRegistros registro;
    ...
    @Getter @Setter private List<EvaluacionSatisfaccionResultados> eduContConsulta = new ArrayList<>();
    ...
    @Getter @Setter private List<DTOEvaluacionSatEduContAnioMes.ConsultaRegistros> lstDtoEvaluacionSatEducontAnioMes;
    
    public DtoEvaluacionSatEduCont(){
        setRegistroTipoST(new RegistrosTipo((short)55));
        setEjesRegistro(new EjesRegistro(4));
        setRegistros(new ArrayList<>(Arrays.asList(registroTipoST.getRegistroTipo())));
        tieneEvidencia = false;
        forzarAperturaDialogo = false;
    }
    
    public void setRegistro (DTOEvaluacionSatEduContAnioMes.ConsultaRegistros registro){
