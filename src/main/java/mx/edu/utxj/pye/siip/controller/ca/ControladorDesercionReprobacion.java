...
public class ControladorDesercionReprobacion implements Serializable{
   ...
   //Variables para almacenar el registro
    ...
    @Getter @Setter private ListaDesercionReprobacion listaDesercionReprobacion = new  ListaDesercionReprobacion();
    
    @EJB
    EjbDesercionReprobacion ejbDesercionReprobacion;
    ...
    public void init(){
        ...
        registroTipo.setRegistroTipo((short)26);
    ...
    public void listaDesercionReprobacionPrevia(String rutaArchivo) {
       try {
            listaDesercionReprobacion = ejbDesercionReprobacion.getListaDesercionReprobacion(rutaArchivo);
        } catch (Throwable ex) {
    ...
    public void guardaDesercionReprobacion() {
        try {
            ejbDesercionReprobacion.guardaDesercionReprobacion(listaDesercionReprobacion,registroTipo, ejesRegistro, area, controladorModulosRegistro.getEventosRegistros());
    ...
    public void cancelarArchivo(){
        listaDesercionReprobacion.getReprobacion().clear();
    }
