 ...
 * @author UTXJ
 */
public class DtoBolsaTrabajo {
    @Getter private AreasUniversidad areaPOA;
    @Getter private DTOBolsa registro;//representa al registro seleccionado o al registro circulante en la tabla de datos.
    ...
    @Getter private List<DTOBolsa> lista;
    ...
    public DtoBolsaTrabajo() {
        setRegistroTipo(new RegistrosTipo((short)1));
    ...
    public void setLista(List<DTOBolsa> lista) {
        this.lista = lista;
    }
    ...
    public void setEventosPorPeriodo(List<EventosRegistros> eventosPorPeriodo) {
     ...
     public void setRegistro(DTOBolsa registro) {
