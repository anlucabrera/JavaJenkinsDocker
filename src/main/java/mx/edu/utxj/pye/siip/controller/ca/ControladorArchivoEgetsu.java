...
public class ControladorArchivoEgetsu implements Serializable{
   ...
   //    Variables de Lectura
    ...
    @Inject
    ControladorEgetsuResultados controladorEgetsuResultados;
    ...
    //ActionListener
    public void subirExcelEgetsu() {
        
       if (file != null) {
            rutaArchivo = ejbCarga.subirExcelRegistro(String.valueOf(ejercicio),String.valueOf(area),eje,"egetsu",file);
