...
public class DtoDifusionIems {
    ...
    @Getter private List<DifusionIems> ListadoDIemsE;
    @Getter private List<ListaDifusionIemsDTO>ListadoDIemsDTO;
    ///////////////////////////////////////////////////////////
    ...
    @Getter private ListaDifusionIemsDTO registro;//representa al registro seleccionado o al registro circulante en la tabla de datos.
    ...
    public void setListaDifusionIems(ListaDifusionIems listaDifusionIems) {
        this.listaDifusionIems = listaDifusionIems;
    }
    ...
    public void setListadoDIemsE(List<DifusionIems> ListadoDIemsE) {
        this.ListadoDIemsE = ListadoDIemsE;
    }

    public void setListadoDIemsDTO(List<ListaDifusionIemsDTO> ListadoDIemsDTO) {
        this.ListadoDIemsDTO = ListadoDIemsDTO;
    }
    
    public void setRegistro(ListaDifusionIemsDTO registro) {
