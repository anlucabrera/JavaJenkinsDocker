...
public class ControladorArchivoDistribucionEquipamiento implements Serializable{
    ...
    public void subirExcelDistribucionEquipamiento() throws IOException{
        if (file != null) {
            rutaArchivo = ejbCarga.subirExcelRegistroMensual(String.valueOf(ejercicio),String.valueOf(area.getSiglas()),eje,ejbModulos.getEventoRegistro().getMes(),"distribucion_equipamiento",file);
