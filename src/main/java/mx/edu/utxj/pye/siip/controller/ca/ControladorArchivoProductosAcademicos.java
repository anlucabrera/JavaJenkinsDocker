...
@ManagedBean
@ViewScoped
public class ControladorArchivoProductosAcademicos implements Serializable{

    private static final long serialVersionUID = -2073039669828958945L;
    ...
    @Inject
    ControladorProductosAcademicos controladorProductosAcademicos;
