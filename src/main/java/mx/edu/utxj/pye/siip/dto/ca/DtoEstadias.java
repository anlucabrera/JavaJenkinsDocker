 ...
 * @author UTXJ
 */
public final class DtoEstadias {
    @Getter private AreasUniversidad areaPOA;
    @Getter private DTOEstadiasPorEstudiante registro;//representa al registro seleccionado o al registro circulante en la tabla de datos.
    ...
    @Getter private List<DTOEstadiasPorEstudiante> lista;
    ...
    public DtoEstadias() {
        setRegistroTipo(new RegistrosTipo((short)5));
    ...
    public void setLista(List<DTOEstadiasPorEstudiante> lista) {
        this.lista = lista;
    }
    ...
    public void setRegistro(DTOEstadiasPorEstudiante registro) {
