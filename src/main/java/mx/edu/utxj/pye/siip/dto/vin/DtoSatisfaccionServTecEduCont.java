 ...
 * @author UTXJ
 */
public final class DtoSatisfaccionServTecEduCont {
    /************************** Lectura de plantilla ************************/
    @Getter @Setter private List<SatisfaccionServtecEducontAnioMes> lstSatisfaccionServtecEducontAnioMes;
    ...
    /************************** Evidencias *************************************/
    @Getter private DTOSatisfaccionServTecEduContAnioMes registro;
    ...
    @Getter @Setter private List<DTOSatisfaccionServTecEduContAnioMes> lstDtoSatisfaccionServtecEducontAnioMes;
    
    public DtoSatisfaccionServTecEduCont(){
        setRegistroTipoST(new RegistrosTipo((short)54));
    ...
    public void setRegistro (DTOSatisfaccionServTecEduContAnioMes registro){
