 ...
 * @author UTXJ
 */
public class DtoProgramasEstimulos {
    
    @Getter private AreasUniversidad areaPOA;
    @Getter private DTOProgramasEstimulos registro;//representa al registro seleccionado o al registro circulante en la tabla de datos.
    ...
    @Getter private List<DTOProgramasEstimulos> lista;
    ...
    public DtoProgramasEstimulos() {
        setRegistroTipo(new RegistrosTipo((short)47));
    ...
    public void setLista(List<DTOProgramasEstimulos> lista) {
        this.lista = lista;
    }
    ...
    public void setRegistro(DTOProgramasEstimulos registro) {
