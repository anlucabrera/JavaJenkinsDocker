...
@ManagedBean
@ViewScoped
public class ControladorArchivoTutAsesCE implements Serializable{
...
//    Interfaces conectadas
    ...
    public void consultaAreaRegistro() {
        try {
            ...
            System.out.println("ControladorArchivoTutAsesCE.consultaAreaRegistro: " + ex.getMessage());
        }
    }
    ...
    public void subirExcelTutAsesCE() throws IOException {
        if (file != null) {
            rutaArchivo = ejbCarga.subirExcelRegistroMensual(String.valueOf(ejercicio),String.valueOf(area.getSiglas()),eje,ejbModulos.getEventoRegistro().getMes(),"tutorias_asesorias",file);
