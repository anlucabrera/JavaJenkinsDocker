...
public class ControladorComAcadParticipantes implements Serializable{
    ...
    @Getter @Setter private ListaComAcadParticipantes listaComAcadParticipantes = new  ListaComAcadParticipantes();
    
    @EJB
    EjbComAcadParticipantes ejbComAcadParticipantes;
    ...
    public void init(){
        ...
        registroTipo.setRegistroTipo((short)49);
    ...
    public void listaComAcadParticipantesPrevia(String rutaArchivo) {
      try {
            listaComAcadParticipantes = ejbComAcadParticipantes.getListaComAcadParticipantes(rutaArchivo);
        } catch (Throwable ex) {
    ...
    public void guardaComAcadParticipantes() {
      try {
            ejbComAcadParticipantes.guardaComAcadParticipantes(listaComAcadParticipantes, registroTipo, ejesRegistro, area, controladorModulosRegistro.getEventosRegistros());
    ...
    public void cancelarArchivo(){
        listaComAcadParticipantes.getParticipantes().clear();
    }
