 ...
 * @author UTXJ
 */
public class DtoParticipantesComAcad {
    @Getter private AreasUniversidad areaPOA;
    @Getter private DTOComAcadParticipantes registro;//representa al registro seleccionado o al registro circulante en la tabla de datos.
    ...
    @Getter private List<DTOComAcadParticipantes> lista;
    ...
    public DtoParticipantesComAcad() {
        setRegistroTipo(new RegistrosTipo((short)49));
    ...
    public void setLista(List<DTOComAcadParticipantes> lista) {
        this.lista = lista;
    }
    ...
    public void setEventoActual(EventosRegistros eventoActual) {
     ...
     public void setRegistro(DTOComAcadParticipantes registro) {
