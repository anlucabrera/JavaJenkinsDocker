...
@NoArgsConstructor
@AllArgsConstructor
@ToString(of = "programasPertcal")
@EqualsAndHashCode
public class DTOProgramasPertCalidad implements Serializable{
    private static final long serialVersionUID = 6865902401527224802L;
    @Getter @Setter @NonNull private ProgramasPertcal programasPertcal;
