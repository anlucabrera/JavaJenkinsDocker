 ...
 * @author UTXJ
 */
public final class DtoDistribucionInstalaciones {
    @Getter private AreasUniversidad areaPOA;
    @Getter private DTOCapacidadInstaladaCiclosEscolares registroCapacidadInstalada;
    @Getter private DTODistribucionAulasCPE registroDistribucionAulas;
    @Getter private DTODistribucionLabTallCPE registroDistribucionLabTall;
    ...
    @Getter private RegistrosTipo regTipoCapIns;
    @Getter private RegistrosTipo regTipoDistAu;
    @Getter private RegistrosTipo regTipoDistLabTal;
    ...
    @Getter private List<DTOCapacidadInstaladaCiclosEscolares> listaCapIns;
    @Getter private List<DTODistribucionAulasCPE> listaDisAulas;
    @Getter private List<DTODistribucionLabTallCPE> listaDisLabTall;
    ...
    public DtoDistribucionInstalaciones() {
        setRegTipoCapIns(new RegistrosTipo((short)18));
        setRegTipoDistAu(new RegistrosTipo((short)19));
        setRegTipoDistLabTal(new RegistrosTipo((short)20));
    ...
    public void setRegTipoCapIns(RegistrosTipo regTipoCapIns) {
        this.regTipoCapIns = regTipoCapIns;
    }

    public void setRegTipoDistAu(RegistrosTipo regTipoDistAu) {
        this.regTipoDistAu = regTipoDistAu;
    }

    public void setRegTipoDistLabTal(RegistrosTipo regTipoDistLabTal) {
        this.regTipoDistLabTal = regTipoDistLabTal;
    }

    public void setListaCapIns(List<DTOCapacidadInstaladaCiclosEscolares> listaCapIns) {
        this.listaCapIns = listaCapIns;
    }

    public void setListaDisAulas(List<DTODistribucionAulasCPE> listaDisAulas) {
        this.listaDisAulas = listaDisAulas;
    }

    public void setListaDisLabTall(List<DTODistribucionLabTallCPE> listaDisLabTall) {
        this.listaDisLabTall = listaDisLabTall;
    }
    ...
    public void setRegistroCapacidadInstalada(DTOCapacidadInstaladaCiclosEscolares registroCapacidadInstalada) {
        this.registroCapacidadInstalada = registroCapacidadInstalada;
    }

    public void setRegistroDistribucionAulas(DTODistribucionAulasCPE registroDistribucionAulas) {
        this.registroDistribucionAulas = registroDistribucionAulas;
    }

    public void setRegistroDistribucionLabTall(DTODistribucionLabTallCPE registroDistribucionLabTall) {
        this.registroDistribucionLabTall = registroDistribucionLabTall;
    }
