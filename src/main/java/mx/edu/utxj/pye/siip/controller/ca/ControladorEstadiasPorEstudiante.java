...
public class ControladorEstadiasPorEstudiante implements Serializable{
    ...
    @Getter @Setter private ListaEstadiasPorEstudiante listaEstadiasPorEstudiante = new ListaEstadiasPorEstudiante();
    
    @EJB
    EjbEstadiasPorEstudiante ejbEstadiasPorEstudiante;
    ...
    public void init(){
        ...
        registroTipo.setRegistroTipo((short)5);
    ...
    public void listaEstadiasPorEstudiantePrevia(String rutaArchivo) {
        try {
            if (rutaArchivo != null) {
                ...
                listaEstadiasPorEstudiante = ejbEstadiasPorEstudiante.getListaEstadiasPorEstudiante(rutaArchivo);
            }
        } catch (Throwable ex) {
    ...
    public void guardaEstadiasPorEstudiante(){
        if (listaEstadiasPorEstudiante != null) {
            try {
                ejbEstadiasPorEstudiante.guardaEstadiasPorEstudiante(listaEstadiasPorEstudiante, registroTipo, ejesRegistro, area, controladorModulosRegistro.getEventosRegistros());
                ...
                listaEstadiasPorEstudiante.getEstadiasPorEstudiante().clear();
