...
public class ControladorFeriasParticipantes implements Serializable{
    ...
    @Getter @Setter private ListaFeriasParticipantes listaFeriasParticipantes = new  ListaFeriasParticipantes();
    
    @EJB
    EjbFeriasParticipantes ejbFeriasParticipantes;
    ...
    public void init(){
        ...
        registroTipo.setRegistroTipo((short)35);
    ...
    public void listaFeriasprofParticipantesPrevia(String rutaArchivo) {
      try {
            listaFeriasParticipantes = ejbFeriasParticipantes.getListaFeriasParticipantes(rutaArchivo);
        } catch (Throwable ex) {
    ...
    public void guardaFeriasprofParticipantes() {
         try {
            ejbFeriasParticipantes.guardaFeriasParticipantes(listaFeriasParticipantes,registroTipo, ejesRegistro, area, controladorModulosRegistro.getEventosRegistros());
    ...
    public void cancelarArchivo(){
        listaFeriasParticipantes.getFeriasParticipantes().clear();
    }
