...
public class ControladorEficienciaTerminalTitulacionRegistro implements Serializable{
    ...
    public void consultaAreaRegistro() {
        try {
            ...
            System.out.println("ControladorEficienciaTerminalTitulacionRegistro.consultaAreaRegistro: " + ex.getMessage());
        }
    }
    ...
    public void cargarAlineacionXActividad(){
        if(dto.getAlineacionActividad() != null){
            ...
            dto.setActividades(ejbFiscalizacion.getActividadesPorLineaAccion(dto.getAlineacionLinea(), dto.getArea(),dto.getRegistro().getEficienciaTerminalTitulacionRegistro().getRegistros().getEventoRegistro().getEjercicioFiscal().getAnio()));
